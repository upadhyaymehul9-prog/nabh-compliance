...
function Dashboard({ decision, gaps, onNav, hospitalName, assessmentName }) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      doc.text(hospitalName||'Hospital',W/2,165,{align:'center'});
      ...
      const cleanName=(hospitalName||'Hospital').replace(/[^a-zA-Z0-9]/g,'_');
  ...
  return (
    <div style={{fontFamily:"Segoe UI,system-ui,sans-serif",background:T.bg,minHeight:"100vh",color:T.text}}>
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"16px"}}>
        {screen==="dashboard"&&<Dashboard decision={decision} gaps={gaps} onNav={setScreen} hospitalName={context?.hospitalName||""} assessmentName={context?.assessmentName||""}/>}
