-- HIC.4 master policy -- DRAFT for review. Do NOT set status = 'approved' here;
...
The second half of this document concerns staff. A healthcare worker is both a route by which infection reaches a patient and a person who can be harmed by the patient's infection. This policy states what {{HOSPITAL_NAME}} does to keep its workers well enough and protected enough not to become the former, and what it does for them when, despite that, an exposure occurs.$q$,
  $q$This policy applies to every area of {{HOSPITAL_NAME}} in which a urinary catheter is placed, a patient is mechanically ventilated, an intravascular device is inserted or maintained, or a surgical or invasive procedure is performed — inpatient wards, critical care and high-dependency areas, operation theatres and procedure rooms, the labour room, emergency, day-care, dialysis, and any outpatient area where these are done.
...
{{HOSPITAL_NAME}} further undertakes that reporting an exposure carries no penalty of any kind. Under-reporting of needlestick and mucosal exposure is the single largest obstacle to managing it, and it is driven by fear — of blame, of the result, of being seen as careless. A worker who reports an exposure at {{HOSPITAL_NAME}} is treated as having done the right thing, and is told so.$q$,
  array[
    $s$1. What "taking action to prevent" means at {{HOSPITAL_NAME}}
...
Bundle compliance is measured as set out in step 23. Infection rates arising from these bundles are counted under the surveillance policy, not here.$s$,
    $s$2. Catheter-associated urinary tract infection — deciding whether to catheterise at all
...
Before catheterising, the treating team considers the alternatives set out in step 5. Where a bladder scanner is available, it is used to establish whether retention is actually present rather than inferring it.$s$,
    $s$3. Catheter-associated urinary tract infection — insertion
...
Systemic antimicrobials are not given as prophylaxis to prevent catheter-associated urinary tract infection in a patient with a catheter in situ.$s$,
    $s$5. Catheter-associated urinary tract infection — daily review, removal and alternatives
...
Catheter days are the denominator against which this hospital's performance in this area is ultimately judged. Reducing them is the intervention with the largest effect, and it is a matter of daily discipline rather than of technique.$s$,
    $s$6. Catheter-associated urinary tract infection — specimens, and what is not done
...
Where infection is genuinely suspected, the catheter is reassessed for removal or replacement as part of the clinical response, and the case is notified to the Infection Control Team for surveillance under the surveillance policy.$s$,
    $s$7. Ventilator-associated pneumonia and infection-related ventilator-associated complication — applicability
...
Where a contraindication to daily sedation interruption or to a spontaneous breathing trial exists, it is recorded against the patient for that day. A blank is treated on audit as an omission, not as a contraindication.$s$,
    $s$9. Ventilator-associated pneumonia — position, the mouth and the airway
...
- the airway is not disconnected unnecessarily, and where disconnection is unavoidable the circuit is protected.$s$,
    $s$10. Ventilator-associated pneumonia — circuit, condensate and equipment
...
Any ventilated patient who develops new or worsening oxygenation requirements is assessed clinically, and the case is notified to the Infection Control Team for classification and counting under the surveillance policy.$s$,
    $s$12. Catheter-linked bloodstream infection — applicability and what is covered
...
Insertion of a central line is performed only by an operator trained and assessed as competent, or by a trainee under the direct supervision of such an operator. {{HOSPITAL_NAME}} maintains the list of assessed operators and the date of each assessment.$s$,
    $s$13. Catheter-linked bloodstream infection — the decision, the site and the insertion
...
In a genuine emergency where full asepsis could not be observed, that fact is recorded and the catheter is replaced at the earliest safe opportunity, and in any event within [Hospital to define].$s$,
    $s$14. Catheter-linked bloodstream infection — the dressing and the access hub
...
Dressing changes and hub care are recorded. The record is the maintenance audit trail for step 23.$s$,
    $s$15. Catheter-linked bloodstream infection — infusates, administration sets and line necessity
...
Where catheter-related bloodstream infection is suspected, blood cultures are taken before antimicrobials are started, from a peripheral vein and from the catheter, and the case is notified to the Infection Control Team.$s$,
    $s$16. Catheter-linked bloodstream infection — peripheral cannulae, and escalation when the rate does not fall
...
Antiseptic-impregnated adhesive incise drapes are not used as an infection-prevention measure. Where {{HOSPITAL_NAME}} uses incise drapes for another reason, that reason is recorded and they are not credited as prevention.$s$,
    $s$19. Surgical site infection — surgical antimicrobial prophylaxis
...
Where an operation is contaminated or dirty, the procedure is scheduled and the theatre is cleaned in accordance with the support services policy; the practice of listing such cases last is a matter of theatre management and is not by itself an infection control measure.$s$,
    $s$21. Surgical site infection — physiological control during surgery
...
Each of the three is recorded on the anaesthetic record, and the records form part of the surgical site infection bundle audit at step 23.$s$,
    $s$22. Surgical site infection — after the operation
...
Records are retained for the period defined by {{HOSPITAL_NAME}} of [Hospital to define], having regard to the long latency of some occupational infections, and are disposed of securely.$s$,
    $s$25. Occupational health — assessment at placement and thereafter
...
The outcome recorded and communicated is a fitness determination as described in step 24. Where a restriction is determined, it states what the worker may not do and for how long, and it is reviewed at the stated date rather than left standing indefinitely.$s$,
    $s$26. Occupational health — immunisation of staff
...
Immunisation status is reviewed at the periodic assessment and when a worker changes role.$s$,
    $s$27. Occupational health — the worker who is infected: reporting and work restriction
...
A worker restricted from patient contact is assigned to suitable alternative work where such work exists and the restriction permits it, rather than simply sent home, provided this does not defeat the purpose of the restriction.$s$,
    $s$28. Occupational health — protecting the worker at the point of work
...
Training in all of the above is delivered under step 30 and recorded.$s$,
    $s$29. Occupational health — workers at particular risk
...
All costs arising under steps 24 to 36 — assessment, immunisation, testing, prophylaxis, treatment and follow-up — are borne by {{HOSPITAL_NAME}}. No part of the cost is recovered from a worker, whether employed, contracted or a student on attachment.$s$,
    $s$31. Occupational exposure — first aid in the first minutes
...
The assessment is completed at the time of report and drives the decisions at steps 33 to 36. A decision on human immunodeficiency virus prophylaxis is not deferred pending completion of the paperwork; the clinical decision is taken first and documented immediately after.$s$,
    $s$33. Occupational exposure — testing the source and the exposed worker
...
Testing is performed at the cost of {{HOSPITAL_NAME}} and at [Hospital to define — the laboratory or integrated counselling and testing centre used, and the arrangement out of hours].$s$,
    $s$34. Post-exposure prophylaxis — human immunodeficiency virus
...
A worker may decline prophylaxis after counselling. The declination and the counselling given are recorded, the worker is told they may change their mind within the 72-hour window, and follow-up under step 36 continues regardless.$s$,
    $s$35. Post-exposure prophylaxis — hepatitis B, and the management of hepatitis C
...
The worker is told plainly at the outset which of the three viruses can be prevented after exposure and which cannot, because a worker who believes hepatitis C is being prevented by the tablets they are taking will not attend for the follow-up test that actually protects them.$s$,
    $s$36. Occupational exposure — other exposures, follow-up and counselling
...
Confidentiality. Everything recorded under steps 31 to 36 is confidential clinical information held under step 24. The fact of a worker's exposure, the source's identity and status, and any test result are not disclosed to colleagues or managers.$s$,
    $s$37. Records, indicators and reporting to the Committee
...
Infection rates themselves are produced and reported under the surveillance policy and are read alongside these process measures.$s$,
...
Revisions are approved by the Committee, endorsed by management, and issued with the superseded version withdrawn from every point of use.$s$
  ],
  $q$The Infection Prevention and Control Committee owns this policy, approves the content of the four care bundles, reviews compliance and exposure data, and escalates unresolved failures and unfunded requirements to management.
...
All staff are responsible for performing the bundle elements applicable to their role, for recording what they have done, for reporting their own transmissible infection, and for reporting every occupational exposure immediately — their own and any they witness.$q$,
  $q$- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Hospital Infection Control chapter, standard HIC.4.
...
- Internal documents of {{HOSPITAL_NAME}}: infection prevention and control programme policy, infection prevention and control practices policy, infection prevention and control in support services policy, surveillance policy, sterilisation and disinfection policy, antimicrobial usage policy, surgical prophylaxis schedule, patient safety policy and surgical safety checklist, and the occupational health and post-exposure procedure.$q$,
...
This document is not issued by, endorsed by, or affiliated with NABH, the World Health Organization, the National Centre for Disease Control, the Food Safety and Standards Authority of India, any Pollution Control Board, or any other body named in it. Wording is original; no text has been reproduced from the standards, rules or guidelines referenced.$q$,
  $q$[{"oe_code": "HIC.4.a", "requirement": "Action is taken to prevent urinary tract infection associated with indwelling urinary catheters", "steps": "Steps 1-6, 23", "evidence": "Written CAUTI insertion and maintenance bundle; recorded indication at insertion in every case record; catheter insertion register with inserter name and competency list; daily catheter review record showing continued indication or removal; nurse-initiated removal protocol where adopted; shift-wise maintenance checklist covering closed system, bag position and meatal hygiene; bundle compliance audit reports (all-or-none and by element) with corrective actions; catheter-day counts handed to surveillance", "responsible": "Nursing in-charge of each area for the daily review and maintenance elements, with the treating team accountable for the indication, audited independently by the Infection Control Nurse"}, {"oe_code": "HIC.4.b", "requirement": "Action is taken to prevent infection-related ventilator-associated complications and ventilator-associated pneumonia", "steps": "Steps 1, 7-11, 23", "evidence": "Signed and dated applicability declaration recording whether invasive ventilation is provided, or the not-applicable position and its reason, tabled at the IPCC; written VAP bundle; ventilator care chart per patient per day covering head-of-bed elevation, sedation assessment against target, daily sedation interruption and spontaneous breathing trial or recorded contraindication, oral care, cuff pressure measurement and extubation readiness; circuit and condensate management records; humidifier and accessory reprocessing records; weaning protocol; bundle compliance audit reports with corrective actions", "responsible": "Intensive care or ward in-charge where ventilation is provided, with the treating intensivist or physician accountable for sedation and weaning decisions; head of the institution signs the applicability declaration"}, {"oe_code": "HIC.4.c", "requirement": "Action is taken to prevent bloodstream infection linked to intravascular catheters", "steps": "Steps 1, 12-16, 23", "evidence": "Signed and dated applicability declaration recording whether central venous access is inserted or maintained, or the not-applicable position and its reason; list of operators assessed as competent, with assessment dates; completed central line insertion checklist for every insertion, signed by an observer who is not the operator; written authorisation of the observer to halt a non-emergency procedure; site selection recorded; dressing change and hub care records; administration set change records; daily line necessity review; peripheral cannula inspection and phlebitis scoring records; IPCC minutes recording any escalation decision on second-line measures; bundle compliance audit reports", "responsible": "The inserting operator for the insertion bundle and the nursing in-charge of the area for the maintenance bundle, with the Infection Control Officer advising on escalation; head of the institution signs the applicability declaration and the observer authorisation"}, {"oe_code": "HIC.4.d", "requirement": "Action is taken to prevent infection of the surgical site", "steps": "Steps 1, 17-22, 23", "evidence": "Written SSI bundle; pre-operative risk assessment in the case record; pre-operative bathing record; hair removal record showing method used, with clippers stocked and razors absent from pre-operative areas; decolonisation protocol and its application records; surgical prophylaxis schedule; per-operation record of prophylaxis agent, dose, administration time relative to incision, intra-operative re-dosing and stop time; completed surgical safety checklist; anaesthetic record showing core temperature and blood glucose; wound assessment records at each dressing change; discharge wound-care instruction record; post-discharge follow-up mechanism and its records to the defined follow-up horizon; bundle compliance audit reports, with prophylaxis compliance also reported to the antimicrobial stewardship arrangement", "responsible": "Operating surgeon and anaesthetist jointly, with the surgeon accountable for asepsis, hair removal, wound care and post-discharge follow-up and the anaesthetist accountable for prophylaxis timing, normothermia and glycaemic control"}, {"oe_code": "HIC.4.e", "requirement": "Occupational health and safety practices are implemented to reduce transmission of microorganisms among healthcare providers", "steps": "Steps 24-30, 37", "evidence": "Named occupational health responsible person with defined reporting line; confidential staff health records held separately from personnel files; pre-placement assessment records for employed, contracted and student staff; periodic reassessment records; immunisation register with hepatitis B course dates, anti-HBs results and non-responder determinations, and declination records where immunisation was refused; written work restriction schedule and records of restrictions applied, with confirmation that pay was not withheld; respiratory protection programme with fit-test records; PPE and sharps container provision and replenishment records; safety-engineered device assessment; induction and periodic training attendance with competence assessment, including contractor staff; exposure reporting contact displayed at every point of work; evidence that no cost was passed to any worker", "responsible": "The occupational health responsible person of {{HOSPITAL_NAME}}, with heads of department accountable for releasing staff and acting on findings, and the contract manager for outsourced personnel"}, {"oe_code": "HIC.4.f", "requirement": "Appropriate post-exposure prophylaxis is provided to every staff member concerned", "steps": "Steps 31-36, 37", "evidence": "Written post-exposure procedure with a named designated person and deputy and a documented 24x7 arrangement; occupational exposure report form completed for every exposure, including the risk assessment and the circumstances that produced it; source and exposed-person consent, counselling and testing records held confidentially; HIV PEP starter stock physically on the premises with location, stock and expiry check records; record of time of exposure against time of first dose; 28-day course completion or documented declination after counselling; hepatitis B PEP schedule with vaccine and immunoglobulin administration records showing separate sites; hepatitis C baseline and follow-up testing records; tetanus, rabies and other chemoprophylaxis records; follow-up schedule completion and counselling records; aggregate exposure and PEP indicators reported to the IPCC", "responsible": "The occupational health responsible person of {{HOSPITAL_NAME}} and the designated exposure contact (and deputy) available at all hours, with the pharmacy accountable for the availability of the starter supply and immunoglobulin"}]$q$::jsonb,
