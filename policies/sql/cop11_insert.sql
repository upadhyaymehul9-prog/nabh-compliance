-- COP.11 master policy -- UNAPPROVED DRAFT for review.
...
--
-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 2, printed page 67
...
- End-of-life pathways and brain-death declaration, where they exist, are governed by the intensive-care policy of {{HOSPITAL_NAME}} (COP.6). This policy owns only the transplant-programme and donation-awareness duties of COP.11.i and COP.11.j.$q$,
  $q${{HOSPITAL_NAME}} performs clinical procedures and operations according to written guidance, in a consistent and safe manner, in every theatre and procedure room it uses.
...
This step does not write the SSI bundle, the sterilisation cycle, or the anaesthetic. Those remain in the documents named in Scope.$s$,
    $s$2. Pre-operative assessment, diagnosis and instructions
...
An emergency procedure that cannot wait for a full elective work-up still has a recorded working diagnosis and the instructions that were possible. Absence of time is recorded; absence of a diagnosis is not.$s$,
    $s$3. Informed consent obtained by the doctor prior to the procedure
...
An emergency that makes prior consent impossible is recorded as such, with the reason and the person who decided to proceed, in line with the patient-rights policies. Emergency is not a standing exemption for convenience.$s$,
    $s$4. Preventing wrong site, wrong patient and wrong surgery
...
The completed checklist travels with the unique identification number in the record. Where the completed checklists are filed is [Hospital to define — where completed surgical-safety checklists are filed].$s$,
    $s$5. Standard precautions during the procedure
...
How theatre staff are shown that HIC.2 applies in the operating theatre, including at induction to the theatre, is [Hospital to define — how theatre staff are briefed that standard precautions under HIC.2 apply in the operating theatre].$s$,
    $s$6. Procedure notes, post-procedure monitoring and the post-operative care plan
...
The medical record structure is owned by the information-management policies of {{HOSPITAL_NAME}}. This step owns the surgical content.$s$,
    $s$7. Facilities, equipment, instruments and supplies in the operating theatre
...
Engineering controls of the theatre — ventilation, pressure, temperature as an engineering matter — are owned by the support-services infection-control policy and the facility policies of {{HOSPITAL_NAME}}. This step does not write those parameters.$s$,
    $s$8. Quality-assurance programme for procedural and theatre practice
...
The common error is to treat theatre quality assurance as a count of cases done, or as a photocopy of the infection-control minutes. Volume is not assurance. Infection-control minutes are not a checklist-completion audit.$s$,
    $s$9. Organ transplant programme — legal and ethical, or a recorded absence
...
This step does not write intensive-care end-of-life care. It writes the legal-and-ethical envelope of transplantation, or the recorded fact that transplantation is not done here.$s$,
    $s$10. Awareness of organ donation
...
Records of the measures — the materials, the dates of any session, the display — are kept by [Hospital to define — who keeps the organ-donation awareness records].$s$,
    $s$11. Records, review and the order of operations
...
All staff are expected to treat a skipped pause, an unmarked laterality, a consent obtained after incision, and a hospital held out as transplanting when it is not registered to do so, as defects, and to report them.$q$,
  $q$- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Care of Patients chapter, standard COP.11.
...
Superseded versions are withdrawn from all points of use on issue of a revision, and one dated copy of each is retained by the quality or accreditation coordinator.$q$,
  $q$Abbreviations already defined in the HIC.1 to HIC.6 master policies are not repeated here. A reader using this document on its own should refer to those policies for the shared glossary, including NABH, SHCO, OE, OT, SSI, PPE, WHO, SOP, ICT and CSSD.
...
This document is not issued by, endorsed by, or affiliated with NABH, the World Health Organization, the National Centre for Disease Control, the Food Safety and Standards Authority of India, any Pollution Control Board, or any other body named in it. Wording is original; no text has been reproduced from the standards, rules or guidelines referenced.$q$,
  $q$[{"oe_code": "COP.11.a", "requirement": "Clinical procedures as well as procedures done in operation theatres are done in a consistent and safe manner.", "steps": "Steps 1, 11", "evidence": "The written procedural and operation-theatre guidance covering which procedures may be performed in which theatre, who may perform them, how a list is scheduled and how an emergency is inserted, what must be present before the patient is moved into the operating room, the surgical-safety checklist pointer, the standard-precautions pointer, the operation-note content and the postponement route; alignment of that guidance with the current service directory and department scopes of services; human-resource credentialing used and not restated; sample lists showing the same class of procedure prepared, paused, performed and documented the same way on a routine list and on an emergency or out-of-hours case, and by employed and visiting surgeons; the location where the guidance is held and induction or briefing records showing theatre staff have been shown it rather than a cupboard copy; records of a case stopped or postponed when a required element was missing rather than started from habit; the audit sample at step 11 of written guidance in use rather than only on file", "responsible": "Person in charge of the operating theatre holds the written guidance; operating surgeons and theatre staff apply it; head of the institution is accountable that procedures are consistent and safe; quality or accreditation coordinator audits"}, {"oe_code": "COP.11.b", "requirement": "Surgical patients have a preoperative assessment, a documented pre-operative diagnosis, and pre-operative instructions provided before surgery and documented.", "steps": "Steps 2, 11", "evidence": "Pre-operative assessment records against the unique identification number, distinct from the pre-anaesthesia assessment; documented pre-operative diagnosis dated before the patient is moved into the operating room; the written pre-operative instruction set and sample records that instructions were given; emergency cases with a recorded working diagnosis rather than a blank", "responsible": "Operating surgeon or the role named at step 2 performs and documents the assessment, diagnosis and instructions"}, {"oe_code": "COP.11.c", "requirement": "Informed consent is obtained by the doctor prior to the procedure.", "steps": "Steps 3, 11", "evidence": "Consent forms naming the procedure, the side where laterality applies and the unique identification number, signed by the doctor who will perform the procedure before it starts; records of incomplete consents not accepted; documented emergency exceptions with reason, consistent with the patient-rights policies", "responsible": "Operating doctor obtains consent; patient-rights policies own the consent method; theatre staff do not start without it"}, {"oe_code": "COP.11.d", "requirement": "Care is taken to prevent adverse events like wrong site, wrong patient and wrong surgery.", "steps": "Steps 4, 8, 11", "evidence": "The hospital's own surgical-safety checklist, stating that the World Health Organization Guidelines for Safe Surgery 2009 is the three-moment framework (before induction, before incision, before the patient leaves the operating room) and that WHO checklist items are not pasted as a mandated verbatim script; the named person who leads each pause; sample completed checklists filed against the unique identification number whose times match the procedure rather than a block of ticks at the end of the list; identity confirmation at the first pause using the two identifiers of the uniform-care policy, matched to consent, operating list and unique identification number, with patient participation while able; the written site-marking method (who marks, with what, which procedures are exempt because laterality does not apply), with marks made before the patient is moved into the operating room, visible after draping, and with marking after the drape or marking the opposite side forbidden; records of the operating list, consent, mark and imaging agreed at the pause before incision, and of procedures stopped when those disagreed rather than started because the list was running late; implant and laterality-specific device confirmation at the pause; near-miss records of wrong patient, missing mark or laterality mismatch caught at the pause, reviewed under the quality-assurance programme at step 8; the location where completed checklists are filed; induction or briefing records showing visiting surgeons use this hospital's checklist and marking method; the audit sample at step 11 of checklists that match the time of the procedure", "responsible": "Operating surgeon marks the site and does not start when identity, site or consent is in doubt; the named checklist lead runs each pause out loud; theatre staff refuse a retrospective tick; named theatre quality lead reviews near-misses; quality or accreditation coordinator audits"}, {"oe_code": "COP.11.e", "requirement": "The procedure is done adhering to standard precautions.", "steps": "Steps 5, 11", "evidence": "Pointer records that HIC.2 standard precautions apply in the operating theatre and procedure rooms; briefing or induction records for theatre staff; breaches handled under HIC.2 rather than a parallel theatre rule; no restated PPE or hand-hygiene protocol in this document", "responsible": "Theatre staff apply HIC.2; Infection Control Team owns the precautions; person in charge of the operating theatre ensures the briefing"}, {"oe_code": "COP.11.f", "requirement": "Procedures / operation notes, post procedure monitoring and post-operative care plan are documented accurately in the patient record.", "steps": "Steps 6, 11", "evidence": "Operation or procedure notes against the unique identification number including procedure performed, side, findings, implants or specimens, complications and names of surgeon and assistants, timed as required; recovery surgical observations; written post-operative care plan before the patient leaves recovery", "responsible": "Operating surgeon ensures the note and the post-operative plan; recovery staff record surgical observations; information-management policies own the record structure"}, {"oe_code": "COP.11.g", "requirement": "Appropriate facilities, equipment, instruments and supplies are available in the operating theatre.", "steps": "Steps 7, 11", "evidence": "Written list of theatres and procedure rooms and the procedures each may hold, aligned with the service directory; equipment inventory for each theatre; records of sterile sets present, in date, with intact indicators, and of cases stopped for an unsterile or missing set; implant availability confirmed before induction; out-of-service equipment labelled and not counted", "responsible": "Person in charge of the operating theatre keeps facilities, equipment and supplies available; HIC.6 owns instrument reprocessing; surgeons do not start without the set and implant"}, {"oe_code": "COP.11.h", "requirement": "The organization shall implement a quality assurance programme.", "steps": "Steps 8, 11", "evidence": "The named theatre quality lead and the accountability of that role for the programme running; the written quality-assurance measures covering checklist completion as a pause rather than a retrospective tick, consent before incision, documented pre-operative diagnosis, operation notes within the stated time, postponements and cancellations after arrival with reason, near-misses of wrong site, wrong patient or wrong procedure, and any actual such event with immediate report and analysis; the sample or census and the review interval; records showing the programme measured use of the pause rather than possession of the form, and that SSI rates and NHSN definitions were left to the infection-surveillance policy rather than duplicated here; any hospital-set targets recorded as this hospital's decision and not as a numeric mandate of this document; corrective and preventive actions with owner and due date rather than a reminder to be careful; the forum at which findings are reviewed, distinct from infection-control minutes treated as a substitute; the audit sample at step 11 of checklist and consent defects feeding this programme", "responsible": "Named theatre quality lead operates the programme and reports findings; head of the institution is accountable that the programme is run; quality or accreditation coordinator audits; Infection Control Team does not own this process look"}, {"oe_code": "COP.11.i", "requirement": "The organ transplant program shall be in consonance with the legal requirements and shall be conducted ethically.", "steps": "Steps 9, 11", "evidence": "The recorded hospital decision whether an organ transplant programme is conducted, matching the service directory; if none, that recorded fact and evidence that retrieval or transplantation is not performed here; if a programme exists, registration under the Transplantation of Human Organs and Tissues Act, 1994, Authorization Committee records, living-donor permissions as the Act permits, and the named programme lead", "responsible": "Head of the institution for transplant-programme status matching the directory and the Act; named transplant-programme lead where a programme exists; quality or accreditation coordinator audits the match"}, {"oe_code": "COP.11.j", "requirement": "The organization shall take measures to create awareness regarding organ donation.", "steps": "Steps 10, 11", "evidence": "The written awareness measures, materials or sessions, and display, including when no transplant programme exists; the named person who responds to a family enquiry and how a referral to the organ-transplant network is made; records kept of the measures", "responsible": "Person named at step 10 holds awareness measures; clinical staff do not pressure families; head of the institution is accountable that awareness exists without a transplant programme"}]$q$::jsonb,
