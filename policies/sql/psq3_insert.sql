-- PSQ.3 master policy -- UNAPPROVED DRAFT for review.
...
--
-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 6 PSQ, printed page 103.
...
insert into public.shco_policy_masters (
  ...
  'PSQ.3',
  'PSQ',
  array['PSQ.3.a', 'PSQ.3.b', 'PSQ.3.c', 'PSQ.3.d', 'PSQ.3.e'],
  $q$Clinical Audit and Quality Improvement Projects$q$,
  $q$This document sets out how {{HOSPITAL_NAME}} performs and documents clinical audits to improve the quality of patient care; how the parameters to be audited are defined; how medical and nursing staff participate; how remedial measures are implemented; and how the organisation undertakes quality-improvement projects.

The chapter intent is that clinical audits are used as a tool to improve patient care, that quality tools are used for improvement activities, and that improvements are sustained. A monitoring audit under PSQ.1.h counted twice, or a project that is only a poster, is not that intent.$q$,
  $q$This policy applies to medical and nursing staff who participate in clinical audit and QI projects at {{HOSPITAL_NAME}}, and to the people who define parameters and implement remedial measures.
...
- This chapter is PSQ, not CQI.$q$,
  $q${{HOSPITAL_NAME}} performs clinical audits to improve the quality of patient care and documents them.
...
{{HOSPITAL_NAME}} does not treat PSQ.1.h monitoring audits, or a 2nd Edition CQI project list, as this system.$q$,
  array[
    $s$1. Clinical audits performed and documented

Clinical audits are performed to improve the quality of patient care and documented.

How clinical audits are performed, documented, and shown to improve care, is [Hospital to define — how clinical audits are performed and documented]. Esposito and Canton (chapter reference 8) and Limb et al. (chapter reference 23) are frameworks for audit method, not pasted protocols. A monitoring checklist under PSQ.1.h is not this audit.$s$,
    $s$2. Parameters defined by the organisation

The parameters to be audited are defined by the organisation.

The current defined parameters, who defines them, and how they are kept current, are [Hospital to define — the parameters to be audited and who defines them]. Parameters match services this hospital actually runs.$s$,
    $s$3. Medical and nursing staff participate

Medical and nursing staff participates in this system.

How doctors and nurses participate (choosing parameters, collecting, reviewing, acting), is [Hospital to define — how medical and nursing staff participate in the clinical-audit system]. Participation by the quality office alone is not this OE.$s$,
    $s$4. Remedial measures implemented

Remedial measures are implemented.

How remedial measures are decided, implemented and checked for completion, is [Hospital to define — how remedial measures from clinical audit are implemented and followed through]. A recommendation without implementation is not this OE. Sustained improvement is the chapter intent; a one-off memo is incomplete.$s$,
    $s$5. Quality-improvement projects

The organisation undertakes quality improvement projects.

Which projects are undertaken, who leads them, which quality tools are used, and how they sit inside the PSQ.1.e programme, are [Hospital to define — the quality-improvement projects undertaken, who leads them, and how they are documented]. IHI QI Essentials Toolkit (chapter reference 28) and ASQ seven basic tools (chapter reference 36) are frameworks, not mandated toolkits. A project is not the whole QI programme, and the programme is not a substitute for having undertaken a project.$s$,
...
This policy is reviewed at [Hospital to define — the review interval for this policy], and sooner when an audit produced no remedial measure, or a monitoring audit was offered as clinical audit, or when PSQ.1 that this document sits inside is revised.$s$
  ],
  $q$The head of the institution is accountable for {{HOSPITAL_NAME}} running clinical audit and undertaking QI projects.
...
The quality or accreditation coordinator audits the records at step 6 and reports findings to the head of the institution.$q$,
  $q$- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Chapter 6 PSQ, standard PSQ.3.
...
- Internal documents of {{HOSPITAL_NAME}}: the clinical-audit method and parameter list; participation and remedial-measure records; QI project records; the PSQ.1 QI programme.$q$,
...
This document is not issued by, endorsed by, or affiliated with NABH, the World Health Organization, the National Centre for Disease Control, the Food Safety and Standards Authority of India, any Pollution Control Board, or any other body named in it. Wording is original; no text has been reproduced from the standards, rules or guidelines referenced.$q$,
  $q$[{"oe_code": "PSQ.3.a", "requirement": "Clinical audits are performed to improve the quality of patient care and documented.", "steps": "Steps 1, 6", "evidence": "The written clinical-audit method; sample documented audits of patient care rather than a PSQ.1.h monitoring checklist; the audit sample at step 6", "responsible": "Named lead holds the method; medical and nursing staff perform; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.3.b", "requirement": "The parameters to be audited are defined by the organisation.", "steps": "Steps 2, 1, 6", "evidence": "The current defined parameter list matching services actually run; who defines them; the audit sample at step 6", "responsible": "Named definer of parameters; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.3.c", "requirement": "Medical and nursing staff participates in this system.", "steps": "Steps 3, 1, 6", "evidence": "Records of medical and nursing participation, not quality-office-only audits; the audit sample at step 6", "responsible": "Medical and nursing staff participate; quality office supports; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.3.d", "requirement": "Remedial measures are implemented.", "steps": "Steps 4, 1, 6", "evidence": "Sample remedial measures implemented and followed through rather than recommendations left on paper; the audit sample at step 6", "responsible": "Named owners implement remedial measures; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.3.e", "requirement": "The organisation undertakes quality improvement projects.", "steps": "Steps 5, 6", "evidence": "Records of QI projects undertaken, sitting inside the PSQ.1.e programme rather than replacing it; the recorded split that IHI/ASQ tools are frameworks not mandated kits; the audit sample at step 6", "responsible": "Project leads undertake projects; PSQ.1.e owns the programme; quality or accreditation coordinator audits"}]$q$::jsonb,
...
The values the hospital must supply: how clinical audits are performed; parameters and who defines them; how medical and nursing participate; how remedial measures are implemented; QI projects; named lead; audit interval; review interval; intranet location; and any additional local abbreviation.$q$,
  '1.0',
