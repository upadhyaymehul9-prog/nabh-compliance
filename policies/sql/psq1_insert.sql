-- PSQ.1 master policy -- UNAPPROVED DRAFT for review.
...
--
-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 6 PSQ, printed page 102
...
This document is the hospital-wide patient-safety and quality-improvement programmes. It is not the intensive-care quality-assurance programme, the theatre quality-assurance programme, HAI surveillance method, or the incident-management system. Those remain the documents that own them.$q$,
  $q$This policy applies to every area of {{HOSPITAL_NAME}} and to every staff member the programmes cover. It binds the multi-disciplinary committees, the designated quality-improvement coordinator, the people who audit, and the people who monitor nursing-care quality.
...
- This chapter is PSQ, not CQI. Do not title, code or cite this document as Continuous Quality Improvement.$q$,
  $q${{HOSPITAL_NAME}} develops, implements and maintains a patient-safety programme through a multi-disciplinary committee.
...
{{HOSPITAL_NAME}} does not treat a downloaded plan, a committee that never meets, or a 2nd Edition "CQI" file retitled in ink, as these programmes.$q$,
  array[
    $s$1. Patient-safety programme developed, implemented and maintained by a multi-disciplinary committee
...
The QI committee (it may be the same body as step 1, or a distinct body — the hospital says which), the written QI programme, and the named coordinator, are [Hospital to define — the multi-disciplinary quality-improvement committee, the written comprehensive QI programme, and the designated individual who coordinates and implements it]. Comprehensive means it covers the hospital, not a single ward project. PSQ.3 owns named QI projects and clinical audit; this step owns the programme those projects sit inside. IHI Quality Improvement Essentials Toolkit (chapter reference 28) and Hughes on tools and strategies (chapter reference 15) are frameworks, not pasted protocols.$s$,
    $s$6. Quality-improvement programme review at pre-defined intervals
...
The interval, who reviews, and how opportunities are recorded, are [Hospital to define — the pre-defined interval at which the quality-improvement programme is reviewed and how opportunities for improvement are recorded]. PSQ.2.e (data verification and analysis) feeds this review; it does not replace it.$s$,
    $s$7. Audits at regular intervals as continuous monitoring
...
Which audits, the regular interval, who conducts them, and how findings enter the programmes at steps 1 and 5, are [Hospital to define — which audits are conducted at regular intervals as continuous monitoring, who conducts them, and how findings feed the patient-safety and QI programmes]. Unit QA (COP.6.d, COP.11.h) remains those unit programmes; their findings may be inputs. This step does not rewrite them.$s$,
    $s$8. Process to monitor and improve quality of nursing care
...
How quality of nursing care is monitored, by whom, which aspects, how improvement is recorded, and how it reports into the QI programme, are [Hospital to define — the established process to monitor and improve quality of nursing care]. This document does not print a named nursing-audit tool as a NABH mandate.$s$,
...
This policy is reviewed at [Hospital to define — the review interval for this policy], and sooner when a committee existed only on paper, or a 2nd Edition CQI document was offered as PSQ.1, or when PSQ.2–5, COP.4, COP.6, COP.11, COP.12, HIC.5 or MOM.7 that this document hands work to are revised.$s$
  ],
  $q$The head of the institution is accountable for {{HOSPITAL_NAME}} maintaining a patient-safety programme and a comprehensive quality-improvement programme under this document.
...
All staff are expected to treat a paper committee, a monitoring audit that is only a clinical-audit file, and a document coded CQI offered as this programme, as defects, and to report them.$q$,
  $q$- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Patient Safety and Quality Improvement chapter (Chapter 6), standard PSQ.1. This is not the 2nd Edition Continuous Quality Improvement (CQI) chapter.
...
- Internal documents of {{HOSPITAL_NAME}}: the patient-safety programme; the QI programme; committee terms and minutes; the designated coordinator's role; the monitoring-audit schedule; the nursing-care quality process; PSQ.2–5; COP.4, COP.6, COP.11, COP.12; HIC.5; MOM.7.$q$,
...
This document is not issued by, endorsed by, or affiliated with NABH, the World Health Organization, the National Centre for Disease Control, the Food Safety and Standards Authority of India, any Pollution Control Board, or any other body named in it. Wording is original; no text has been reproduced from the standards, rules or guidelines referenced.$q$,
  $q$[{"oe_code": "PSQ.1.a", "requirement": "The patient safety programme is developed, implemented and maintained by a multi-disciplinary committee.", "steps": "Steps 1, 2, 9", "evidence": "The written patient-safety programme and the multi-disciplinary committee's current membership, meeting interval and minutes showing the committee develops, implements and maintains the programme rather than a quality officer's private file or a 2nd Edition CQI manual retitled PSQ; sample implementation in areas this hospital actually runs, with a recorded absence against the service directory for a service it does not provide; the recorded use of WHO Patient Safety Solutions and High 5s (chapter references 27 and 22) as frameworks not pasted programmes; induction or briefing of committee members; the location of the programme; the audit sample at step 9 of a living committee rather than a membership list of absentees", "responsible": "Multi-disciplinary patient-safety committee owns the programme; head of the institution is accountable; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.1.b", "requirement": "The patient-safety programme identifies opportunities for improvement based on review at pre-defined intervals.", "steps": "Steps 2, 1, 9", "evidence": "The written pre-defined review interval; sample reviews that recorded opportunities rather than restating the programme text; the audit sample at step 9", "responsible": "Patient-safety committee reviews; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.1.c", "requirement": "The organisation performs proactive analysis of patient safety risks and makes improvement accordingly.", "steps": "Steps 3, 9", "evidence": "The written proactive-analysis method; sample analyses that produced an improvement; the recorded split that COP.12 owns bedside vulnerable/falls/PU identification, PSQ.5 owns after-the-fact incident analysis, and ROM.4 will own management risk duty; the audit sample at step 9", "responsible": "Named lead or committee performs analysis; COP.12/PSQ.5/ROM.4 remain those documents; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.1.d", "requirement": "The organisation adapts and implements national/international patient-safety goals/solutions.", "steps": "Steps 4, 1, 9", "evidence": "The written list of goals/solutions this hospital has adapted, matching services it actually runs; evidence of implementation in owning clinical/IPC documents rather than a reprint of COP.1, HIC.2 or MOM.6; the audit sample at step 9", "responsible": "Patient-safety committee adapts; owning clinical/IPC policies implement; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.1.e", "requirement": "A comprehensive quality improvement programme is developed, implemented and maintained by a multi-disciplinary committee.", "steps": "Steps 5, 6, 9", "evidence": "The written comprehensive QI programme and QI committee records (or the same body as step 1 with minutes that show the QI function); the recorded split that PSQ.3 owns named projects and clinical audit; the audit sample at step 9", "responsible": "QI committee owns the programme; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.1.f", "requirement": "There is a designated individual for coordinating and implementing the quality improvement programme.", "steps": "Steps 5, 9", "evidence": "The named designated individual and role; sample work showing that person coordinates implementation rather than an unnamed quality office; the audit sample at step 9", "responsible": "Designated QI coordinator; QI committee; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.1.g", "requirement": "The quality improvement programme identifies opportunities for improvement based on review at pre-defined intervals.", "steps": "Steps 6, 5, 9", "evidence": "The written pre-defined QI-programme review interval and sample dated reviews that produced an opportunity rather than an annual reprint of the same file; minutes that distinguish this review from the patient-safety-programme review at step 2 even when they share a meeting; the recorded split that PSQ.2.e data analysis feeds this review and does not replace it; the recorded refusal to treat a 2nd Edition CQI annual report as this 3rd Edition OE; induction or briefing of the QI committee on the review method; the location of review records; the audit sample at step 9 of a review that changed the programme", "responsible": "QI committee reviews; designated coordinator prepares; quality or accreditation coordinator audits"}, {"oe_code": "PSQ.1.h", "requirement": "Audits are conducted at regular intervals as a means of continuous monitoring.", "steps": "Steps 7, 9", "evidence": "The written monitoring-audit schedule (which audits, regular interval, who conducts) showing continuous monitoring of the safety and QI programmes rather than a single pre-assessment mock audit; sample audit reports whose findings entered the programmes at steps 1 and 5; the recorded split that PSQ.3 owns clinical audit of patient care and that this step is not that file counted twice; the recorded split that COP.6.d and COP.11.h remain unit QA and may feed this step as inputs; the location of the schedule; the audit sample at step 9 of monitoring audits that ran at the stated interval", "responsible": "Named auditors conduct monitoring audits; QI/safety committees receive findings; PSQ.3 owns clinical audit; quality or accreditation coordinator audits the schedule"}, {"oe_code": "PSQ.1.i", "requirement": "There is an established process in the organisation to monitor and improve quality of nursing care.", "steps": "Steps 8, 5, 9", "evidence": "The written established process to monitor and improve quality of nursing care, showing aspects monitored, who monitors, and recorded improvements, rather than a COP.4 assignment roster or a single HIC hand-hygiene rate counted as the whole process; sample ward records of that monitoring reporting into the QI programme; the recorded split that COP.4 owns nursing assignment and the nursing process as care; the recorded refusal to print a named nursing-audit tool as a NABH mandate; induction or briefing of nursing leads; the location of the process; the audit sample at step 9 of monitoring that produced an improvement", "responsible": "Nursing leadership operates the process; QI programme receives findings; COP.4 owns assignment; quality or accreditation coordinator audits"}]$q$::jsonb,
