-- COP.13 master policy -- UNAPPROVED DRAFT for review.
...
--
-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 2, printed pages 68-69
...
- The medical record itself is governed by the information-management policies of {{HOSPITAL_NAME}} (IMS, not yet drafted). This policy owns the pain, rehabilitation and nutrition content written into that record.$q$,
  $q${{HOSPITAL_NAME}} manages patients in pain. Pain is asked about, recorded, and treated; it is not inferred from whether the patient complains loudly.
...
The therapeutic diet is planned and provided collaboratively with dietetics. Kitchen food-safety practice remains the support-services infection-control policy.$q$,
  array[
    $s$1. Patients in pain are effectively managed
...
This step does not write an analgesic formulary and does not set a score at which an opioid is required.$s$,
    $s$2. Titration according to need and response
...
A patient whose pain is not responding is not left on the same plan by default. The reason for a change, or for holding the plan, is recorded.$s$,
    $s$3. Rehabilitation scope commensurate with the services of {{HOSPITAL_NAME}}
...
This step does not write AAC.1's four-way alignment check. It requires that the COP.13 scope and the directory do not disagree.$s$,
    $s$4. Collaborative rehabilitation planning
...
Internal referral into rehabilitation uses the information-sharing method of the continuity policy of {{HOSPITAL_NAME}} (AAC.7) for the referral; this step owns the rehabilitation plan that follows.$s$,
    $s$5. Nutritional-risk screening of admitted patients, and assessment of those at risk
...
The screen and the at-risk assessment are recorded against the unique identification number. The forms or fields used are [Hospital to define — where nutritional-risk screening and at-risk assessment are recorded].$s$,
    $s$6. Therapeutic diet planned and provided collaboratively
...
Provision is confirmed: the planned diet was served. How that confirmation is made is [Hospital to define — how provision of the planned therapeutic diet is confirmed].$s$,
...
This policy is reviewed at [Hospital to define — the review interval for this policy], and sooner when the service directory adds or removes rehabilitation, when unmanaged pain, an unscreened admission, or a therapeutic diet that did not reach the patient exposes a gap, or when the definition-and-display, kitchen, obstetric, paediatric, medication or assessment policies that this document hands work to are revised.$s$
  ...
  $q$The head of the institution is accountable for {{HOSPITAL_NAME}} managing pain, for a rehabilitation scope that matches the defined services, and for nutritional-risk screening of admitted patients.
...
All staff are expected to treat unasked-about pain, a rehabilitation service held out that the directory does not resource, and an admission without a nutritional-risk screen, as defects, and to report them.$q$,
  $q$- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Care of Patients chapter, standard COP.13.
...
Superseded versions are withdrawn from all points of use on issue of a revision, and one dated copy of each is retained by the quality or accreditation coordinator.$q$,
  $q$Abbreviations already defined in the HIC.1 to HIC.6 master policies are not repeated here. A reader using this document on its own should refer to those policies for the shared glossary, including NABH, SHCO, OE, SOP and PPE.
...
Several requirements in this document are statutory rather than advisory — in particular those arising under the Rights of Persons with Disabilities Act, 2016, insofar as rehabilitation services are a defined healthcare service of this hospital, and the National Medical Commission Act, 2019 insofar as registered medical practitioners must provide pain management and nutritional care consistent with professional practice. Statutory requirements change, and State authorities impose additional or stricter conditions. {{HOSPITAL_NAME}} is responsible for verifying the current text of any rule cited here and the conditions attached to its own authorisations and licences; this document does not constitute legal advice.
...
This document is not issued by, endorsed by, or affiliated with NABH, the World Health Organization, the National Centre for Disease Control, the Food Safety and Standards Authority of India, any Pollution Control Board, or any other body named in it. Wording is original; no text has been reproduced from the standards, rules or guidelines referenced.$q$,
  $q$[{"oe_code": "COP.13.a", "requirement": "Patients in pain are effectively managed", "steps": "Steps 1, 2, 7", "evidence": "The written pain-assessment method, including the scale or description method and the settings in which it is applied, with no mandated numeric cut-off; sample records against the unique identification number showing pain asked about and recorded, including for patients who cannot self-report where such a method is defined, rather than a blank field or a default zero that was not asked; a written plan for the patient in pain (pharmacological, non-pharmacological, or both) with non-pharmacological measures as this hospital defined them and pharmacological measures prescribed under the medication policies; the named person who keeps the method current; induction or briefing records showing ward staff use the method rather than waiting for a loud complaint; the audit sample at step 7 of pain asked about rather than assumed", "responsible": "Treating clinicians plan alleviation; nurses apply the assessment method; named person at step 1 keeps the method current; MOM owns the analgesic as a medication; quality or accreditation coordinator audits"}, {"oe_code": "COP.13.b", "requirement": "Pain alleviation measures or medications are initiated and titrated according to the patient's need and response.", "steps": "Steps 2, 7", "evidence": "Records of initiation and of reassessment after a measure using the same method as step 1; who may titrate within a prescribed range and when the clinician is called; recorded changes when pain does not respond; administration remaining under the medication policies", "responsible": "Nurses reassess and titrate within the prescribed range; treating clinicians review non-response; MOM owns administration records"}, {"oe_code": "COP.13.c", "requirement": "Scope of rehabilitation services at a minimum is commensurate to the services provided by the organization.", "steps": "Steps 3, 7", "evidence": "The written hospital decision whether rehabilitation is a defined healthcare service and which disciplines it includes, matching the service directory and department scopes maintained under the definition-and-display policy rather than a copied SOP for a department the hospital does not have; if rehabilitation is provided, the COP.13 scope listing disciplines, patient groups, hours and referral point, using the AAC.1 department scope and not rewriting it, and not claiming a discipline the directory does not resource; if rehabilitation is not provided, the recorded fact, evidence that physiotherapy or other rehabilitation is not displayed or held out, and the referral route used; the location of that scope or recorded absence; the Rights of Persons with Disabilities Act, 2016 cited insofar as the service exists, without a building-catalogue or section-number claim; the audit sample at step 7 of scope matching the directory or absence matching a directory without rehabilitation", "responsible": "Head of the institution for directory alignment; person who holds the rehabilitation scope at step 3; heads of rehabilitation departments where they exist author the AAC.1 scope this step uses; quality or accreditation coordinator audits the match"}, {"oe_code": "COP.13.d", "requirement": "Care providers collaboratively plan rehabilitation services.", "steps": "Steps 4, 7", "evidence": "Where rehabilitation is a defined service, sample collaborative plans stating goal, therapy, deliverable frequency and review, made with clinician, therapist, nursing and patient or family; where it is not a defined service, the recorded statement that this step does not operate; internal referral using AAC.7 for the referral method", "responsible": "Rehabilitation professionals and treating clinicians plan together where the service exists; nursing participates; AAC.7 owns referral method"}, {"oe_code": "COP.13.e", "requirement": "Patients admitted to the organization are screened for nutritional risk, and assessment is done for patients found at risk during nutritional screening.", "steps": "Steps 5, 7", "evidence": "The written nutritional-risk screening method for every admitted patient, who performs it, and by when after admission it is completed, with no mandated named tool or numeric cut-off; sample admission records against the unique identification number showing a completed screen rather than a meal-order slip treated as a screen; the named role that performs nutritional assessment of patients screened at risk, and sample assessments recording intake, the hospital's chosen nutritional findings, swallowing concern if present, and the problem the therapeutic diet must address; records showing a flagged patient was assessed rather than left flagged; the distinction recorded that obstetric antenatal nutrition and paediatric growth assessment are not this screen and are not ticked off by it; the distinction recorded that HIC.3 kitchen practice is not this screen; the location of the screen and at-risk assessment records; the audit sample at step 7 of screens on admissions and of at-risk patients assessed", "responsible": "Nurses or the named role screen every admission; dietetics or the named role assess those at risk; treating clinicians act on the assessment; kitchen does not own the screen; quality or accreditation coordinator audits"}, {"oe_code": "COP.13.f", "requirement": "The therapeutic diet is planned and provided collaboratively.", "steps": "Steps 6, 7", "evidence": "Therapeutic-diet plans agreed by clinician, dietetics and nursing; communication to the kitchen; confirmation that the planned diet was served; kitchen hygiene left to HIC.3; refusals recorded and reviewed rather than silently replaced", "responsible": "Dietetics plans with the treating clinician; nursing confirms provision; kitchen prepares under HIC.3"}]$q$::jsonb,
