-- PRE.1 master policy -- UNAPPROVED DRAFT for review.
...
--
-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 4, printed page 86
...
- Clinical procedures, anaesthesia, sedation and transfusion each own that the relevant consent happened (COP.5, COP.9, COP.10, COP.11). This document does not decide whether a unit was hung with consent.$q$,
  $q${{HOSPITAL_NAME}} documents patient and family rights and responsibilities, displays them, and makes patients and families aware of them at entry.
...
{{HOSPITAL_NAME}} requires top leadership to monitor and analyse violations and to take corrective and preventive action.$q$,
  array[
    $s$1. Documented, displayed, and patients and families made aware
...
WHO Human rights and health (chapter reference 9) may inform why a rights document exists. It is not pasted as this hospital's charter.$s$,
    $s$2. Actively promoted
...
This step does not rewrite PRE.3 consent method, PRE.5 cost explanation, or PRE.6 complaint method. It requires that those later processes are spoken of as rights, not as favours.$s$,
    $s$3. Organisation protects patient and family rights
...
How staff are expected to protect the rights in the documented set, in each care setting, is [Hospital to define — how staff protect patient and family rights in the course of care]. This step does not reprint the PRE.2 list. A failure of protection is a violation and is reported at step 4.$s$,
    $s$4. Mechanism to report a violation of patient and family rights
...
A report that can be made only to the person alleged to have committed the violation is not a mechanism.$s$,
    $s$5. Violations monitored, analysed and acted on by top leadership
...
This step does not replace PRE.6 analysis of feedback and complaints. A complaint that is not a rights violation stays PRE.6. A rights violation that never became a patient complaint still comes here.$s$,
...
This policy is reviewed at [Hospital to define — the review interval for this policy], and sooner when a patient was not made aware at entry, a display was only in an unused language, a violation had no report route, or leadership review did not happen, or when PRE.2–PRE.6 or the registration policy that this document hands work to are revised.$s$
  ...
  $q$The head of the institution is accountable for {{HOSPITAL_NAME}} documenting, displaying and making known patient and family rights and responsibilities, for protecting them, and for leadership review of violations.
...
All staff are expected to treat a hidden charter, an unexplained signature sheet, and a violation with no report route, as defects, and to report them.$q$,
  $q$- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Patient Rights and Education chapter, standard PRE.1.
...
This document is not issued by, endorsed by, or affiliated with NABH, the World Health Organization, the National Centre for Disease Control, the Food Safety and Standards Authority of India, any Pollution Control Board, or any other body named in it. Wording is original; no text has been reproduced from the standards, rules or guidelines referenced.$q$,
  $q$[{"oe_code": "PRE.1.a", "requirement": "Patient and family rights and responsibilities are documented, displayed, and they are made aware of the same.", "steps": "Steps 1, 6", "evidence": "The current documented set of patient and family rights and responsibilities, matching the list owned by the beliefs-values-and-decision-making policy rather than a quality-office charter that the wards do not use, and showing responsibilities as what this hospital asks during care rather than a numbered duties table printed as a NABH mandate; the display (boards, printed material, any online presence) in a language and a place a person entering can actually use, rather than an English-only board behind a clerk; the written awareness method at entry for out-patient first contact, emergency arrival and in-patient admission, including language or format, and sample records showing a named person made the patient or accompanying family aware rather than a harvested signature with no explanation; records of delayed awareness for an unconscious or severely distressed arrival with the reason; the recorded use of WHO Human rights and health (chapter reference 9) as a framework not pasted as the charter; the location where the documented set is held; induction or briefing records of staff at points of entry; the audit sample at step 6 of a current set, a usable display, and awareness at entry rather than a signature sheet", "responsible": "Named lead holds the documented set, display and awareness method; staff at entry make patients and families aware; quality or accreditation coordinator audits"}, {"oe_code": "PRE.1.b", "requirement": "Patient and family rights and responsibilities are actively promoted.", "steps": "Steps 2, 1, 6", "evidence": "The written promotion method for staff and for patients and families after entry, showing promotion in the course of care rather than the step-1 board counted twice or a once-a-year seminar counted as the year's work; sample records or briefing notes showing staff were shown the set, the violation-report route and that PRE.2 lists the content; sample encounters where a right about to be exercised (consent, refusal, complaint, cost) was referred to as a right; the recorded statement that PRE.3, PRE.5 and PRE.6 own those later methods and this step requires they are spoken of as rights; the audit sample at step 6 of promotion that is not only the display", "responsible": "Named lead holds the promotion method; all staff promote in the course of care; quality or accreditation coordinator audits"}, {"oe_code": "PRE.1.c", "requirement": "The organisation protects patient and family rights.", "steps": "Steps 3, 4, 6", "evidence": "The written expectation of how staff protect the rights in the documented set in each care setting, without reprinting the PRE.2 list; sample records or incident files showing a failure of protection was treated as a violation at step 4; the audit sample at step 6", "responsible": "All staff protect the rights in the documented set; named lead holds the expectation; quality or accreditation coordinator audits"}, {"oe_code": "PRE.1.d", "requirement": "The organisation has a mechanism to report a violation of patient and family rights.", "steps": "Steps 4, 5, 6", "evidence": "The written report mechanism (who may report, who receives, how it is recorded), showing a route that is not only to the person alleged to have committed the violation; records of PRE.6 complaints that alleged a rights violation also entering this violation record; the audit sample at step 6 of a usable report route", "responsible": "Named receiver holds the violation record; PRE.6 owns complaint redressal; quality or accreditation coordinator audits"}, {"oe_code": "PRE.1.e", "requirement": "Violation of patient and family rights are monitored, analysed and corrective/preventive action taken by the top leadership of the organisation.", "steps": "Steps 5, 4, 6", "evidence": "The named top-leadership reviewer, the review interval, and recorded corrective and preventive action; sample reviews showing repeated settings or failed display/promotion were acted on rather than a dormant file; the recorded split that PRE.6 analyses complaints as complaints and this step analyses rights violations; the audit sample at step 6 of leadership review that produced action", "responsible": "Top leadership reviews and acts; named lead prepares the violation record; quality or accreditation coordinator audits"}]$q$::jsonb,
