...
FILE_LAYOUT:
  ...
  drafts: policies/drafts_hco/hco_aac{N}_v2_draft.json
  masters: policies/build/masters_hco/HCO.AAC.{N}_v2_master.docx
  previews: policies/build/preview_hco/HCO.AAC.{N}_v2_preview.docx|.md
