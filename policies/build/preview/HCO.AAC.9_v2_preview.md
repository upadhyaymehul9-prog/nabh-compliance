# Imaging Quality Assurance and Safety Programme
**Preview Hospital**

*Imaging quality assurance, ALARA and radiation safety.*

## Document control

Document number: «HCO/AAC/POL/09»
Issue number: «01»
Version: 2.0 (HCO AAC v2 draft — not an approved master)
Date created: «________»
Date of implementation: «________»
Review due: «one year from implementation»

Prepared by (designation): «Imaging In-Charge»    Name: «________»    Signature: «________»
...
ALARA — As Low As Reasonably Achievable. TLD — thermo-luminescent dosimeter. RSO — Radiation Safety Officer. Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to the imaging/radiology in-charge, Radiation Safety Officer (RSO), radiographers and technologists, reporting doctors, ancillary staff posted in imaging (nurses, helpers, stretcher-bearers, housekeeping, security), treating doctors who request imaging, patients and attendants entering imaging areas, and the Quality Coordinator at Preview Hospital.
...
10. Staff who see an imaging QA or safety rule broken report it the same shift to the «Imaging In-Charge», the «Radiation Safety Officer» or the «Medical Superintendent».

## 5. What we do

### 5.1 Quality assurance programme for imaging
...
The imaging in-charge and RSO own the QA schedule; results are reviewed «monthly».

### 5.2 Appropriateness of investigations and procedures
...
### 5.3 Peer review of CT and MRI results
...
### 5.4 Clinico-radiological meetings
...
Meetings are scheduled «at least quarterly» unless the Medical Superintendent defines a different interval. Minutes record correlations, discrepancies and actions.

### 5.5 Corrective and preventive action documentation
...
CAPA from equipment-test failures, protocol deviations, peer-review discrepancies, appropriateness audits and radiation-safety incidents is logged with owner, due date and closure evidence. Open CAPA older than «thirty days» is escalated to the Medical Superintendent.

### 5.6 Radiation-safety programme
...
### 5.7 Patient screening before imaging
...
### 5.8 Use of radiation-safety and monitoring devices
...
### 5.9 Periodic testing of radiation-safety and monitoring devices
...
### 5.10 Training in imaging and radiation safety
...
Training is at induction and «annually», with records held by the imaging in-charge.

### 5.11 Imaging signage
...
The imaging in-charge and RSO check that signage remains visible and current «monthly». Obscured or missing required signage is restored the same shift.
...
The person who stops tells the «Imaging In-Charge» or the «Radiation Safety Officer» the same shift. Refusing to expose without screening or with failed safety devices is not a disciplinary matter.
...
Quality Coordinator
- Audits this policy «quarterly»; tracks CAPA to closure.
...
This policy is reviewed «annually», and sooner after a radiation incident, failed device cluster or major modality change.

## 9. Training and staff acknowledgement

All imaging staff, RSO, ancillary staff posted in imaging and doctors who request or report imaging are trained on this policy at induction and «once a year» after that. Training covers QA tests, appropriateness, peer review, ALARA, screening, device use and testing, stop-work and signage.

Staff acknowledgement

I have read this Imaging Quality Assurance and Safety Programme policy of Preview Hospital. I will follow the QA, ALARA, screening, device and stop-work processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Guidebook to Accreditation Standards for Hospitals, 6th Edition — Access, Assessment and Continuity of Care chapter, standard AAC.9 (PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).
...
The current version is available to all staff at the «front-office policy file» and, if the hospital keeps an intranet, at «staff intranet / policies».
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition AAC.9

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| AAC.9.a | The quality assurance programme for imaging services is implemented. | Section 3; 5.1 Quality assurance programme for imaging | Imaging In-Charge and RSO (run QA); Quality Coordinator (audit) |
| AAC.9.b | A system is in place to ensure the appropriateness of the investigations and procedures for the clinical indication. | Section 3; 5.2 Appropriateness of investigations and procedures; Section 4 item 1 | Imaging In-Charge / reporting doctor (screen orders); treating doctor (consult) |
| AAC.9.c | The programme addresses periodic internal / external peer review of imaging results using appropriate sampling. | Section 3; 5.3 Peer review of CT and MRI results; Section 4 item 2 | Imaging In-Charge / HOD (organise); peer reviewers (blind review); Quality Coordinator (track) |
| AAC.9.d | The programme addresses the clinico-radiological meeting(s). | Section 3; 5.4 Clinico-radiological meetings | Imaging In-Charge (convene); referring clinicians (participate) |
| AAC.9.e | The programme includes the documentation of corrective and preventive actions. | Section 3; 5.5 Corrective and preventive action documentation; Section 4 item 3 | Imaging In-Charge (log CAPA); Quality Coordinator (closure tracking) |
| AAC.9.f | The radiation-safety programme is implemented. | Section 3; 5.6 Radiation-safety programme; Section 4 item 4 | RSO (implement ALARA/AERB); Imaging In-Charge (protocols); Medical Superintendent (alignment) |
| AAC.9.g | Patients are appropriately screened for safety / risk before imaging. | Section 3; 5.7 Patient screening before imaging; Section 4 items 5–6; Section 6 Stop-work | Radiographers/technologists (screen); reporting doctor (review uncertain pregnancy); PRE process (consent) |
| AAC.9.h | Imaging personnel and patients use appropriate radiation-safety and monitoring devices where applicable. | Section 3; 5.8 Use of radiation-safety and monitoring devices; Section 4 item 7 | RSO (issue devices); imaging personnel (wear/use); Imaging In-Charge (adequacy) |
| AAC.9.i | Radiation-safety and monitoring devices are periodically tested, and results are documented. | Section 3; 5.9 Periodic testing of radiation-safety and monitoring devices; Section 4 item 8; Section 6 Stop-work | RSO (test and document); Imaging In-Charge (remove failed devices) |
| AAC.9.j | Imaging and ancillary personnel are trained in imaging safety practices and radiation-safety measures. | Section 3; 5.10 Training in imaging and radiation safety | Imaging In-Charge (train); ancillary supervisors (ensure attendance) |
| AAC.9.k | Imaging signage is prominently displayed in all appropriate locations. | Section 3; 5.11 Imaging signage; Section 4 item 9 | Imaging In-Charge and RSO (maintain displays) |

## 14. Required Records / Evidence Checklist

Records the hospital holds under this policy, listed by objective element.

### AAC.9.a — The quality assurance programme for imaging services is implemented.
...
### AAC.9.b — A system is in place to ensure the appropriateness of the investigations and procedures for the clinical indication.
...
### AAC.9.c — The programme addresses periodic internal / external peer review of imaging results using appropriate sampling.
...
### AAC.9.d — The programme addresses the clinico-radiological meeting(s).
...
### AAC.9.e — The programme includes the documentation of corrective and preventive actions.
...
### AAC.9.f — The radiation-safety programme is implemented.
...
### AAC.9.g — Patients are appropriately screened for safety / risk before imaging.
...
### AAC.9.h — Imaging personnel and patients use appropriate radiation-safety and monitoring devices where applicable.
...
### AAC.9.i — Radiation-safety and monitoring devices are periodically tested, and results are documented.
...
### AAC.9.j — Imaging and ancillary personnel are trained in imaging safety practices and radiation-safety measures.
...
### AAC.9.k — Imaging signage is prominently displayed in all appropriate locations.
