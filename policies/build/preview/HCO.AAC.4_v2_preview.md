...
*HCO Full Accreditation, 6th Edition — initial assessment.*
...
Words marked «like this» are defaults a hospital can keep. A blank marked «________» has no sensible default. Fill it in before this document is signed.

## 2. Scope

This policy applies to treating doctors, nurses and other caregivers who perform initial assessment at Preview Hospital in out-patient, day-care (including dialysis day-care), in-patient wards and emergency. It binds department heads who define who may assess, the Medical Superintendent, Medical Records, and the Quality Coordinator.
...
8. Staff who find assessment or care-plan rules not followed report it the same shift to the «treating doctor» or the «Medical Superintendent».

## 5. What we do

### 5.1 Standardised initial assessment (OP, day-care, IP, emergency)

Preview Hospital uses a standardised format for initial assessment in the OPD, day-care, in-patient and emergency areas. Formats may differ by department need but are the same within a particular area or unit. Formats capture the laid-down parameters.
...
### 5.3 Within a time frame based on patient needs

Preview Hospital defines and documents the time frame for completing initial assessment for day-care, in-patients and emergency, and implements it.

For in-patients, the clock starts when the patient arrives at the ward and stops when initial assessment is completed. The maximum time is 24 hours. Patients are assessed earlier when clinical need requires — defaults: «unstable or high-dependency within 1 hour; routine ward within 6 hours where staffing allows, and always within 24 hours».

For emergency, the clock starts at arrival at emergency and stops when initial assessment is completed — default «primary survey and vitals immediately; full emergency initial assessment within 30 minutes unless resuscitation is ongoing».

Day-care time frames are defined per service — default «before the planned procedure or dialysis session begins».

### 5.4 Nursing assessment at admission for day-care and in-patients

Initial assessment of day-care and in-patients includes nursing assessment at the time of admission, documented in the record. It identifies nursing needs and any special needs of the patient, completed within a defined time frame — default «within 1 hour of ward or day-care arrival».
...
### 5.5 Documented care plan from in-patient initial assessment
...
### 5.6 Care plan countersigned by clinician in-charge within 24 hours
...
### 5.7 Special needs regarding care following discharge
...
Preview Hospital begins identifying special discharge needs early in the assessment process — not only on the day of discharge. Nursing and medical assessments both contribute. Detailed discharge process remains under AAC.12; this step owns early identification inside the care plan.
...
Quality Coordinator
- Audits formats, time frames, nursing assessment, care plans, countersignatures and discharge-needs identification «quarterly».
...
This policy is reviewed «annually», and sooner when formats or privilege lists change.

## 8. Training and staff acknowledgement

Doctors, nurses and other caregivers who assess patients are informed of this policy at induction and «once a year» after that. Training covers area formats, privilege limits, time frames, medication reconciliation, nursing assessment, care-plan content, 24-hour countersignature, and early identification of special discharge needs.

Staff acknowledgement

I have read this Initial Assessment policy of Preview Hospital. I will assess only within my privilege, complete assessment within the defined time, document the care plan for in-patients, and obtain or provide countersignature within 24 hours.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Guidebook to Accreditation Standards for Hospitals, 6th Edition — Access, Assessment and Continuity of Care (AAC), standard AAC.4.
- Correlated standards named in the guidebook interpretation: COP.10.d; COP.11.e.
- Internal documents of Preview Hospital: initial-assessment formats (OP, day-care, IP, emergency); assessment privilege list; nursing-assessment templates; care-plan template; medication-reconciliation form; AAC.5 re-assessment policy; AAC.12 discharge policy.
...
The current version is available to all staff at the «clinical policy file» and, if the hospital keeps an intranet, at «staff intranet / policies».
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition AAC.4

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| AAC.4.a | The initial assessment of the out-patients, daycare, in-patients and emergency patients is done in a standardised manner. | Section 3; 5.1 Standardised initial assessment (OP, day-care, IP, emergency); Section 4 items 1–2 | Department heads (formats); treating doctors (complete); nurses (contribute); Quality Coordinator (hold formats) |
| AAC.4.b | The initial assessment is performed by qualified personnel. | Section 3; 5.2 Performed by qualified personnel within scope of practice; Section 4 item 3 | Medical Superintendent (approve privilege list); department heads (maintain); caregivers (assess within scope) |
| AAC.4.c | The initial assessment is performed within a time frame based on the needs of the patient. | Section 3; 5.3 Within a time frame based on patient needs; Section 4 item 4 | Treating doctors (complete on time); department heads (define specialty defaults); Quality Coordinator (audit) |
| AAC.4.d | Initial assessment of daycare and in-patients includes nursing assessment, which is done at the time of admission and documented. | Section 3; 5.4 Nursing assessment at admission for day-care and in-patients; Section 4 item 5 | Nurses (perform and document); nursing administration (templates and time frames) |
| AAC.4.e | The initial assessment for in-patients results in a documented care plan. | Section 3; 5.5 Documented care plan from in-patient initial assessment; Section 4 item 6 | Treating doctor or doctor member of treating team (document); Medical Records (presence in record) |
| AAC.4.f | The care plan is countersigned by the clinician in-charge of the patient within 24 hours. | Section 3; 5.6 Care plan countersigned by clinician in-charge within 24 hours; Section 4 item 7 | Clinician in-charge / treating doctor (countersign); junior doctors (seek countersignature) |
| AAC.4.g | The care plan includes the identification of special needs regarding care following discharge. | Section 3; 5.7 Special needs regarding care following discharge; Section 4 item 8 | Treating doctors and nurses (identify early); AAC.12 owners (execute discharge planning) |

## 13. Required Records / Evidence Checklist

Records the hospital holds under this policy, listed by objective element.

### AAC.4.a — The initial assessment of the out-patients, daycare, in-patients and emergency patients is done in a standardised manner.
...
### AAC.4.b — The initial assessment is performed by qualified personnel.
...
### AAC.4.c — The initial assessment is performed within a time frame based on the needs of the patient.
...
### AAC.4.d — Initial assessment of daycare and in-patients includes nursing assessment, which is done at the time of admission and documented.
...
### AAC.4.e — The initial assessment for in-patients results in a documented care plan.
...
### AAC.4.f — The care plan is countersigned by the clinician in-charge of the patient within 24 hours.
...
### AAC.4.g — The care plan includes the identification of special needs regarding care following discharge.
