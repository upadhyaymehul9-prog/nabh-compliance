...
*Imaging services, legal compliance and turnaround time.*

## Document control

Document number: «HCO/AAC/POL/08»
Issue number: «01»
...
Imaging services are provided as per the scope of services of the organisation — complying with legal requirements, available when clinical care needs them, reported on time, and quality-assured when outsourced.

## 1. Purpose

This policy says how Preview Hospital provides imaging services that comply with legal requirements (including Atomic Energy Regulatory Board (AERB) clearance and Pre-Conception and Pre-Natal Diagnostic Techniques (PC-PNDT) duties), keeps scope, infrastructure and human resources commensurate with clinical services, uses qualified personnel to perform, supervise and interpret investigations, delivers results within defined turnaround time (TAT) while monitoring waiting, performance and report times, intimates critical results within one hour with read-back, reports in a standardised manner (including teleradiology naming), recalls or amends reports when needed, and outsources unavailable tests under a quality-assured MoU.
...
TAT — turnaround time. RSO — Radiation Safety Officer. Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to the imaging/radiology in-charge, Radiation Safety Officer (RSO), radiographers and technologists, reporting doctors (including teleradiology reporters), treating doctors who request imaging, nurses who accompany patients, and the Quality Coordinator at Preview Hospital.
...
9. Staff who see an imaging service rule broken report it the same shift to the «Imaging In-Charge», the «Radiation Safety Officer» or the «Medical Superintendent».
...
The imaging in-charge and RSO maintain a register of licences, registrations, RSO appointment and renewal dates. Renewal is initiated «60 days before expiry». Equipment is not used when clearance has lapsed — stop-work applies.

### 5.2 Scope of imaging services
...
The imaging in-charge maintains a service menu of in-house and outsourced modalities, reviewed «annually» and whenever clinical services change.

### 5.3 Infrastructure and human resources
...
Staffing and authorised reporters are reviewed «annually» against workload.

### 5.4 Qualified performance, supervision and interpretation
...
### 5.5 Results within defined turnaround time
...
- Emergency / stat imaging: «within one hour of examination completion for the report».
- Urgent in-patient imaging: «within four hours».
- Routine out-patient imaging: «same day or next morning as defined per modality».

The imaging in-charge reviews waiting/perform/report-time data «monthly».

### 5.6 Critical imaging results
...
### 5.8 Recall and amendment of reports
...
The organisation has an MoU/agreement that incorporates quality assurance and the requirements of this standard. Refer to AAC.3.c (accompanying staff / safe transfer) and ROM.6.e (MoU quality). The panel and MoUs are reviewed «annually».
...
The person who stops tells the «Imaging In-Charge» or the «Radiation Safety Officer» the same shift, and the «Medical Superintendent» if legal clearance is the barrier. Refusing to scan without required checks is not a disciplinary matter.
...
Quality Coordinator
- Audits this policy «quarterly»; tracks CAPA when TAT, critical-result or legal-compliance defects recur.
...
This policy is reviewed «annually», and sooner when modalities, legal registrations or outsourcing arrangements change.

## 9. Training and staff acknowledgement

All imaging staff, RSO, nurses who accompany patients to imaging and doctors who request or report imaging are trained on this policy at induction and «once a year» after that. Training covers legal compliance triggers for stop-work, TAT monitoring, critical-result intimation with read-back, standardised reporting, recall/amendment and outsourcing rules.

Staff acknowledgement

I have read this Imaging Services policy of Preview Hospital. I will follow the legal-compliance, TAT, critical-result, reporting, recall and outsourcing processes described, including stop-work.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Guidebook to Accreditation Standards for Hospitals, 6th Edition — Access, Assessment and Continuity of Care chapter, standard AAC.8 (PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).
...
- Internal documents of Preview Hospital: imaging service menu; licence and RSO register; critical-result list; TAT and time-monitoring records; recall/amendment log; outsourced imaging MoUs (AAC.3.c, ROM.6.e).
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition AAC.8

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| AAC.8.a | Imaging services comply with legal and other requirements. | Section 3; 5.1 Legal and other requirements; Section 4 items 1–2, 8; Section 6 Stop-work | Imaging In-Charge and RSO (maintain compliance); Medical Superintendent (accountable) |
| AAC.8.b | Scope of the imaging services is commensurate to the services provided by the organisation. | Section 3; 5.2 Scope of imaging services | Imaging In-Charge (maintain menu); Medical Superintendent (approve) |
| AAC.8.c | The infrastructure (physical and equipment) and human resources are adequate to provide for its defined scope of services. | Section 3; 5.3 Infrastructure and human resources | Imaging In-Charge (manage); Medical Superintendent (resource) |
| AAC.8.d | Qualified and trained personnel perform, supervise and interpret the investigations. | Section 3; 5.4 Qualified performance, supervision and interpretation; Section 4 item 3 | Imaging In-Charge (competency records); reporting doctors (interpret); radiographers (perform) |
| AAC.8.e | Imaging results are available within a defined time frame. | Section 3; 5.5 Results within defined turnaround time | Imaging In-Charge (define and monitor); Quality Coordinator (audit) |
| AAC.8.f | Critical results are intimated immediately to the personnel concerned. | Section 3; 5.6 Critical imaging results; Section 4 item 4 | Designated imaging personnel (intimate); treating team (read-back); Imaging In-Charge (critical list) |
| AAC.8.g | Results are reported in a standardised manner. | Section 3; 5.7 Standardised reporting; Section 4 item 5 | Imaging In-Charge (format); reporting doctor (sign); staff (no alteration of outsourced content) |
| AAC.8.h | There is a mechanism to address the recall / amendment of reports whenever applicable. | Section 3; 5.8 Recall and amendment of reports; Section 4 item 7 | Imaging In-Charge (run mechanism); Quality Coordinator (CAPA) |
| AAC.8.i | Imaging tests not available in the organisation are outsourced to organisation(s) based on their quality assurance system. | Section 3; 5.9 Outsourced imaging tests; Section 4 item 6 | Imaging In-Charge (panel and MoU); Medical Superintendent (approve MoU) |

## 14. Required Records / Evidence Checklist

Records the hospital holds under this policy, listed by objective element.

### AAC.8.a — Imaging services comply with legal and other requirements.
...
### AAC.8.b — Scope of the imaging services is commensurate to the services provided by the organisation.
...
### AAC.8.c — The infrastructure (physical and equipment) and human resources are adequate to provide for its defined scope of services.
...
### AAC.8.d — Qualified and trained personnel perform, supervise and interpret the investigations.
...
### AAC.8.e — Imaging results are available within a defined time frame.
...
### AAC.8.f — Critical results are intimated immediately to the personnel concerned.
...
### AAC.8.g — Results are reported in a standardised manner.
...
### AAC.8.h — There is a mechanism to address the recall / amendment of reports whenever applicable.
...
### AAC.8.i — Imaging tests not available in the organisation are outsourced to organisation(s) based on their quality assurance system.
