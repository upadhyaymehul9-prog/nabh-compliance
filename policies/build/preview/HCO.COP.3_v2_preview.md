# Ambulance Services and Safe Transportation
**Preview Hospital**

*HCO Full Accreditation, 6th Edition — COP.3.*

## Document control

Document number: «HCO/COP/POL/03»
Issue number: «01»
...
Prepared by (designation): «Ambulance / Transport In-Charge»    Name: «________»    Signature: «________»
...
Preview Hospital implements COP.3 so that ambulance services ensure safe patient transportation with appropriate care..
...
### 5.2 There are adequate access and space for the ambulance(s)

There are adequate access and space for the ambulance(s).
...
### 5.4 The ambulance(s) is operated by trained personnel
...
### 5.6 The ambulance(s) has a proper communication system
...
Do not dispatch or continue an ambulance transfer when the vehicle fails its readiness check, required equipment is non-functional, the driver is not licensed for the vehicle class, or the organisation/control-room communication link is down.

Stop-work applies to the transfer dispatch, not to on-scene life-saving measures.

The person who stops tells the «Ambulance / Transport In-Charge» and the «Medical Superintendent» the same shift. Refusing an unsafe ambulance dispatch is not a disciplinary matter.

## 7. Governance and responsibility

Medical Superintendent
- Accountable that COP.3 is resourced and followed.
...
I have read this Ambulance Services and Safe Transportation policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Care of Patients, standard COP.3.
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — COP.3 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).
- Internal documents of Preview Hospital: written guidance and registers named for COP.3.
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition COP.3
