# Information, Education and Communication about Healthcare Needs
**Preview Hospital**

*Teaching patients and families about healthcare needs.*

## Document control

Document number: «PRE/POL/04»
Issue number: «01»
...
Patients and families have a right to information, education and communication about their healthcare needs in a language and manner that is understood by them — not a leaflet they cannot read and never hear explained again.

## 1. Purpose

This policy says how Preview Hospital educates the patient and/or family in a language and format they can understand; covers medicines and side effects when appropriate, food-drug interaction, diet, nutrition and immunisations, the specific disease process with complications and prevention, preventing healthcare-associated infections; and communicates effectively.
...
This policy applies wherever a patient or family is taught about healthcare needs: registration after stabilisation, out-patient, emergency, in-patient, day-care, ICU if it exists, and at discharge.

It binds treating doctors, nurses, the «Patient Rights Officer» as education lead where named, and the «Quality Coordinator» who audits.
...
Preview Hospital educates the patient and/or family in a language and format that they can understand.

Preview Hospital educates about safe and effective use of medication and potential side effects when appropriate.

Preview Hospital educates about food-drug interaction and about diet, nutrition and immunisations.

Preview Hospital educates about the specific disease process, complications and prevention strategies.

Preview Hospital educates about preventing healthcare-associated infections.

Preview Hospital communicates with patients and/or families effectively. A leaflet unread, or a monologue without checking understanding, is not effective communication.
...
Staff report defects to the «Patient Rights Officer» or «Medical Superintendent».

## 5. What we do

### 5.1 Education in a language and format they can understand

Patient and/or family are educated in a language and format that they can understand.

Language and format — spoken language, written material, interpreter, accompanying family as translator, and what is done when the patient cannot read — are chosen and recorded in «Hindi and English» or the patient's language. PRE.3.b uses the same language for consent; this step is ongoing education.

### 5.2 Medicines and potential side effects, when appropriate
...
Education is given at start of a medicine, at a change, or at discharge as this hospital defines — «at start and at any dose change, and again at discharge if the medicine continues». Administration remains MOM.6. Event capture remains MOM.7.

### 5.3 Food-drug interaction, diet, nutrition and immunisations
...
### 5.4 Specific disease process, complications and prevention
...
### 5.5 Preventing healthcare-associated infections

Patient and/or family are educated about preventing healthcare associated infections.

Patients and families are told what they can do — hand hygiene, not touching devices, telling staff of fever — as «a short ward talk at admission and a reminder at discharge». Bundles and surveillance remain HIC.

### 5.6 Communication done effectively

Communication with the patients and/or families is done effectively.

Understanding is checked — «the patient or family repeats the key point in their own words». If they cannot, staff adapt and record that. Marcus (2014) EDUCATE and Nouri and Rudd (2015) are frameworks, not mandated acronyms on a form. A harvested signature is not a check of understanding.

## 6. Governance and responsibility

Medical Superintendent — accountable for education and effective communication.
...
Quality Coordinator — audits «quarterly».

## 7. Quality monitoring (RCA → CAPA)

The Quality Coordinator audits «quarterly» for language and format; medicines when appropriate; food-drug, diet, nutrition and immunisations; disease process; HAI prevention teaching; and evidence communication was effective, not only a leaflet or signature.

Reviewed «annually» or sooner when AAC.8, MOM or HIC policies change.

## 8. Training and staff acknowledgement

Clinical staff train at induction and «once a year» on language choice, teach-back, and when to escalate if the family cannot understand.
...
- NABH SHCO 3rd Edition — standard PRE.4.
...
- Internal documents of Preview Hospital: education methods; rights, consent, discharge, medication and infection-prevention policies.

## 10. Distribution

Master copy: Medical Superintendent, Patient Rights Officer, Quality Coordinator.

Copies: out-patient, emergency, wards, ICU if exists, nursing administration.

Available at «front-office policy file» and, if the hospital keeps an intranet, at «staff intranet / policies».
...
## 12. Traceability to NABH SHCO 3rd Edition PRE.4

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| PRE.4.a | Patient and/or family are educated in a language and format that they can understand. | Statement of intent; Section 3; 5.1 Language and format; 5.6 Effective communication | Patient Rights Officer (method); doctors and nurses (teach) |
| PRE.4.b | Patient and/or family are educated about the safe and effective use of medication and the potential side effects of the medication, when appropriate. | Section 3; 5.2 Medicines and side effects; Section 4 item 2 | Staff who start or change medicines; MOM.6/MOM.7 (administration and events) |
| PRE.4.c | Patient and/or family are educated about food-drug interaction and about diet, nutrition and immunisations. | Section 3; 5.3 Food-drug, diet, nutrition and immunisations | Staff who teach; COP.13/COP.8/HIC.3 (clinical and kitchen acts) |
| PRE.4.d | Patient and/or family are educated about their specific disease process, complications and prevention strategies. | Section 3; 5.4 Disease process, complications and prevention | Treating clinicians; AAC.3 (care plan) |
| PRE.4.e | Patient and/or family are educated about preventing healthcare associated infections. | Section 3; 5.5 Preventing healthcare-associated infections | Ward nurses and doctors; HIC (IPC method) |
| PRE.4.f | Communication with the patients and/or families is done effectively. | Section 3; 5.6 Communication done effectively; Sections 5.1–5.5 | Patient Rights Officer (method); all staff who teach |

## 13. Required Records / Evidence Checklist

Records the hospital holds under this policy, listed by objective element.

### PRE.4.a — Patient and/or family are educated in a language and format that they can understand.
...
### PRE.4.b — Patient and/or family are educated about the safe and effective use of medication and the potential side effects of the medication, when appropriate.
...
### PRE.4.c — Patient and/or family are educated about food-drug interaction and about diet, nutrition and immunisations.
...
### PRE.4.d — Patient and/or family are educated about their specific disease process, complications and prevention strategies.
...
### PRE.4.e — Patient and/or family are educated about preventing healthcare associated infections.
...
### PRE.4.f — Communication with the patients and/or families is done effectively.
