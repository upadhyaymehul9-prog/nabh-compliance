# Beliefs, Values and Involvement in Decision-Making
**Preview Hospital**

*Beliefs, values and decision-making in day-to-day care.*

## Document control

Document number: «PRE/POL/02»
Issue number: «01»
...
Prepared by (designation): «Patient Rights Officer»    Name: «________»    Signature: «________»
...
Display languages: «Hindi and English»
...
Patient and family rights support individual beliefs and values and involve the patient and family in decision-making — not only on a display board they never read again.

## 1. Purpose

This policy says what patient and family rights include at Preview Hospital when beliefs, values and decision-making are in question, and how those rights are exercised in care.
...
This policy applies to every patient and family at Preview Hospital and to every staff member who must respect the rights listed here: registration, treating doctors, nurses, the «Patient Rights Officer», billing staff where cost is a right, and the «counsellor» where multidisciplinary counselling is provided.
...
Preview Hospital includes in patient and family rights the elements PRE.2.a–p name, and exercises them in the course of care — not only on a charter in the quality office.

Preview Hospital involves the patient and/or family in decision-making, including the care plan and multidisciplinary counselling when appropriate.

Preview Hospital does not treat the PRE.1 display board as a substitute for these rights being exercised, and does not rewrite PRE.3, PRE.5, PRE.6, COP.5/9/10/11, AAC.3 or AAC.8 inside this list.

## 4. Non-negotiable rules

The following are prohibited. There is no ward convenience exception.
...
Staff who see one of these acts report it the same shift to the «Patient Rights Officer» or the «Medical Superintendent».

## 5. What we do

### 5.1 Values, beliefs, preferences, culture and spiritual needs
...
The «Patient Rights Officer» holds how those are identified and responded to in the course of care. Registration staff and nurses ask at or after entry in «Hindi and English» (or the language the patient uses). Spiritual requests are passed to the person this hospital names — «the ward nurse or the counsellor» — not ignored as "not medical."
...
### 5.2 Dignity, privacy, protection and confidentiality
...
### 5.3 Refusal of treatment and additional opinion
...
Refusal is received without punishment and recorded as refusal — PRE.3 records that consent was not given. An additional opinion is facilitated as this hospital can arrange: «referral letter and appointment where the hospital has a tie-up; otherwise an honest statement of what the hospital cannot arrange». This hospital does not print a named second-hospital list as a NABH mandate.

### 5.4 Right that informed consent is obtained before named acts
...
### 5.5 Right to complain and to expected-cost information
...
### 5.6 Access to records and who receives information
...
### 5.7 Treating doctor, care plan, progress and healthcare needs
...
### 5.8 Explanation of proposed care and expected results
...
### 5.9 Care plan consultation and multidisciplinary counselling
...
The treating team consults the patient and/or family when the plan is prepared or modified. AAC.3 owns the care plan as a clinical document. PRE.5.d owns the financial implications of a change. The «counsellor» or treating team provides multidisciplinary counselling when appropriate — «for example before major surgery, on request, or when the treating doctor documents that it is needed». COP.6.e owns periodic ICU family counselling where ICU exists. Unused ICU is a recorded absence, not a copied SOP.
...
Quality Coordinator
- Audits this policy «quarterly» (see section 7).
- Tracks CAPA when the same right is not exercised twice in the same setting.

## 7. Quality monitoring (RCA → CAPA)

The Quality Coordinator audits this policy «quarterly». The audit looks at records and at the floor.
...
This policy is reviewed «annually», and sooner when PRE.1, PRE.3, PRE.4, PRE.5, PRE.6 or AAC.3 are revised.

## 8. Training and staff acknowledgement

All clinical staff and registration staff are trained on this policy at induction and «once a year» after that. Training covers the rights list, how to exercise it in care, and where PRE.3, PRE.5 and PRE.6 own the method.

Staff acknowledgement

I have read this Beliefs, Values and Involvement in Decision-Making policy of Preview Hospital. I will exercise the rights in the documented set during care, not only point to the display board.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Patient Rights and Education chapter, standard PRE.2.
...
- Internal documents of Preview Hospital: the documented rights set (with PRE.1); methods at sections 5.1–5.9; informed-consent, expected-costs, feedback-and-complaints, education, assessment, discharge, transfusion, sedation, anaesthesia, procedures and ICU policies.

## 10. Distribution

Official master copy: office of the Medical Superintendent, Preview Hospital, with the Patient Rights Officer and the Quality Coordinator.
...
## 12. Traceability to NABH SHCO 3rd Edition PRE.2

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| PRE.2.a | Patients and family rights include respecting values and beliefs, any special preferences, cultural needs, and responding to requests for spiritual needs. | Statement of intent; Section 3; 5.1 Values, beliefs, preferences, culture and spiritual needs; Section 4 items 1, 8 | Patient Rights Officer (method); registration staff and nurses (identify and respond) |
| PRE.2.b | Patient and family rights include respect for personal dignity and privacy during examination, procedures and treatment. | Section 3; 5.2 Dignity, privacy, protection and confidentiality; Section 4 item 2 | Treating doctors and nurses (apply); Patient Rights Officer (method) |
| PRE.2.c | Patient and family rights include protection from neglect or abuse. | Section 3; 5.2 Dignity, privacy, protection and confidentiality; Section 4 item 2 | All staff (protect); Patient Rights Officer (method); PRE.1.d (violation report) |
| PRE.2.d | Patient and family rights include treating patient information as confidential. | Section 3; 5.2 Dignity, privacy, protection and confidentiality; Section 4 item 2 | All staff (confidentiality); IMS owns the record file |
| PRE.2.e | Patient and family rights include the refusal of treatment. | Section 3; 5.3 Refusal and additional opinion; Section 4 item 3 | Treating doctors (receive refusal); PRE.3 (consent not given record) |
| PRE.2.f | Patient and family rights include a right to seek an additional opinion regarding clinical care. | Section 3; 5.3 Refusal and additional opinion; Section 4 item 3 | Treating doctor (facilitate); Patient Rights Officer (method) |
| PRE.2.g | Patient and family rights include informed consent before the transfusion of blood and blood components, anaesthesia, surgery, initiation of any research protocol and any other invasive/high-risk procedures/treatment. | Section 3; 5.4 Right that informed consent is obtained; Section 4 item 4 | PRE.3 (method); COP.5/9/10/11 (consent happened); Patient Rights Officer (pointer) |
| PRE.2.h | Patient and family rights include a right to complain and information on how to voice a complaint. | Section 3; 5.5 Complaint and cost rights; Section 4 item 5 | PRE.6 (mechanism); Patient Rights Officer (pointer) |
| PRE.2.i | Patient and family rights include information on the expected cost of the treatment. | Section 3; 5.5 Complaint and cost rights; Section 4 item 5 | PRE.5 (method); billing staff (do not withhold); Patient Rights Officer (pointer) |
| PRE.2.j | Patient and family rights include access to their clinical records. | Section 3; 5.6 Access to records and who receives information; Section 4 item 6 | Treating doctor or Patient Rights Officer (access); IMS/AAC.8 (file and summary) |
| PRE.2.k | Patient and family rights include information on the name of the treating doctor, care plan, progress and information on their health care needs. | Section 3; 5.7 Treating doctor, care plan, progress; Section 4 item 7 | Treating team (inform); PRE.4 (education method) |
| PRE.2.l | Patient rights include determining what information regarding their care would be provided to self and family. | Section 3; 5.6 Access to records and who receives information; Section 4 item 6 | Staff who disclose information (apply patient's determination) |
...
### PRE.2.m — The patient and/or family members are explained about the proposed care, including the risks, alternatives and benefits.
...
### PRE.2.n — The patient and/or family members are explained about the expected results and complications.
...
### PRE.2.o — The care plan is prepared and modified in consultation with the patient and/or family members.
