# -*- coding: utf-8 -*-
"""Builds the PSQ.2 master policy draft: JSON for review + SQL for later insert.
...
Official source: NABH SHCO 3rd Edition PDF, Chapter 6, PSQ.2, printed pages
102-103 (PDF indices 108-109). Intent printed page 101: collect data on
structures, processes and outcomes, especially high-risk situations; collate,
analyse and use for further improvements. Annexure 1 (Key Performance
Indicators) of the same book is a framework, not pasted as a mandated set.

Asterisks verified 2026-08-17: none of PSQ.2.a-e is asterisked.
"""
...
POLICY_TITLE = "Key Indicators for Continual Improvement"
...
PURPOSE = """This document sets out how {{HOSPITAL_NAME}} identifies and monitors key indicators to oversee clinical structures, processes and outcomes; infection-control activities; managerial structures, processes and outcomes; and patient-safety activities; and how the quality team regularly verifies that data and analyses it to identify opportunities for improvement.
...
This document is hospital-wide indicator identification, monitoring, verification and analysis. It is not HAI surveillance method, unit QA, or the safety/QI programmes that use the findings."""

SCOPE = """This policy applies to the quality team and to every area that supplies indicator data at {{HOSPITAL_NAME}}.
...
POLICY_STATEMENT = """{{HOSPITAL_NAME}} identifies and monitors key indicators for clinical structures, processes and outcomes; infection-control activities; managerial structures, processes and outcomes; and patient-safety activities.
...
This policy is reviewed at [Hospital to define — the review interval for this policy], and sooner when an unverified dashboard was used for a decision, or HAI definitions were rewritten here, or when PSQ.1, HIC.5, COP.12 or MOM.7 that this document hands work to are revised.""",
]

RESPONSIBILITY = """The head of the institution is accountable for {{HOSPITAL_NAME}} identifying and monitoring these key indicators and for the quality team verifying and analysing the data.
...
REFERENCES = """- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Chapter 6 PSQ, standard PSQ.2, and Annexure 1 Key Performance Indicators as a framework, not a mandated paste.
...
- Internal documents of {{HOSPITAL_NAME}}: the four indicator lists and collection methods; verification and analysis records; the patient-safety and QI programmes; HIC.5 surveillance; COP.12; MOM.7."""
...
OE_MAPPING = [
    {
        ...
        "steps": "Steps 1, 5, 6",
        "evidence": "The written clinical indicator list and collection method, with recorded absences for services not provided; sample monitoring records; Donabedian used as a frame not a paste; the audit sample at step 6",
        "responsible": "Named lead holds the clinical list; area leads supply data; quality team verifies; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PSQ.2.b",
        "requirement": "The organisation identifies and monitors the key indicators to oversee infection control activities.",
        "steps": "Steps 2, 5, 6",
        "evidence": "The written IC-indicator list showing HIC.5/HIC.4 figures used as inputs rather than a second case-definition book; sample monitoring; the recorded refusal to revive a 'CQI owns surveillance' assignment; the audit sample at step 6",
        "responsible": "HIC.5 owns surveillance method; this document oversees IC indicators; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PSQ.2.c",
        ...
        "steps": "Steps 3, 5, 6",
        "evidence": "The written managerial indicator list; the recorded split that ROM/FMS own the ledger and facility registers when drafted; sample monitoring; the audit sample at step 6",
        "responsible": "Named lead holds the managerial list; ROM/FMS remain those chapters; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PSQ.2.d",
        "requirement": "The organisation identifies and monitors the key indicators to oversee patient safety activities.",
        "steps": "Steps 4, 5, 6",
        "evidence": "The written patient-safety indicator list; the recorded splits that COP.12, MOM.7 and HIC.4 still own bedside/capture/occupational method; sample monitoring; the audit sample at step 6",
        "responsible": "Named lead holds the patient-safety list; owning clinical documents remain; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PSQ.2.e",
        "requirement": "Data is regularly verified by the quality team and is analysed to identify the opportunities for improvement.",
        "steps": "Steps 5, 1, 6",
        "evidence": "The written verification and analysis method and regular interval; sample verified datasets and analyses that produced opportunities handed to PSQ.1; the audit sample at step 6 of verified rather than dashboard-only data",
        "responsible": "Quality team verifies and analyses; PSQ.1 receives opportunities; quality or accreditation coordinator audits",
    },
]
...
The values the hospital must supply: clinical indicators; IC indicators; managerial indicators; patient-safety indicators; verification/analysis method; named lead; audit interval; review interval; intranet location; and any additional local abbreviation."""

SQL_HEADER = """-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 6 PSQ, printed pages 102-103.
...
if __name__ == "__main__":
    emit_and_verify(
        ...
        json_name="psq2_draft.json",
        sql_name="psq2_insert.sql",
    )
