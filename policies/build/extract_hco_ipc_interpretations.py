# -*- coding: utf-8 -*-
"""Extract 1:1 Guidebook Interpretation paragraphs for HCO IPC OEs.

Pairs Interpretation: blocks in document order with the 49 portal-PDF OEs.
...
OCR = ROOT / "policies/source/hco6_ipc_guidebook_ocr.txt"
INV = ROOT / "policies/source/hco6_ipc_inventory.json"
OUT = ROOT / "policies/source/hco6_ipc_interpretations.json"
...
def extract(ocr_text: str, oes: list[dict]) -> dict[str, str]:
    ...
    start = body.find("Interpretation: The written guidance shall be directed at prevention and control")
    if start < 0:
