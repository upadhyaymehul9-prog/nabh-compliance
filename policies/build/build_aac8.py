# -*- coding: utf-8 -*-
"""Builds the AAC.8 master policy draft: JSON for review + SQL for later insert.
...
Tier is decided by doc_required / the asterisk in the official PDF:
  Tier 1 (full treatment): none. TIER1_OES = [].
  Tier 2 (lighter pass):   AAC.8.a through AAC.8.g.

If a standard carries no asterisked OE at all, the whole standard is Tier 2.
Say so explicitly in universal_facts_checklist. This is that case.

AAC.8.g is Excellence and unasterisked. An early asterisk parse (2026-08-10)
produced a FALSE POSITIVE on AAC.8.g when the chapter References list was
swallowed into the last OE; the current extractor cuts at References and
AAC.8.g is correctly false.

Official source: NABH Standards for Small Healthcare Organisations, 3rd Edition
(August 2022), Chapter 1, standard AAC.8 and OEs AAC.8.a-g, read from the official
standards PDF (downloaded 2026-08-17 from the NABH website's Explore NABH Standards
page), printed page 54, PDF page index 60.
...
committed scripts/shco_oe_asterisks.json on all 408 entries) and the AAC.8 page
read directly. ZERO OEs of AAC.8 carry the asterisk.
"""
...
PURPOSE = """This document sets out how {{HOSPITAL_NAME}} discharges a patient and what the discharge summary contains. Every patient who leaves — including a patient who leaves against medical advice — is given a summary. The summary carries identity fields, the clinical content of the episode, follow-up advice in an understandable manner, instructions on when and how to obtain urgent care, the cause of death in the case summary when the patient has died, and the special needs of planned post-discharge care.

A patient who leaves without a summary, or with a summary the next clinician and the family cannot act on, is a patient whose care has stopped at the door. This document is the process that prevents that."""

SCOPE = """This policy applies to every point at which a patient of {{HOSPITAL_NAME}} leaves the organisation: planned discharge home, discharge to another destination, leaving against medical advice, and death in the organisation insofar as a case summary is issued. It binds the clinicians who authorise discharge, the staff who prepare and give the summary, the staff who record leaving against medical advice, and the staff who identify special needs for care following discharge.
...
- Batch and serial numbers of implantable prosthesis and medical devices, where they must also appear on the discharge summary, are governed by the medication and implant policies of {{HOSPITAL_NAME}} (MOM). This policy's clinical-content list does not replace that requirement."""

POLICY_STATEMENT = """{{HOSPITAL_NAME}} discharges against a defined process. A discharge summary is given to every patient who leaves, including a patient who leaves against medical advice. Leaving against medical advice does not cancel the summary.
...
{{HOSPITAL_NAME}} treats a patient who left without a summary, or a summary missing a required field, as a defect."""

PROCEDURE_STEPS = [
"""1. The discharge process, and giving the summary to every leaving patient
...
A patient transferred out to another organisation under the registration, admission and transfer policy is still a leaving patient under this step and is given the summary. The transfer note and the receiving organisation are AAC.2's.""",

"""2. Identity fields of the discharge summary
...
Date of discharge for LAMA is the date the patient left. Date of discharge in the case of death is the date of death as recorded in the case summary at step 6.""",

"""3. Clinical content of the discharge summary
...
Batch and serial numbers of implantable prosthesis and medical devices, where an implant was used, appear on the summary because the medication and implant policies of {{HOSPITAL_NAME}} require them. This step's clinical-content list does not replace that requirement.""",

"""4. Follow-up advice in an understandable manner
...
How follow-up advice, discharge medication and other instructions are written on the summary so that they are understandable is [Hospital to define — how follow-up advice, discharge medication and other instructions are written so that they are understandable].""",

"""5. Instructions about when and how to obtain urgent care
...
A summary that lists follow-up appointments but is silent on urgent care does not meet this step.""",

"""6. Cause of death in the case summary
...
The case summary of a death still carries the identity fields at step 2 and the clinical content at step 3, with the cause of death in addition.""",

"""7. Planned discharge and special needs following discharge
...
RESPONSIBILITY = """The head of the institution is accountable for {{HOSPITAL_NAME}} having a working discharge process and for a discharge summary being given to every leaving patient, including a patient who leaves against medical advice.
...
All staff are expected to report a patient who left without a summary, a summary missing a required field, or a death whose case summary omitted the cause of death."""

REFERENCES = """- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Access, Assessment and Continuity of Care chapter, standard AAC.8.
...
STATUTE_CLAUSE = (
    "the Registration of Births and Deaths Act, 1969 insofar as a death in the organisation "
    "must be certified and recorded, the Clinical Establishments (Registration and Regulation) "
    "Act, 2010 and the rules under it, where adopted by the State — or the corresponding State "
    "law — and the Consumer Protection Act, 2019"
)
...
OE_MAPPING = [
    {
        "oe_code": "AAC.8.a",
        "requirement": "A discharge summary is given to all patients leaving the organisation, including patients leaving against medical advice",
        "steps": "Steps 1, 8",
        "evidence": "The written discharge process naming who authorises discharge, who prepares and gives the summary, and how LAMA is recorded; sample summaries given to planned discharges and to LAMA patients, showing the summary was given before leaving; LAMA documentation that still includes a summary; records of patients transferred out who were given the summary in addition to the AAC.2 transfer note; the audit sample at step 8 covering a summary given to every leaving patient including LAMA",
        "responsible": "Clinicians authorise discharge; staff who prepare and give the summary do so before the patient leaves, including LAMA; information-management policies own filing of the copy; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "AAC.8.b",
        "requirement": "The discharge summary contains the patient's name, unique identification number, date of admission and date of discharge",
        "steps": "Steps 2, 8",
        "evidence": "Sample discharge summaries showing name, unique identification number, date of admission and date of discharge; records showing the unique identification number matches the number generated at registration under AAC.2.b rather than a second number; LAMA and death summaries showing the date of leaving or the date of death; the audit sample at step 8 of identity fields",
        "responsible": "Staff who prepare the summary enter the identity fields; registration and admission policy owns generation of the unique identification number; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "AAC.8.c",
        "requirement": "The discharge summary contains reasons for admission, significant findings and diagnosis, condition at discharge, investigation results, procedures, medication administered and other treatment given",
        "steps": "Steps 3, 8",
        "evidence": "The discharge-summary form or electronic template capturing each required clinical field; sample summaries showing those fields completed or marked as not applicable rather than left blank; the audit sample at step 8 of clinical content",
        "responsible": "The authorising clinician is responsible for clinical content; staff who prepare the summary complete the form; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "AAC.8.d",
        "requirement": "The discharge summary contains follow-up advice, medication and other instructions in an understandable manner",
        "steps": "Steps 4, 8",
        "evidence": "The written method for how follow-up advice, discharge medication and other instructions are written so that they are understandable; sample summaries showing that advice in a language and wording the patient can act on; the audit sample at step 8 of understandable follow-up advice",
        "responsible": "Staff who prepare the summary write the advice; patient-rights and education policies own the method of teaching the patient; this policy owns that the advice is on the summary; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "AAC.8.e",
        "requirement": "The discharge summary incorporates instructions about when and how to obtain urgent care",
        "steps": "Steps 5, 8",
        "evidence": "The written urgent-care instructions stating when to return, how to make contact, and where; sample summaries showing those instructions present rather than follow-up appointments alone; the audit sample at step 8 of urgent-care instructions",
        "responsible": "Staff who prepare the summary include the urgent-care instructions; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "AAC.8.f",
        "requirement": "In case of death, the summary of the case also includes the cause of death",
        "steps": "Steps 6, 8",
        "evidence": "Sample death case-summaries showing the cause of death in addition to identity fields and clinical content; records distinguishing the clinical case summary from the statutory death certificate under the Registration of Births and Deaths Act, 1969; the audit sample at step 8 of death case-summaries",
        "responsible": "The clinician who completes the case summary records the cause of death; statutory certification under the Registration of Births and Deaths Act, 1969 is a separate document and is not performed under this policy; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "AAC.8.g",
        "requirement": "The organisation adheres to planned discharge and identifies special needs regarding care following discharge",
        "steps": "Steps 7, 8",
        "evidence": "The written method for initiating planned discharge and for identifying and recording special post-discharge needs; sample summaries showing those needs recorded and handed to whoever will provide the care; the audit sample at step 8 of planned-discharge and special-needs entries",
        "responsible": "Staff who plan discharge identify special post-discharge needs and record them on the summary; quality or accreditation coordinator audits",
    },
]
...
SQL_HEADER = """-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 1, printed page 54
...
if __name__ == "__main__":
    emit_and_verify(
        ...
        json_name="aac8_draft.json",
        sql_name="aac8_insert.sql",
    )
