# -*- coding: utf-8 -*-
"""Builds the PRE.2 master policy draft: JSON for review + SQL for later insert.
...
NO OE CARRIES THE ASTERISK. The whole standard is Tier 2. Sixteen OEs (a-p)
are clustered into ten procedure steps so the draft does not grow sixteen
Tier-1 blocks.

Official source: NABH Standards for Small Healthcare Organisations, 3rd Edition
(August 2022), Chapter 4 Patient Rights and Education, standard PRE.2 and OEs
PRE.2.a-e printed page 86 (PDF page index 92), PRE.2.f-p printed page 87
(PDF page index 93). Chapter intent printed page 85, PDF page index 91.

Asterisks verified 2026-08-17: none of PRE.2.a-p is asterisked in the PDF or in
scripts/shco_oe_asterisks.json.

The chapter bibliography's sources for rights content are WHO Human rights and
health (ch 9) and Olejarczyk and Young 2021 (ch 15). No named Act of Parliament
is a numbered PRE chapter reference for this standard's subject. Capacity under
the Mental Healthcare Act, 2017 is PRE.3.c, not this list.
"""
...
This document owns what the rights include and how they are exercised in care. PRE.1 owns that a documented set exists, is displayed, is made known, is promoted and is protected. PRE.3 owns consent method. PRE.5 owns cost information. PRE.6 owns complaint redressal. Those methods are not rewritten here."""

SCOPE = """This policy applies to every patient and family at {{HOSPITAL_NAME}} and to every staff member who must respect the rights listed here. It binds clinicians, nurses, registration and anyone who handles patient information.
...
- Unused research or unused ICU is a recorded absence against AAC.1, not a copied SOP in this list."""

POLICY_STATEMENT = """{{HOSPITAL_NAME}} includes in patient and family rights the elements PRE.2.a-p name, and exercises them in the course of care.
...
{{HOSPITAL_NAME}} does not treat the PRE.1 display board as a substitute for these rights being exercised, and does not rewrite PRE.3, PRE.5, PRE.6, COP.5/9/10/11, AAC.3 or AAC.8 inside this list."""

PROCEDURE_STEPS = [
"""1. Values, beliefs, special preferences, cultural and spiritual needs
...
How those are identified and responded to in the course of care is [Hospital to define — how values, beliefs, special preferences, cultural needs and spiritual-need requests are identified and responded to]. A copied dietary-preference form is not by itself this OE. This document does not print a religion table as a NABH mandate. WHO Human rights and health (chapter reference 9) and Olejarczyk and Young (2021) — chapter reference 15 — are frameworks for rights content, not pasted charters.""",

"""2. Dignity and privacy; protection from neglect or abuse; confidentiality of patient information
...
This step is a pointer. Complaint mechanism and awareness of the procedure are PRE.6. Pricing policy, tariff and expected-cost explanation are PRE.5. How these two rights are made known as rights, without rewriting those methods, is [Hospital to define — how the rights to complain (and how to voice a complaint) and to information on expected cost are made known as rights].""",

"""6. Access to clinical records; determining what information is provided to self and family
...
"""7. Information on the treating doctor, care plan, progress and healthcare needs
...
How that information is given and recorded is [Hospital to define — how patients and families are informed of the treating doctor's name, the care plan, progress and healthcare needs]. Ongoing education about healthcare needs as a teaching method remains PRE.4. This step is the right to be told who is treating them and how they are doing.""",

"""8. Explanation of proposed care, expected results and complications
...
This policy is reviewed at [Hospital to define — the review interval for this policy], and sooner when a right was displayed but not exercised, or when PRE.1, PRE.3, PRE.4, PRE.5, PRE.6, AAC.3, AAC.8 or COP.5/9/10/11 that this document hands work to are revised.""",
]

RESPONSIBILITY = """The head of the institution is accountable for {{HOSPITAL_NAME}} exercising the rights PRE.2.a-p name, not only displaying them.
...
All staff are expected to treat a displayed right that is not exercised as a defect, and to report it as a PRE.1.d violation where it is one."""

REFERENCES = """- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Patient Rights and Education chapter, standard PRE.2.
...
- Internal documents of {{HOSPITAL_NAME}}: the documented rights set (with PRE.1); the methods at steps 1-9; the informed-consent, expected-costs, feedback-and-complaints, education, assessment, discharge, transfusion, sedation, anaesthesia, procedures, ICU and information-management policies."""
...
OE_MAPPING = [
    {
        ...
        "steps": "Steps 1, 10",
        "evidence": "The written method for identifying and responding to values, beliefs, special preferences, cultural needs and spiritual-need requests; sample records of a response rather than a copied religion table; the audit sample at step 10",
        "responsible": "Named lead holds the method; staff in the course of care apply it; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.b",
        ...
        "steps": "Steps 2, 10",
        "evidence": "The written method for dignity and privacy during examination, procedures and treatment; sample practice or incident files showing a screen or equivalent rather than corridor discussion; the audit sample at step 10",
        "responsible": "Staff who examine or treat apply the method; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.c",
        "requirement": "Patient and family rights include protection from neglect or abuse.",
        "steps": "Steps 2, 10",
        "evidence": "The written method for protection from neglect or abuse and how a suspicion is reported; the recorded split that a rights-violation suspicion also enters PRE.1.d; the audit sample at step 10",
        "responsible": "All staff protect; PRE.1.d owns the violation report; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.d",
        "requirement": "Patient and family rights include treating patient information as confidential.",
        "steps": "Steps 2, 10",
        "evidence": "The written method for confidentiality as a patient right; the recorded split that IMS owns the record as a file; sample defects (open record at a public desk) treated as violations; the audit sample at step 10",
        "responsible": "All staff treat information as confidential; IMS owns the file; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.e",
        "requirement": "Patient and family rights include the refusal of treatment.",
        "steps": "Steps 3, 10",
        "evidence": "The written method for receiving and recording refusal; the recorded split that PRE.3 records consent not given; sample refusals; the audit sample at step 10",
        "responsible": "Clinicians receive refusal; PRE.3 owns the consent record; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.f",
        "requirement": "Patient and family rights include a right to seek an additional opinion regarding clinical care.",
        "steps": "Steps 3, 10",
        "evidence": "The written method for facilitating an additional opinion, including what this hospital can and cannot arrange; sample records; the audit sample at step 10",
        "responsible": "Treating doctor facilitates; named lead holds the method; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.g",
        ...
        "steps": "Steps 4, 10",
        "evidence": "The recorded pointer that PRE.3 owns consent method and COP.5/9/10/11 own that the relevant consent happened before those acts; the method for making this right known as a right; a recorded absence against AAC.1 for a class not provided; the audit sample at step 10 of the pointer not rewritten as a consent SOP",
        "responsible": "PRE.3 owns method; COP.5/9/10/11 own that consent happened; this document lists the right; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.h",
        "requirement": "Patient and family rights include a right to complain and information on how to voice a complaint.",
        "steps": "Steps 5, 10",
        "evidence": "The recorded pointer that PRE.6 owns the complaint mechanism and awareness of the procedure; the method for making this right known as a right; the audit sample at step 10",
        "responsible": "PRE.6 owns the mechanism; this document lists the right; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.i",
        "requirement": "Patient and family rights include information on the expected cost of the treatment.",
        "steps": "Steps 5, 10",
        "evidence": "The recorded pointer that PRE.5 owns pricing policy, tariff and explanation; the method for making this right known as a right; the audit sample at step 10",
        "responsible": "PRE.5 owns the method; this document lists the right; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.j",
        "requirement": "Patient and family rights include access to their clinical records.",
        "steps": "Steps 6, 10",
        "evidence": "The written method for access to clinical records during care; the recorded split that AAC.8 owns the discharge summary and IMS owns the file; the audit sample at step 10",
        "responsible": "Named staff give access as a right; IMS/AAC.8 own the file and the summary; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.k",
        ...
        "steps": "Steps 7, 10",
        "evidence": "The written method for telling the treating doctor's name, care plan, progress and healthcare needs; the recorded split that PRE.4 owns teaching method; sample records; the audit sample at step 10",
        "responsible": "Treating team informs; PRE.4 owns education method; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.l",
        ...
        "steps": "Steps 6, 10",
        "evidence": "The written method for the patient determining what information is provided to self and family; sample records showing a relative's demand against that determination was refused; the audit sample at step 10",
        "responsible": "Staff who disclose information apply the patient's determination; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.m",
        ...
        "steps": "Steps 8, 10",
        "evidence": "The written method for explaining proposed care including risks, alternatives and benefits as a decision-making right; the recorded split that PRE.3.b is the consent conversation and PRE.4.d is disease-process education; sample explanations; the audit sample at step 10",
        "responsible": "Clinicians explain proposed care; PRE.3/PRE.4 own consent conversation and ongoing education; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.n",
        "requirement": "The patient and/or family members are explained about the expected results and complications.",
        "steps": "Steps 8, 10",
        "evidence": "The written method for explaining expected results and complications; the same PRE.3.b/PRE.4.d split as PRE.2.m; sample explanations; the audit sample at step 10",
        "responsible": "Clinicians explain expected results and complications; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.o",
        "requirement": "The care plan is prepared and modified in consultation with the patient and/or family members.",
        "steps": "Steps 9, 10",
        "evidence": "The written method for consulting the patient and/or family when the plan is prepared or modified; the recorded split that AAC.3 owns the clinical care plan and PRE.5.d owns financial implications of a change; sample plans showing consultation; the audit sample at step 10",
        "responsible": "Treating team consults; AAC.3 owns the plan document; PRE.5.d owns the money of a change; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PRE.2.p",
        "requirement": "The patient and/or family members are provided multidisciplinary counselling when appropriate.",
        "steps": "Steps 9, 10",
        "evidence": "The written description of when multidisciplinary counselling is provided and by whom; the recorded split that COP.6.e owns periodic ICU family counselling where ICU exists; a recorded absence against AAC.1 if ICU is not provided; the audit sample at step 10",
        "responsible": "Named counsellors provide when appropriate; COP.6 owns ICU periodicity; quality or accreditation coordinator audits",
    },
]
...
SQL_HEADER = """-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 4, printed pages 86-87
...
if __name__ == "__main__":
    emit_and_verify(
        ...
        json_name="pre2_draft.json",
        sql_name="pre2_insert.sql",
    )
