...
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — IPC.{n} interpretations (source PDF md5 {GUIDEBOOK_MD5}).
        ...
        "revision_history": [
            {
                "version": "2.0",
                "date": "21-08-2026",
                "description": f"HCO Full 6th Edition IPC.{n} v2 draft: portal PDF OE data + Guidebook interpretations.",
            }
        ],
        "status": "draft",
