# -*- coding: utf-8 -*-
"""Builds the COP.7 master policy draft: JSON for review + SQL for later insert.
...
Tier is decided by doc_required / the asterisk in the official PDF:
  Tier 1 (full treatment): COP.7.a, COP.7.c
  Tier 2 (lighter pass):   COP.7.b, COP.7.d, COP.7.e

TWO of five OEs are asterisked. The draft builds deep blocks for a and c.
b, d and e are lean.

CRITICAL OVERLAP:
- PC-PNDT 1994: this document owns the obstetric process and that antenatal
  care does not include sex determination. Imaging LICENCES stay with AAC.5.
- COP.7.e neonatal backup vs COP.8 neonatal care: COP.7 owns that the obstetric
  service has human resources and facilities to take care of neonates of
  high-risk cases. COP.8 (sibling, drafted separately) owns how neonates and
  children are cared for. Stated in Scope.

Official source: NABH Standards for Small Healthcare Organisations, 3rd Edition
(August 2022), Chapter 2 Care of Patients, standard COP.7 and OEs COP.7.a-e, read
from the official standards PDF (downloaded 2026-08-17 from the NABH website's
Explore NABH Standards page), printed pages 64-65, PDF page index 70-71.
...
committed scripts/shco_oe_asterisks.json on all 408 entries) and the COP.7 pages
read directly. COP.7.b, COP.7.d and COP.7.e are unasterisked; COP.7.a and
COP.7.c carry the asterisk. COP.7.a was among the 2026-08-10 audit flips
(now asterisked).
"""
...
Obstetric care is where three legal duties sit on the same patient: the prohibition of sex determination, the law on termination of pregnancy where termination is provided, and the registration of live birth and stillbirth. This document exists so that those duties are part of the obstetric process, not notices on someone else's wall."""

SCOPE = """This policy applies to every location at {{HOSPITAL_NAME}} in which obstetric care is provided: the antenatal clinic, the labour room, the postnatal ward, the operation theatre insofar as a caesarean birth or an obstetric procedure is performed there, the emergency area insofar as an obstetric emergency is received, and any high-dependency or intensive-care area that receives an obstetric patient. It binds the doctors and nurses who provide obstetric care, the staff who identify high-risk pregnancy, the staff who monitor mother and neonate around birth, and whoever arranges referral of a high-risk case this hospital cannot manage.
...
- The medical record itself is governed by the information-management policies of {{HOSPITAL_NAME}}."""

POLICY_STATEMENT = """{{HOSPITAL_NAME}} organises and provides obstetric services safely. Antenatal care, labour, birth and postnatal care are a defined service with written guidance, not a room that is used when a woman arrives.
...
{{HOSPITAL_NAME}} does not determine or communicate the sex of a foetus. Termination of pregnancy, where provided, is provided in consonance with the Medical Termination of Pregnancy Act, 1971 as amended in 2021. Live births and stillbirths are registered under the Registration of Births and Deaths Act, 1969."""

PROCEDURE_STEPS = [
"""1. Obstetric services organised and provided safely
...
Where this hospital cannot provide the care the high-risk case needs — including when the neonatal backup at step 5 is not available for the neonate of that case — the patient is referred to another appropriate centre. The clinical decision to refer is this step's. The between-organisation transfer is performed under the registration, admission and transfer policy of {{HOSPITAL_NAME}}. Referral is not delayed until an emergency that this hospital has already said it cannot manage.""",

"""3. Antenatal assessment includes maternal nutrition
...
Advice given under this step is recorded against the unique identification number. If the hospital refers the woman to dietetics, that referral is recorded; the referral does not replace the inclusion of nutrition in the antenatal assessment itself.""",

"""4. Peri-natal and post-natal monitoring
...
Deterioration of the mother is escalated using the early-warning process of the assessment policy of {{HOSPITAL_NAME}} where that process applies, and using obstetric emergency response as the obstetric guidance at step 1 provides. Cardio-pulmonary resuscitation, when needed, uses the resuscitation policy.""",

"""5. Human resources and facilities for neonates of high-risk cases
...
RESPONSIBILITY = """The head of the institution is accountable for {{HOSPITAL_NAME}} organising obstetric services as a defined safe service, for antenatal assessment that includes maternal nutrition, for high-risk cases being identified and either cared for or referred, and for neonatal backup existing when high-risk obstetric care is provided.
...
All staff are expected to treat communication of foetal sex, a high-risk birth without backup, an antenatal record without maternal nutrition, and a birth that was not registered, as defects, and to report them."""

REFERENCES = """- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Care of Patients chapter, standard COP.7.
...
STATUTE_CLAUSE = (
    ...
    "Act, 1994, insofar as it prohibits sex determination in obstetric care, the Medical "
    "Termination of Pregnancy Act, 1971 as amended in 2021 where termination of pregnancy "
    "is provided, and the Registration of Births and Deaths Act, 1969 for registration of "
...
SQL_HEADER = """-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 2, printed pages 64-65
...
if __name__ == "__main__":
    emit_and_verify(
        ...
        json_name="cop7_draft.json",
        sql_name="cop7_insert.sql",
    )
