...
VERSION = "1.0"
REVISION_HISTORY = [
    {"version": "1.0", "date": "17-08-2026", "description": "Initial release, with a distinct chemotherapeutic-agent handling block (PPE, spill, closed-system transfer or equivalent, extravasation, hazardous waste) and NIOSH/OSHA/USP <800>/ESMO–EONS cited as frameworks, not as NABH mandates."},
]
...
The PPE, spill, closed-system transfer or equivalent, and hazardous-waste paragraphs of this step are informed by the NIOSH Alert on preventing occupational exposures to antineoplastic and other hazardous drugs, OSHA's guidance on controlling occupational exposure to hazardous drugs, and USP General Chapter 800 on handling hazardous drugs in healthcare settings. Those documents are frameworks. They are not pasted as this hospital's method, they are not a numbered pharmacy-chapter mandate of NABH, they are not Indian statutes, and they are not applied to narcotic drugs and psychotropic substances. Extravasation response is informed by the ESMO–EONS clinical practice guidelines on management of chemotherapy extravasation as a framework; this document does not print that guideline's vesicant tables or antidotes.
...
- NIOSH Alert: Preventing Occupational Exposures to Antineoplastic and Other Hazardous Drugs in Healthcare Settings, DHHS (NIOSH) Publication No. 2004-165 (September 2004) — used for extra hazardous-drug PPE, the cytotoxic-spill method, closed-system transfer or equivalent, and hazardous-waste handling as occupational-exposure controls. Not among the MOM chapter's numbered references. Not a NABH mandate. Not applied to narcotic drugs and psychotropic substances.
- Occupational Safety and Health Administration, Controlling Occupational Exposure to Hazardous Drugs — OSHA's occupational-exposure guidance for hazardous drugs in healthcare settings (https://www.osha.gov/hazardous-drugs/controlling-occex). Used as a framework for worker protection at preparation and administration. Not an Indian statute and not named in paragraph 2 of the Disclaimer.
- United States Pharmacopeia, General Chapter <800> Hazardous Drugs—Handling in Healthcare Settings (official 1 December 2019) — used for closed-system transfer or equivalent and handling controls that limit aerosol and splash. This document does not treat that chapter number as an NABH requirement and does not name a brand of device.
- Pérez Fidalgo JA, García Fabregat L, Cervantes A, Margulies A, Vidall C, Roila F; ESMO Guidelines Working Group. Management of chemotherapy extravasation: ESMO–EONS Clinical Practice Guidelines. Ann Oncol. 2012;23 Suppl 7:vii167–vii173 — used as the framework for stop-the-infusion, who is called, site management and record. This document does not print that guideline's vesicant tables or antidotes as mandates.
...
8. NO NUMBERS ARE STATED as requirements -- no lock counts, no chemo doses, no destruction recipes, no schedule lists, no USP chapter numbers as NABH mandates, no CSTD brand. Every such value is [Hospital to define].
...
9a. NIOSH Alert DHHS (NIOSH) Publication 2004-165 (September 2004), OSHA Controlling Occupational Exposure to Hazardous Drugs, USP General Chapter <800> Hazardous Drugs—Handling in Healthcare Settings (official 1 December 2019), and ESMO–EONS Management of chemotherapy extravasation (Ann Oncol 2012;23 Suppl 7:vii167–vii173) are cited in References and named as frameworks at step 4. They are NOT Indian statutes and are NOT in P2. They are NOT among the MOM chapter's numbered references (printed p.82-84). They are NOT NABH mandates. NDPS is not applied to them.
...
15. Adding NIOSH 2004-165, OSHA hazardous-drug occupational-exposure guidance, USP <800>, and ESMO–EONS 2012 to References (2026-08-17, before insert) is an editorial position required by the owner's instruction that every substantive claim have a traceable citation. They remain frameworks, not P2 statutes.
...
- USP <800> or any numbered pharmacy chapter as an NABH mandate; a named CSTD brand; a vesicant list or named antidotes as mandate. Those sources ARE cited in References as frameworks.
