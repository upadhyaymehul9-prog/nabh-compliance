...
This document accepts the handoff from the procedural-sedation and anaesthesia policies of {{HOSPITAL_NAME}}: the clinical act of sedating or anaesthetising remains those policies; the Narcotic Drugs and Psychotropic Substances Act, 1985 cupboard, register and destruction live here."""
...
The written safe-use guidance — the named classes, the recorded absences, and the pointer to steps 2 to 5 for the classes in use — is held at [Hospital to define — where the written safe-use guidance for these three classes is held]. A location that holds a class this hospital has not named does not use it.""",
...
"""4. Chemotherapy and radioactive agents prepared properly and safely, and administered by qualified personnel
...
A chemotherapeutic dose prepared in the operation theatre is still prepared and administered under this step. The surgical act is the procedures-and-operation-theatre policy of {{HOSPITAL_NAME}}.""",

"""5. Record of usage, administration and disposal
...
All staff are expected to treat an unlocked narcotic, a chemotherapeutic preparation by an unnamed person, and a copied bunker for a class this hospital does not use, as defects, and to report them."""
...
OE_MAPPING = [
    ...
    },
    {
        ...
        "steps": "Steps 4, 1, 6",
        "evidence": "The named persons who may prepare and who may administer chemotherapy and radioactive agents used as therapy, and where preparation is done, or the recorded absence if the class is not used; sample preparation and administration records against the unique identification number where the class is in use; the recorded application of the infection-prevention policy for PPE at preparation without rewriting it, and of the biomedical-waste policy for cytotoxic waste without restating colours; records showing a chemotherapeutic dose in the operation theatre was still prepared and administered under this step; the audit sample at step 6 of preparation and administration only where the class is in use and only by the named persons",
        "responsible": "Named lead holds the qualified-person lists where those classes are used; named preparers and administrators apply them; HIC.2 owns PPE method; HIC.3 owns the waste stream; COP.11 owns the surgical act; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "MOM.8.e",
