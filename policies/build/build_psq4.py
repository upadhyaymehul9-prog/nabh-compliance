# -*- coding: utf-8 -*-
"""Builds the PSQ.4 master policy draft: JSON for review + SQL for later insert.
...
Official source: NABH SHCO 3rd Edition PDF, Chapter 6, PSQ.4, printed pages
103-104 (PDF indices 109-110). Intent printed page 101: department leaders
play an active role; management should support the patient safety and quality
programme.

Asterisks verified 2026-08-17: none of PSQ.4.a-d is asterisked.
"""
...
POLICY_TITLE = "Management Support for Patient Safety and Quality"
...
PURPOSE = """This document sets out how management at {{HOSPITAL_NAME}} creates a culture of safety; how leaders at all levels are aware of the intent of the patient-safety quality-improvement programme and the approach to its implementation; how management makes available adequate resources and earmarks adequate funds from the annual budget; and how management uses workforce feedback to improve the programme.

The chapter intent is that department leaders play an active role and that management supports the patient-safety and quality programme. A poster about safety culture, or a budget line that is never spent, is not that intent."""

SCOPE = """This policy applies to those who manage {{HOSPITAL_NAME}} and to leaders at all levels who must know the intent and approach of the programme.
...
POLICY_STATEMENT = """{{HOSPITAL_NAME}} requires management to create a culture of safety.
...
{{HOSPITAL_NAME}} does not treat a safety-culture poster, or an unspent budget line, as that support."""
...
This policy is reviewed at [Hospital to define — the review interval for this policy], and sooner when an earmark was absent from the budget, or only one level of leader could explain the programme, or when PSQ.1 or ROM that this document hands work to are revised.""",
]

RESPONSIBILITY = """The head of the institution is accountable for management support of the patient-safety and QI programme at {{HOSPITAL_NAME}}.
...
REFERENCES = """- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Chapter 6 PSQ, standard PSQ.4.
...
- Internal documents of {{HOSPITAL_NAME}}: the culture-of-safety method; leader-awareness method; budget earmark; workforce-feedback method; the PSQ.1 programmes; ROM policies when drafted."""
...
OE_MAPPING = [
    {
        ...
        "steps": "Steps 1, 5",
        "evidence": "The written method for creating a culture of safety and sample evidence that is more than a poster; the recorded splits that PSQ.5 owns the incident system and ROM.1.e will own ethical framework; AHRQ/Weaver used as frameworks not a mandated survey; the audit sample at step 5",
        "responsible": "Head of the institution and management create the culture; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PSQ.4.b",
        "requirement": "The leaders at all levels in the organisation are aware of the intent of the patient safety quality improvement program and the approach to its implementation.",
        "steps": "Steps 2, 5",
        "evidence": "The written awareness method covering leaders at all levels this hospital has; sample records showing more than one level can state intent and approach; the audit sample at step 5",
        "responsible": "Leaders at all levels must be aware; named lead produces awareness; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PSQ.4.c",
        ...
        "steps": "Steps 3, 5",
        "evidence": "The written resources and the budget earmark for this programme; the recorded split that ROM.3.a will own governance approval of the annual budget; no rupee figure as a NABH mandate; the audit sample at step 5",
        "responsible": "Management earmarks and provides resources; ROM.3 will own budget approval; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "PSQ.4.d",
        ...
        "steps": "Steps 4, 5",
        "evidence": "The written workforce-feedback method and sample uses that changed the programme; the recorded split that PRE.6 owns patient/family feedback; the audit sample at step 5",
        "responsible": "Management uses workforce feedback; PRE.6 remains patient complaints; quality or accreditation coordinator audits",
    },
]
...
The values the hospital must supply: culture-of-safety method; leader-awareness method; resources and budget earmark; workforce-feedback method; named lead; audit interval; review interval; intranet location; and any additional local abbreviation."""

SQL_HEADER = """-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 6 PSQ, printed pages 103-104.
...
if __name__ == "__main__":
    emit_and_verify(
        ...
        json_name="psq4_draft.json",
        sql_name="psq4_insert.sql",
    )
