# -*- coding: utf-8 -*-
"""Builds the ROM.3 master policy draft: JSON for review + SQL for later insert.
...
Tier is decided by doc_required / the asterisk in the official PDF:
  Tier 1 (full treatment): ROM.3.d
  Tier 2 (lighter pass):   ROM.3.a, ROM.3.b, ROM.3.c, ROM.3.e

ONE of five OEs is asterisked. Official ROM.3.e uses "organization".

Official source: NABH SHCO 3rd Edition PDF, Chapter 7, ROM.3, printed page 111
(PDF page index 117). Intent printed page 109: governance professionally and
ethically; responsibilities of management defined.

Asterisks verified 2026-08-17: ROM.3.d carries the asterisk.

No named Act of Parliament is a numbered ROM chapter reference. P2 is
accreditation-only. PSQ.4.c already forwarded annual-budget approval to ROM.3.a
— this draft accepts that handoff.
"""
...
POLICY_TITLE = "Professional Functioning"
...
This document is professional functioning. It is not identification of the governing entity (ROM.1), not the day-to-day head (ROM.2), and not organisation-wide risk management (ROM.4)."""

SCOPE = """This policy applies to those responsible for governance, the person heading {{HOSPITAL_NAME}}, the people who coordinate departments and external agencies, the committees whose functioning is reviewed, and the people who set and monitor service standards and who hold the staff-rights document.
...
- Choudhuri on strategic planning (chapter reference 10) and Strategic Planning: Why It Makes a Difference (chapter reference 41) are frameworks, not pasted plans. No rupee figure is a NABH mandate."""

POLICY_STATEMENT = """{{HOSPITAL_NAME}} requires those responsible for governance to approve the strategic and operational plans and the organisation's annual budget.
...
{{HOSPITAL_NAME}} does not treat an unapproved budget, a dormant committee list, or a slogan without a measure, as professional functioning."""

PROCEDURE_STEPS = [
"""1. Governance approval of strategic and operational plans and the annual budget

Those responsible for governance approve the strategic and operational plans and the organisation's annual budget.

What the strategic plan, operational plan and annual budget are, who presents them, and how approval is recorded, are [Hospital to define — how those responsible for governance approve the strategic and operational plans and the annual budget]. PSQ.4.c earmarks funds for the patient-safety and QI programme from that budget; it does not approve the budget. This document does not print a rupee figure or a mandated financial year-end as a NABH mandate. Choudhuri (chapter reference 10) is a framework, not a pasted plan.""",

"""2. Coordination with departments and external agencies; monitoring of goals
...
Which departments, which external agencies, which goals and objectives, how coordination is done, and how progress is monitored, are [Hospital to define — how functioning is coordinated with departments and external agencies and how progress toward defined goals and objectives is monitored]. External agencies are those this hospital actually deals with (for example a referred hospital, a diagnostic partner, a municipal authority). AAC.1 unused services do not invent an agency.""",

"""3. Review of committee functioning for effectiveness

The functioning of committees is reviewed for their effectiveness.

Which committees this hospital actually runs, who reviews them, at what interval, and how effectiveness is recorded, are [Hospital to define — how the functioning of committees is reviewed for effectiveness]. PSQ.1 committees, the infection-control committee (HIC.1), the medication committee (MOM.1) and any other named committee remain those documents for what they do. This step owns that their functioning is reviewed for effectiveness. A membership list of absentees is not a review.""",

"""4. Documented measurable service standards, monitored
...
This policy is reviewed at [Hospital to define — the review interval for this policy], and sooner when the governing entity or the service directory changed, or when ROM.1, ROM.2, ROM.4, PSQ.2, PSQ.4 or AAC.1 that this document hands work to are revised.""",
]

RESPONSIBILITY = """Those responsible for governance approve plans and the annual budget at step 1 and receive committee-effectiveness and service-standard monitoring.
...
All staff are expected to treat an unapproved budget, a dormant committee, and a slogan offered as a service standard, as defects, and to report them."""

REFERENCES = """- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Standards for Small Healthcare Organisations, 3rd Edition — Chapter 7 ROM, standard ROM.3. Official ROM.3.e uses "organization".
...
- Internal documents of {{HOSPITAL_NAME}}: strategic and operational plans; annual budget; committee list and effectiveness reviews; measurable service standards; staff rights and responsibilities; ROM.1, ROM.2, ROM.4; PSQ.2, PSQ.4; AAC.1; PRE.1."""

DISTRIBUTION = """Controlled master copy: office of those responsible for governance, {{HOSPITAL_NAME}}, with the head of the institution and the quality or accreditation coordinator.
...
OE_MAPPING = [
    {
        ...
        "steps": "Steps 1, 6",
        "evidence": "Sample approved strategic plan, operational plan and annual budget showing governance approval; the recorded split that PSQ.4.c earmarks programme funds from this budget and does not approve it; the audit sample at step 6",
        "responsible": "Those responsible for governance approve; PSQ.4.c remains the earmark; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "ROM.3.b",
        ...
        "steps": "Steps 2, 6",
        "evidence": "The written coordination method and sample progress-monitoring records; the recorded split that unused AAC.1 services do not invent an agency; the audit sample at step 6",
        "responsible": "Head of the institution coordinates; department heads and named external-agency leads participate; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "ROM.3.c",
        "requirement": "The functioning of committees is reviewed for their effectiveness.",
        "steps": "Steps 3, 6",
        "evidence": "The committee list this hospital actually runs and sample effectiveness reviews; the recorded split that PSQ.1/HIC.1/MOM.1 own what those committees do; the audit sample at step 6 of a review that is not a membership list of absentees",
        "responsible": "Named reviewer (governance or head); committee chairs remain owning-document leads; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "ROM.3.d",
        "requirement": "The organisation documents the service standards that are measurable and monitors them.",
        "steps": "Steps 4, 6",
        "evidence": "The written measurable service-standard set aligned to AAC.1 defined services rather than slogans or a copied ICU list for a service not offered; sample monitoring records showing the standards were actually measured; the recorded split that AAC.1 names what is offered, PSQ.2 owns key indicators as QI tools, and this OE owns the service standards themselves; the recorded refusal to paste Annexure 1 or a mandated turnaround-time figure as a NABH number; induction or briefing of department heads who operate the standards; the location of the set; the audit sample at step 6 of monitoring that used the documented measures",
        "responsible": "Head of the institution keeps the set current; department heads monitor in their areas; AAC.1/PSQ.2 remain those documents; quality or accreditation coordinator audits",
    },
    {
        "oe_code": "ROM.3.e",
        "requirement": "The organization documents staff rights and responsibilities.",
        "steps": "Steps 5, 6",
        "evidence": "The documented staff rights and responsibilities (official spelling organization); the recorded split that PRE.1/PRE.2 own patient rights and HRM holds the employment/grievance file when drafted; the audit sample at step 6",
        "responsible": "Head of the institution ensures the document exists; HRM may hold the working copy; PRE remains patient rights; quality or accreditation coordinator audits",
    },
]
...
SQL_HEADER = """-- Source: NABH SHCO Standards 3rd Edition (August 2022), Chapter 7 ROM, printed page 111
...
if __name__ == "__main__":
    emit_and_verify(
        ...
        json_name="rom3_draft.json",
        sql_name="rom3_insert.sql",
    )
