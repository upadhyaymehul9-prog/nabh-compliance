...
- The temperature and vital signs record is also used by the infection-surveillance policy of {{HOSPITAL_NAME}} for case-finding of infection. That use is a different purpose; the two share a chart and do not share a method."""
