# -*- coding: utf-8 -*-
"""Extract 1:1 Guidebook Interpretation paragraphs for HCO ROM OEs.

Pairs Interpretation: blocks in document order with the 37 portal-PDF OEs.
...
OCR = ROOT / "policies/source/hco6_rom_guidebook_ocr.txt"
INV = ROOT / "policies/source/hco6_rom_inventory.json"
OUT = ROOT / "policies/source/hco6_rom_interpretations.json"
