...
*HCO Full Accreditation, 6th Edition — IPC.2.*

## Document control

Document number: «HCO/IPC/POL/02»
Issue number: «01»
...
The organisation provides adequate and appropriate resources for infection prevention and control.

## 1. Purpose

This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard IPC.2: The organisation provides adequate and appropriate resources for infection prevention and control.
...
This policy covers resources for infection prevention and control specifically. Related duties — like patient assessment, clinical care, medication management, or patient rights — are covered in the hospital's other policies, not repeated here. Other IPC standards stay with their own policies.

Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to staff who deliver clinical care, run support services (housekeeping, laundry, kitchen, CSSD, engineering), handle biomedical waste, or hold occupational-health duties at Preview Hospital, including the «Medical Superintendent», the Infection Prevention and Control Officer and Nurse, treating doctors, nursing, CSSD, Occupational Health and the Quality Coordinator.

This policy covers all 4 requirements under this standard, listed in detail below.

This policy covers resources for infection prevention and control specifically. Related duties — like patient assessment, clinical care, medication management, or patient rights — are covered in the hospital's other policies, not repeated here. Spell out abbreviations on first use in training materials. OE counts/levels/asterisks stay with the official portal Standards PDF. Method notes come from the Guidebook Interpretation paragraphs (scanned PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).

## 3. Policy standards

Preview Hospital implements IPC.2 so that the organisation provides adequate and appropriate resources for infection prevention and control.
...
The «Medical Superintendent» signs the budget line. Stock-outs of PPE or soap that last beyond the defined buffer are reported to the «Infection Prevention and Control Committee».

Method note (from guidebook interpretation): The management shall ensure that the resources required are made available on a continual and sustained manner. This includes both men and materials. There shall be an allocation in the budget demarcated for infection prevention and control activities. This shall be prepared, taking into consideration the scope of the activity and previous years’ experience. Refer to ROM.5.c. ial.
...
The «Infection Prevention and Control Nurse» spot-checks availability and correct use «monthly». Starting a procedure without required PPE is a stop-work trigger under IPC.3.
...
The «Infection Prevention and Control Officer» maps points and walks them «quarterly». A sink that is present but blocked or without soap/rub is not accessible.

Method note (from guidebook interpretation): The organisation provides at least one easily accessible washbasin with running water in every patient care area for health care providers. For hand wash, the organisation could consider providing large washbasins, hands-free tap, soap and facility for drying hands without contamination. Hand rub shall be available in every patient care area. Hand rub dispensers can be installed at convenient points and can also be carried by staff as they move between patients and within facilities. HB cone \solation / barrier nursing facilities are available.

This is a CORE objective element — non-compliance is not acceptable for accreditation.

### 5.4 Isolation / barrier nursing facilities are available

The organisation defines when isolation is required and when barrier nursing or cohorting is used instead. Isolation rooms / barrier-nursing kits matching that definition are available.

The «Nursing Superintendent» and the «Infection Prevention and Control Officer» agree the location list. A policy without a usable isolation or barrier arrangement is not this element.

Method note (from guidebook interpretation): The organisation shall define the conditions where isolation is required, and the conditions wherein barrier nursing or both are required. The same shall be carried out. The organisation shall ensure that it provides the necessary resources to carry out the activity (for example clothing, masks, gloves, etc.). Ideally, patients requiring isolation (contact, droplet and airborne) shall be placed in isolation rooms and airborne cases be kept in negative pressure rooms. The door(s) to the aisle or other rooms shall be kept closed at all times. Appropriate signage shall be used/displayed. Organisation implements isolation of patients with MRSA, VRE. Refer to the glossary for “isolation/barrier nursing”. HEB HEB excetience.

## 6. Governance and responsibility

Medical Superintendent
- Accountable that IPC.2 is resourced and followed.
...
I have read this Resources for Infection Prevention and Control policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Infection Prevention and Control, standard IPC.2. Official portal PDF (OE text, counts, levels, asterisks).
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — IPC.2 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a; OCR policies/source/hco6_ipc_guidebook_ocr.txt).
- Internal documents of Preview Hospital: Infection Prevention and Control Manual, antimicrobial policy, BMW and housekeeping procedures, CSSD sterilisation records, occupational-health and PEP guidance named for IPC.2.

## 10. Distribution

Medical Superintendent; Infection Prevention and Control Officer; Infection Prevention and Control Nurse; Nursing Superintendent; CSSD In-Charge; Occupational Health Physician; Quality Coordinator; department clinical and support staff covered by IPC.2
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition IPC.2

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| IPC.2.a | The management makes available resources required for the infection prevention and control programme including allocation of adequate funds from its annual budget. | Section 3; 5.1 | Medical Superintendent |
| IPC.2.b | Adequate and appropriate personal protective equipment, soaps, and disinfectants are available and used correctly. | Section 3; 5.2 | Medical Superintendent |
| IPC.2.c | Adequate and appropriate facilities for hand hygiene in all patient-care areas are accessible to healthcare providers. | Section 3; 5.3 | Medical Superintendent |
| IPC.2.d | Isolation / barrier nursing facilities are available. | Section 3; 5.4 | Medical Superintendent |
