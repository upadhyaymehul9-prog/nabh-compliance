...
It covers objective elements IPC.2.a–d (4 elements).
...
This policy owns IPC.2. Related AAC, COP, MOM and PRE duties stay with those policies — cross-reference only. Other IPC standards stay with their own policies.
