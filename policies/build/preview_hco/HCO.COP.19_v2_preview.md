...
*HCO Full Accreditation, 6th Edition — COP.19.*

## Document control

Document number: «HCO/COP/POL/19»
Issue number: «01»
...
Prepared by (designation): «Dietetics In-Charge»    Name: «________»    Signature: «________»
...
This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard COP.19: Nutritional therapy is provided to patients consistently and collaboratively.

This policy covers all 5 requirements under this standard, listed in detail below.

This policy covers nutritional therapy specifically. Related duties — like patient assessment, patient rights, infection control, staffing, or medication management — are covered in the hospital's other policies, not repeated here.

Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to staff who deliver or oversee the care described in COP.19 at Preview Hospital, including the «Dietetics In-Charge», treating doctors, nurses and the Quality Coordinator.

This policy covers all 5 requirements under this standard, listed in detail below.

This policy covers nutritional therapy specifically. Related duties — like patient assessment, patient rights, infection control, staffing, or medication management — are covered in the hospital's other policies, not repeated here. Spell out abbreviations on first use in training materials.

## 3. Policy standards

Preview Hospital implements COP.19 so that nutritional therapy is provided to patients consistently and collaboratively..
...
1. Do not skip: Patients admitted to the organisation are screened for nutritional risk.
2. Do not skip: Nutritional assessment is done for patients found at risk during nutritional screening.
3. Do not skip: The therapeutic diet is planned and provided collaboratively.
4. Do not skip: Patients receive food according to the written order for the diet.
5. Do not skip: When families provide food, they are educated about the patient’s diet limitations.
6. Staff who see a COP.19 rule broken report it the same shift to the «department in-charge» or the «Medical Superintendent».

## 5. What we do

### 5.1 Patients admitted to the organisation are screened for nutritional risk

Patients admitted to the organisation are screened for nutritional risk.
...
### 5.3 The therapeutic diet is planned and provided collaboratively

The therapeutic diet is planned and provided collaboratively.

Staff follow the written guidance and record the action in the medical record or the department register named for this element.

### 5.4 Patients receive food according to the written order for the diet

Patients receive food according to the written order for the diet.
...
- Accountable that COP.19 is resourced and followed.
...
I have read this Nutritional Therapy policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Care of Patients, standard COP.19.
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — COP.19 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).
- Internal documents of Preview Hospital: written guidance and registers named for COP.19.
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition COP.19

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| COP.19.a | Patients admitted to the organisation are screened for nutritional risk. | Section 3; 5.1 | Dietetics In-Charge |
| COP.19.b | Nutritional assessment is done for patients found at risk during nutritional screening. | Section 3; 5.2 | Dietetics In-Charge |
| COP.19.c | The therapeutic diet is planned and provided collaboratively. | Section 3; 5.3 | Dietetics In-Charge |
| COP.19.d | Patients receive food according to the written order for the diet. | Section 3; 5.4 | Dietetics In-Charge |
| COP.19.e | When families provide food, they are educated about the patient’s diet limitations. | Section 3; 5.5 | Dietetics In-Charge |
