...
*HCO Full Accreditation, 6th Edition — HRM.7.*

## Document control

Document number: «HCO/HRM/POL/07»
Issue number: «01»
...
An appraisal system for evaluating the performance of staff exists as an integral part of the human resource management process.

## 1. Purpose

This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard HRM.7: An appraisal system for evaluating the performance of staff exists as an integral part of the human resource management process.

It covers objective elements HRM.7.a–e (5 elements).
...
This policy owns HRM.7. Related AAC, COP, MOM, PRE, IPC, PSQ, ROM and FMS duties stay with those policies — cross-reference only. Other HRM standards stay with their own policies.
...
Preview Hospital implements HRM.7 so that an appraisal system for evaluating the performance of staff exists as an integral part of the human resource management process.
...
1. Do not skip: Performance appraisal is done for staff within the organisation.
2. Do not skip: The staff are made aware of the system of appraisal at the time of induction.
3. Do not skip: Performance is evaluated based on the pre-determined criteria.
4. Do not skip: The appraisal system is used as a tool for further development.
5. Do not skip: Performance appraisal is carried out at defined intervals and is documented.
6. Staff who see a HRM.7 rule broken report it the same shift to the «HR In-Charge / Personnel Officer» or the «Medical Superintendent».

## 5. What we do

### 5.1 Performance appraisal is done for staff within the organisation

Performance appraisal is done for all categories of staff at Preview Hospital, starting with the person heading the organisation and including doctors, and includes competency assessment where appropriate. For outsourced staff, the appraisal may be done by the contractor. This is an asterisked element.

Method note (from guidebook interpretation): Performance appraisal shall be done for all categories of staff starting from the person heading the organisation and including doctors. Where appropriate, the performance appraisal shall include competency assessment. In the case of outsourced staff, the performance appraisal could be done by the contractor. For the definition of "performance appraisal" refer to the glossary.
...
Method note (from guidebook interpretation): Awareness could be incorporated in the service booklet and included in the induction training.

### 5.3 Performance is evaluated based on the pre-determined criteria

Performance is evaluated against pre-determined criteria at Preview Hospital, based on key performance indicators or key result areas derived from the job description.

Method note (from guidebook interpretation): Criteria shall be done based on key performance indicators/key result areas which are derived from the job description.

### 5.4 The appraisal system is used as a tool for further development

Preview Hospital uses the appraisal system as a tool for further development — identifying training requirements and providing for them where possible, with key result areas set for each staff member and a training-need assessment done. Written guidance covers effective management of underperformance.
...
Method note (from guidebook interpretation): The performance appraisal shall be done at least once a year.

## 6. Governance and responsibility

Medical Superintendent
- Accountable that HRM.7 is resourced and followed.
...
I have read this Staff Performance Appraisal policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Human Resource Management, standard HRM.7. Official portal PDF (OE text, counts, levels, asterisks).
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — HRM.7 interpretations (source PDF has no text layer; transcribed and verified against rendered page images — policies/source/hco6_hrm_guidebook_ocr.txt).
- Internal documents of Preview Hospital: workforce plan, recruitment and induction records, training records, appraisal records, disciplinary and grievance registers, staff health records, personal files, and credentialing/privileging files named for HRM.7.

## 10. Distribution

Medical Superintendent; HR In-Charge / Personnel Officer; Quality Coordinator; departmental leaders; staff covered by HRM.7
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition HRM.7

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| HRM.7.a | Performance appraisal is done for staff within the organisation. | Section 3; 5.1 | HR In-Charge / Personnel Officer |
| HRM.7.b | The staff are made aware of the system of appraisal at the time of induction. | Section 3; 5.2 | HR In-Charge / Personnel Officer |
| HRM.7.c | Performance is evaluated based on the pre-determined criteria. | Section 3; 5.3 | HR In-Charge / Personnel Officer |
| HRM.7.d | The appraisal system is used as a tool for further development. | Section 3; 5.4 | HR In-Charge / Personnel Officer |
| HRM.7.e | Performance appraisal is carried out at defined intervals and is documented. | Section 3; 5.5 | HR In-Charge / Personnel Officer |
