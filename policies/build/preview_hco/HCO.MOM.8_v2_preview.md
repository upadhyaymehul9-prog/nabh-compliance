...
*HCO Full Accreditation, 6th Edition — MOM.8.*

## Document control

Document number: «HCO/MOM/POL/08»
Issue number: «01»
...
Prepared by (designation): «Medication Safety Officer»    Name: «________»    Signature: «________»
...
This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard MOM.8: Patients are monitored after medication administration.

It covers objective elements MOM.8.a–f (6 elements).
...
This policy owns MOM.8. Related AAC, COP, PRE, IPC/HIC and HRM duties stay with those policies — cross-reference only. Other MOM standards stay with their own policies.

Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to staff who prescribe, dispense, administer, store, monitor or oversee medications (or, for MOM.10–11, implants / medical devices / medical supplies) at Preview Hospital, including the «Medication Safety Officer», pharmacy, nursing, treating doctors and the Quality Coordinator.
...
Preview Hospital implements MOM.8 so that patients are monitored after medication administration.
...
1. Do not skip: Patients shall be monitored after medication administration.
2. Do not skip: Medications shall be changed based on the monitoring where appropriate.
3. Do not skip: The organisation shall capture near misses, medication errors and adverse drug reactions.
4. Do not skip: Near misses, medication errors and adverse drug reactions shall be reported within a specified time frame.
5. Do not skip: Near misses, medication errors and adverse drug reactions are collected and analysed.
6. Do not skip: Corrective and / or preventive action(s) are taken based on the analysis.
7. Staff who see a MOM.8 rule broken report it the same shift to the «department in-charge» or the «Medication Safety Officer».

## 5. What we do

### 5.1 Patients shall be monitored after medication administration

After administration, the patient is monitored for the intended effect and for adverse effects, with intensity matching the drug and the clinical setting (for example post-IV opioid sedation and respiration; post-chemotherapy as the protocol states; routine oral doses as the chart and NEWS/EWS require).
...
When monitoring shows the drug is ineffective, poorly tolerated, or causing harm, the treating doctor is informed and the medication is changed, held or the dose adjusted as clinically indicated, with the order rewritten under MOM.5.
...
- Accountable that MOM.8 is resourced and followed.
...
I have read this Monitoring after Medication Administration policy of Preview Hospital. I will follow the processes described.
...
Medical Superintendent; Medication Safety Officer; Pharmacy In-Charge; Nursing Superintendent; Quality Coordinator; department clinical staff covered by MOM.8
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition MOM.8

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| MOM.8.a | Patients shall be monitored after medication administration. | Section 3; 5.1 | Medication Safety Officer |
| MOM.8.b | Medications shall be changed based on the monitoring where appropriate. | Section 3; 5.2 | Medication Safety Officer |
| MOM.8.c | The organisation shall capture near misses, medication errors and adverse drug reactions. | Section 3; 5.3 | Medication Safety Officer |
| MOM.8.d | Near misses, medication errors and adverse drug reactions shall be reported within a specified time frame. | Section 3; 5.4 | Medication Safety Officer |
| MOM.8.e | Near misses, medication errors and adverse drug reactions are collected and analysed. | Section 3; 5.5 | Medication Safety Officer |
| MOM.8.f | Corrective and / or preventive action(s) are taken based on the analysis. | Section 3; 5.6 | Medication Safety Officer |
