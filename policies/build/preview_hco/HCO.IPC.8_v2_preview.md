# Prevention of Healthcare Associated Infections in Staff
**Preview Hospital**

*HCO Full Accreditation, 6th Edition — IPC.8.*

## Document control

Document number: «HCO/IPC/POL/08»
Issue number: «01»
...
Prepared by (designation): «Occupational Health Physician»    Name: «________»    Signature: «________»
...
The organisation takes action to prevent or reduce healthcare associated infections in its staff.

## 1. Purpose

This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard IPC.8: The organisation takes action to prevent or reduce healthcare associated infections in its staff.

It covers objective elements IPC.8.a–e (5 elements).
...
This policy owns IPC.8. Related AAC, COP, MOM and PRE duties stay with those policies — cross-reference only. Other IPC standards stay with their own policies.

Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to staff who deliver clinical care, run support services (housekeeping, laundry, kitchen, CSSD, engineering), handle biomedical waste, or hold occupational-health duties at Preview Hospital, including the «Occupational Health Physician», the Infection Prevention and Control Officer and Nurse, treating doctors, nursing, CSSD, Occupational Health and the Quality Coordinator.
...
Preview Hospital implements IPC.8 so that the organisation takes action to prevent or reduce healthcare associated infections in its staff.
...
5. Do not skip: Appropriate post-exposure prophylaxis is provided to all staff members concerned.
6. Do not bypass the stop-work authority in section 6 when the trigger conditions are met.
7. Staff who see an IPC.8 rule broken report it the same shift to the «department in-charge» or the «Infection Prevention and Control Officer».
...
The «Occupational Health Physician» and the «Infection Prevention and Control Officer» own the guidance. Staff are trained at induction and «annually».

Method note (from guidebook interpretation): Written guidance shall be available on occupational health and safety practices. The organisation provides adequate resources to its staff for infection prevention and control. Staff shall adhere to standard precautions. Where appropriate, the organisation shall have a pre-employment health screening and capture immunisation status. Refer to IPC.2.c., IPC.3.a., IPC.3.b. and HRM.2.b. _b. HB.

This objective element is asterisked in the official Standards PDF — documentation of the process is required.

### 5.2 The organisation implements an immunisation policy for its staff

The staff immunisation policy matches available evidence. At a minimum, hepatitis B vaccination is provided to staff in direct patient care. Other vaccines follow risk and applicable statutory requirements.

The «Occupational Health Physician» holds the register (dose, date, booster). An unvaccinated direct-care worker without a documented contraindication or refusal is a gap.

Method note (from guidebook interpretation): The organisation’s immunisation policy for its staff shall be in consonance with the available evidence. At a minimum, Hepatitis B vaccination shall be provided to staff involved in direct patient care. Other relevant immunisation is provided as per the risk from time to time and in accordance with applicable statutory requirements.
...
The «Infection Prevention and Control Nurse» includes this in the monthly IPC round. A recapping culture on a unit is an incident.
...
Method note (from guidebook interpretation): The organisation provides post-exposure prophylaxis for hepatitis B and HIV exposure. This shall align with National and/or International guidelines. Infection prevention and control Nurse maintains documentation of post-exposure prophylaxis records. For example, PEP for needle stick injury.

This objective element is asterisked in the official Standards PDF — documentation of the process is required.

## 6. Stop-work authority

Do not continue clinical duty when a work restriction for a transmissible infection applies to you.
...
The person who stops (or the colleague who sees the restriction being ignored) tells the «Occupational Health Physician» and the «Infection Prevention and Control Officer» the same shift. Reporting an exposure or observing a restriction is not a disciplinary matter.

## 7. Governance and responsibility

Medical Superintendent
- Accountable that IPC.8 is resourced and followed.
...
I have read this Prevention of Healthcare Associated Infections in Staff policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Infection Prevention and Control, standard IPC.8. Official portal PDF (OE text, counts, levels, asterisks).
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — IPC.8 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a; OCR policies/source/hco6_ipc_guidebook_ocr.txt).
- Internal documents of Preview Hospital: Infection Prevention and Control Manual, antimicrobial policy, BMW and housekeeping procedures, CSSD sterilisation records, occupational-health and PEP guidance named for IPC.8.

## 11. Distribution

Medical Superintendent; Occupational Health Physician; Infection Prevention and Control Officer; Infection Prevention and Control Nurse; Nursing Superintendent; CSSD In-Charge; Quality Coordinator; department clinical and support staff covered by IPC.8
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition IPC.8

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| IPC.8.a | The organisation implements occupational health and safety practices as per written guidance to reduce the risk of transmitting microorganisms among health care providers. | Section 3; 5.1; Section 6 Stop-work | Occupational Health Physician |
| IPC.8.b | The organisation implements an immunisation policy for its staff. | Section 3; 5.2; Section 6 Stop-work | Occupational Health Physician |
| IPC.8.c | The organisation implements work restrictions for health care providers with transmissible infections. | Section 3; 5.3; Section 6 Stop-work | Occupational Health Physician |
| IPC.8.d | The organisation implements measures for blood and body fluid exposure prevention. | Section 3; 5.4; Section 6 Stop-work | Occupational Health Physician |
| IPC.8.e | Appropriate post-exposure prophylaxis is provided to all staff members concerned. | Section 3; 5.5; Section 6 Stop-work | Occupational Health Physician |
