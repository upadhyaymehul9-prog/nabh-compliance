# Informed Decisions and Involvement in the Care Plan
**Preview Hospital**

*HCO Full Accreditation, 6th Edition — PRE.3.*

## Document control

Document number: «HCO/PRE/POL/03»
Issue number: «01»
...
This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard PRE.3: The patient and / or family members are educated to make informed decisions and are involved in the care planning and delivery process

It covers objective elements PRE.3.a–e (5 elements).
...
This policy owns PRE.3. Related AAC, COP, MOM, IPC/HIC and IMS duties stay with those policies — cross-reference only. Other PRE standards stay with their own policies.
...
Preview Hospital implements PRE.3 so that the patient and / or family members are educated to make informed decisions and are involved in the care planning and delivery process.
...
Method note (from guidebook interpretation): The proposed care, including referral to internal and/or external services, is discussed by the attending doctor with the patient and/or family members. This shall be done in a language that the patient/attendant can i al understand. The above information could be documented and signed by the doctor concerned. The patients and/or family members are explained in detail by the treating physician or his/her team about the expected outcomes of such treatment at periodic intervals. Possible complications of the treatment, if any, are clearly communicated to the patient and/or family members.
...
The «treating doctor» records that consultation. A plan written only in the doctor's notes with no evidence of discussion is not Achievement for this element.
...
Night and emergency deterioration is communicated by the «on-call doctor» without waiting for the next routine round.
...
Method note (from guidebook interpretation): The organisation shall identify situations where multidisciplinary counselling is required. This could include counselling of family members of critically ill patients, potential organ donors and/or family, long-stay patients. Members of the multidisciplinary team involved in providing care like doctors from different specialities, nurses and physiotherapists shall be a part of the counselling. The counselling could be led by clinician in-charge of the patient. Refer to COP 1.e.

## 6. Governance and responsibility

Medical Superintendent
- Accountable that PRE.3 is resourced and followed.
...
I have read this Informed Decisions and Involvement in the Care Plan policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Patient Rights and Education, standard PRE.3. Official portal PDF (OE text, counts, levels, asterisks).
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — PRE.3 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a; OCR policies/source/hco6_pre_guidebook_ocr.txt).
- Internal documents of Preview Hospital: Patient Rights display and pamphlet, informed-consent list and forms, tariff and estimate process, feedback and complaints guidance, and communication models named for PRE.3.

## 10. Distribution

Medical Superintendent; Nursing Superintendent; Guest Relations / Patient Rights Officer; Patient Accounts In-Charge; Quality Coordinator; department clinical staff covered by PRE.3
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition PRE.3

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| PRE.3.a | The patient and / or family members are explained about the proposed care (including the risks, benefits, alternatives), expected results and possible complications. | Section 3; 5.1 | Medical Superintendent |
| PRE.3.b | The care plan is prepared and modified in consultation with the patient and / or family members. | Section 3; 5.2 | Medical Superintendent |
| PRE.3.c | The patient and/or family members are informed about the results of diagnostic tests and the diagnosis. | Section 3; 5.3 | Medical Superintendent |
| PRE.3.d | The patient and/or family members are explained about any change in the patient’s condition in a timely manner. | Section 3; 5.4 | Medical Superintendent |
| PRE.3.e | The patient and/or family members are provided multi-disciplinary counselling when appropriate. | Section 3; 5.5 | Medical Superintendent |
