...
*HCO Full Accreditation, 6th Edition — COP.8.*

## Document control

Document number: «HCO/COP/POL/08»
Issue number: «01»
...
Prepared by (designation): «Transfusion / Blood Bank In-Charge»    Name: «________»    Signature: «________»
...
Transfusion services are provided as per the scope of services of the organisation, safely.
...
Preview Hospital implements COP.8 so that transfusion services are provided as per the scope of services of the organisation, safely..
...
1. Do not skip: Scope of transfusion services is commensurate with the services provided by the organisation.
...
Method note (from guidebook interpretation): Clinical care pathways shall be multidisciplinary, and based on
...
### 5.7 The organisation shall implement a quality assurance programme

The organisation shall implement a quality assurance programme.

Method note (from guidebook interpretation): The identified area to treat emergency patients shall be easily

## 6. Stop-work authority

Do not start transfusion of blood or blood components when patient identification (minimum two identifiers) is incomplete, compatibility checks are missing, or required informed consent has not been obtained (except where emergency transfusion rules documented by the organisation apply).
...
The person who stops tells the «Transfusion / Blood Bank In-Charge» and the «treating doctor» the same shift. Refusing an unsafe transfusion is not a disciplinary matter.

## 7. Governance and responsibility

Medical Superintendent
- Accountable that COP.8 is resourced and followed.

Transfusion / Blood Bank In-Charge
...
I have read this Safe Transfusion Services policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Care of Patients, standard COP.8.
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — COP.8 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).
- Internal documents of Preview Hospital: written guidance and registers named for COP.8.
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition COP.8

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| COP.8.a | Scope of transfusion services is commensurate with the services provided by the organisation. | Section 3; 5.1; Section 6 Stop-work | Transfusion / Blood Bank In-Charge |
