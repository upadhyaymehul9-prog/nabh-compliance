...
*HCO Full Accreditation, 6th Edition — MOM.4.*

## Document control

Document number: «HCO/MOM/POL/04»
Issue number: «01»
...
This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard MOM.4: Medications are prescribed safely and rationally.
...
This policy covers safe and rational prescription of medications specifically. Related duties — like patient assessment, clinical care, patient rights, infection control, or staffing — are covered in the hospital's other policies, not repeated here. Other MOM standards stay with their own policies.

Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to staff who prescribe, dispense, administer, store, monitor or oversee medications (or, for MOM.10–11, implants / medical devices / medical supplies) at Preview Hospital, including the «Medical Superintendent», pharmacy, nursing, treating doctors and the Quality Coordinator.

This policy covers all 8 requirements under this standard, listed in detail below.

This policy covers safe and rational prescription of medications specifically. Related duties — like patient assessment, clinical care, patient rights, infection control, or staffing — are covered in the hospital's other policies, not repeated here. Spell out abbreviations on first use in training materials. OE counts/levels/asterisks stay with the official portal Standards PDF. Method notes come from the Guidebook Interpretation paragraphs (scanned PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).

## 3. Policy standards

Preview Hospital implements MOM.4 so that medications are prescribed safely and rationally.
...
### 5.7 Audit of medication orders / prescription is carried out to check for...

The «Medication Safety Officer» (or Quality with pharmacy) audits medication orders / prescriptions «quarterly» for safe and rational prescribing: minimum requirements, allergy documentation, formulary adherence, and high-risk dose checks.
...
Do not prescribe (or transcribe a prescription for action) when drug allergies and previous adverse drug reactions have not been ascertained.
...
The person who stops tells the «treating doctor» and the «Medication Safety Officer» the same shift. Refusing an unsafe prescription is not a disciplinary matter.

## 7. Governance and responsibility

Medical Superintendent
- Accountable that MOM.4 is resourced and followed.
...
I have read this Safe and Rational Prescription of Medications policy of Preview Hospital. I will follow the processes described.
...
Medical Superintendent; Medication Safety Officer; Pharmacy In-Charge; Nursing Superintendent; Quality Coordinator; department clinical staff covered by MOM.4
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition MOM.4

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| MOM.4.a | Medication prescription is in consonance with good practices / guidelines for rational prescription of medications. | Section 3; 5.1; Section 6 Stop-work | Medical Superintendent |
| MOM.4.b | The organisation adheres to the determined minimum requirements of a prescription. | Section 3; 5.2; Section 6 Stop-work | Medical Superintendent |
| MOM.4.c | Drug allergies and previous adverse drug reactions are ascertained before prescribing. | Section 3; 5.3; Section 6 Stop-work | Medical Superintendent |
| MOM.4.d | The organisation has a mechanism to assist the clinician in prescribing appropriate medication. | Section 3; 5.4; Section 6 Stop-work | Medical Superintendent |
| MOM.4.e | Reconciliation of medications occurs at transition points of patient care. | Section 3; 5.5; Section 6 Stop-work | Medical Superintendent |
| MOM.4.f | Verbal orders are implemented by ensuring safe medication management practices. | Section 3; 5.6; Section 6 Stop-work | Medical Superintendent |
| MOM.4.g | Audit of medication orders / prescription is carried out to check for safe and rational prescription of medications. | Section 3; 5.7; Section 6 Stop-work | Medical Superintendent |
| MOM.4.h | Corrective and / or preventive action(s) is taken based on the audit, where appropriate. | Section 3; 5.8; Section 6 Stop-work | Medical Superintendent |
