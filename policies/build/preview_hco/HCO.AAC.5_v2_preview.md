...
*HCO Full Accreditation, 6th Edition — re-assessment.*

## Document control

Document number: «HCO/AAC/POL/05»
Issue number: «01»
...
Preview Hospital reassesses patients at appropriate intervals to determine response to treatment and to plan further treatment or discharge. Out-patients are informed of their next follow-up where appropriate. For in-patients, the care plan is monitored and modified during re-assessment where necessary. Staff involved in direct clinical care document re-assessments. The organisation lays down guidelines and implements processes to identify early warning signs of change or deterioration for prompt intervention.

Preview Hospital does not leave a deteriorating patient without escalation when early-warning triggers fire, and does not accept reassessment notes that say only “patient well” or “condition better”.

## 4. Non-negotiable rules

1. Do not go a calendar day without re-assessment of an in-patient by the treating doctor or a doctor from the treating team; reassess more often in ICU and when the condition changes; reassess day-care patients before discharge.
...
6. Staff who find re-assessment or early-warning rules not followed report it the same shift to the «treating doctor» or the «Medical Superintendent».

## 5. What we do

### 5.1 Re-assess at appropriate intervals
...
Default ward interval beyond the daily medical re-assessment: «nursing observations at the frequency set on the care plan, at least once per shift». Default ICU: «as per ICU protocol, not less than every 1–2 hours for unstable patients». 

### 5.2 Inform out-patients of next follow-up where appropriate
...
### 5.3 Monitor and modify the in-patient care plan during re-assessment
...
### 5.4 Direct clinical care staff document re-assessments
...
### 5.5 Early warning signs — guidelines and prompt intervention

Preview Hospital lays down guidelines and implements processes to identify early warning signs of change or deterioration in clinical condition and to initiate prompt intervention.
...
There is a mechanism to make this information available to appropriate medical personnel to initiate prompt and appropriate actions. Effectiveness of the early-warning system is monitored «monthly» by the Quality Coordinator with clinical leads.
...
The person responsible tells the «treating doctor» and, if there is no timely response, the «Medical Superintendent» the same shift. Refusing to leave a deteriorating patient unescalated is not a disciplinary matter.
...
Quality Coordinator
- Audits daily re-assessment, follow-up documentation, care-plan changes, note quality and early-warning effectiveness «quarterly» (early-warning effectiveness also reviewed «monthly»).
...
The Quality Coordinator audits this policy «quarterly» and reviews early-warning effectiveness «monthly».
...
This policy is reviewed «annually», and sooner after any failure-to-escalate event.

## 9. Training and staff acknowledgement

Doctors, nurses and other direct clinical caregivers are informed of this policy at induction and «once a year» after that. Training covers interval rules, OP follow-up documentation, care-plan modification, acceptable re-assessment content, early-warning parameters, escalation routes and stop-work.

Staff acknowledgement

I have read this Re-assessment policy of Preview Hospital. I will reassess at the required intervals, document real clinical findings, modify the care plan when needed, and escalate early-warning triggers without delay.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Guidebook to Accreditation Standards for Hospitals, 6th Edition — Access, Assessment and Continuity of Care (AAC), standard AAC.5.
- Correlated standards named in the guidebook interpretation: COP.5; COP.6; HRM.1; HRM.5.
- Internal documents of Preview Hospital: re-assessment interval guidance by area; early-warning / track-and-trigger guideline; care-plan modification method; AAC.4 initial-assessment policy; related COP and HRM policies (cross-reference).
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition AAC.5

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| AAC.5.a | Patients are re-assessed at appropriate intervals to determine their response to treatment and to plan further treatment or discharge. | Section 3; 5.1 Re-assess at appropriate intervals; Section 4 item 1 | Treating doctors (daily medical re-assessment); nurses and caregivers (within scope); ICU in-charge (ICU frequency) |
| AAC.5.b | Out-patients are informed of their next follow-up, where appropriate. | Section 3; 5.2 Inform out-patients of next follow-up where appropriate; Section 4 item 2 | OPD treating doctors (inform and document) |
| AAC.5.c | For in-patients during re-assessment, the care plan is monitored and modified, where found necessary. | Section 3; 5.3 Monitor and modify the in-patient care plan during re-assessment; Section 4 item 3 | Treating doctor or doctor member of treating team (monitor and modify) |
| AAC.5.d | Staff involved in direct clinical care document re-assessments. | Section 3; 5.4 Direct clinical care staff document re-assessments; Section 4 item 4 | Treating doctors and team members (document per domain); nurses (vitals) |
| AAC.5.e | The organisation lays down guidelines and implements processes to identify early warning signs of change or deterioration in clinical conditions for initiating prompt intervention. | Section 3; 5.5 Early warning signs — guidelines and prompt intervention; Section 4 item 5; Section 6 Stop-work | Medical Superintendent (approve guideline); treating doctors (respond); nurses (trigger); Quality Coordinator (monitor effectiveness) |

## 14. Required Records / Evidence Checklist

Records the hospital holds under this policy, listed by objective element.

### AAC.5.a — Patients are re-assessed at appropriate intervals to determine their response to treatment and to plan further treatment or discharge.
...
### AAC.5.b — Out-patients are informed of their next follow-up, where appropriate.
...
### AAC.5.c — For in-patients during re-assessment, the care plan is monitored and modified, where found necessary.
...
### AAC.5.d — Staff involved in direct clinical care document re-assessments.
...
### AAC.5.e — The organisation lays down guidelines and implements processes to identify early warning signs of change or deterioration in clinical conditions for initiating prompt intervention.
