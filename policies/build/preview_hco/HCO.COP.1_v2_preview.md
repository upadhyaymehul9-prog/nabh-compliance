# Uniform Care Guided by Written Guidance
**Preview Hospital**

*HCO Full Accreditation, 6th Edition — COP.1.*

## Document control

Document number: «HCO/COP/POL/01»
Issue number: «01»
...
Uniform care to patients is provided in all settings of the organisation and is guided by written guidance.
...
Preview Hospital implements COP.1 so that uniform care to patients is provided in all settings of the organisation and is guided by written guidance..
...
### 5.1 Uniform care is provided to patients following written guidance

Uniform care is provided to patients following written guidance .
...
- Accountable that COP.1 is resourced and followed.
...
I have read this Uniform Care Guided by Written Guidance policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Care of Patients, standard COP.1.
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — COP.1 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).
- Internal documents of Preview Hospital: written guidance and registers named for COP.1.
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition COP.1
...
| COP.1.f | Telemedicine facility is provided safely and securely based on written guidance. | Section 3; 5.6 | Quality Coordinator |
