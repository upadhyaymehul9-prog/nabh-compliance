...
*HCO Full Accreditation, 6th Edition — COP.12.*

## Document control

Document number: «HCO/COP/POL/12»
Issue number: «01»
...
Prepared by (designation): «Anaesthesia / Sedation In-Charge»    Name: «________»    Signature: «________»
...
Procedural sedation is provided consistently and safely.

## 1. Purpose

This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard COP.12: Procedural sedation is provided consistently and safely.

This policy covers all 8 requirements under this standard, listed in detail below.

This policy covers procedural sedation specifically. Related duties — like patient assessment, patient rights, infection control, staffing, or medication management — are covered in the hospital's other policies, not repeated here.

Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to staff who deliver or oversee the care described in COP.12 at Preview Hospital, including the «Anaesthesia / Sedation In-Charge», treating doctors, nurses and the Quality Coordinator.

This policy covers all 8 requirements under this standard, listed in detail below.

This policy covers procedural sedation specifically. Related duties — like patient assessment, patient rights, infection control, staffing, or medication management — are covered in the hospital's other policies, not repeated here. Spell out abbreviations on first use in training materials.

## 3. Policy standards

Preview Hospital implements COP.12 so that procedural sedation is provided consistently and safely..
...
1. Do not skip: Procedural sedation is administered in a consistent manner.
...
10. Staff who see a COP.12 rule broken report it the same shift to the «department in-charge» or the «Medical Superintendent».

## 5. What we do

### 5.1 Procedural sedation is administered in a consistent manner

Procedural sedation is administered in a consistent manner.

Method note (from guidebook interpretation): Written guidance based on standard treatment guidelines/sound :

### 5.2 Informed consent for administration of procedural sedation is obtained

Informed consent for administration of procedural sedation is obtained.
...
### 5.3 Competent and trained persons administer procedural sedation

Competent and trained persons administer procedural sedation.
...
Do not begin procedural sedation when pre-sedation assessment is incomplete, required monitoring is unavailable, or recovery/discharge criteria are not defined for the location.

Stop-work applies to sedation start, not to airway rescue already in progress.

The person who stops tells the «sedation privileged doctor» and the «Medical Superintendent» the same shift. Refusing unsafe sedation is not a disciplinary matter.

## 7. Governance and responsibility

Medical Superintendent
- Accountable that COP.12 is resourced and followed.
...
I have read this Procedural Sedation policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Care of Patients, standard COP.12.
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — COP.12 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).
- Internal documents of Preview Hospital: written guidance and registers named for COP.12.
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition COP.12

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| COP.12.a | Procedural sedation is administered in a consistent manner. | Section 3; 5.1; Section 6 Stop-work | Anaesthesia / Sedation In-Charge |
| COP.12.b | Informed consent for administration of procedural sedation is obtained. | Section 3; 5.2; Section 6 Stop-work | Anaesthesia / Sedation In-Charge |
| COP.12.c | Competent and trained persons administer procedural sedation. | Section 3; 5.3; Section 6 Stop-work | Anaesthesia / Sedation In-Charge |
| COP.12.d | The person monitoring sedation is different from the person performing the procedure. | Section 3; 5.4 | Anaesthesia / Sedation In-Charge |
| COP.12.e | Intra-procedure monitoring includes at a minimum the heart rate, cardiac rhythm, respiratory rate, blood pressure, oxygen saturation, and level of sedation. | Section 3; 5.5 | Anaesthesia / Sedation In-Charge |
| COP.12.f | Patients are monitored after procedural sedation, and the same is documented. | Section 3; 5.6 | Anaesthesia / Sedation In-Charge |
| COP.12.g | Criteria are used to determine the appropriateness of discharge from the observation / recovery area. | Section 3; 5.7 | Anaesthesia / Sedation In-Charge |
| COP.12.h | Equipment and workforce are available to manage patients who have gone into a deeper level of sedation than initially intended. | Section 3; 5.8 | Anaesthesia / Sedation In-Charge |
