# Safe Pharmacy Services and Medication Management
**Preview Hospital**

*HCO Full Accreditation, 6th Edition — MOM.1.*

## Document control

Document number: «HCO/MOM/POL/01»
Issue number: «01»
...
Pharmacy services and medication management is done safely.

## 1. Purpose

This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard MOM.1: Pharmacy services and medication management is done safely.
...
This policy covers safe pharmacy services and medication management specifically. Related duties — like patient assessment, clinical care, patient rights, infection control, or staffing — are covered in the hospital's other policies, not repeated here. Other MOM standards stay with their own policies.
...
### 5.1 Pharmacy services and medication management are implemented following...
...
- Accountable that MOM.1 is resourced and followed.
...
I have read this Safe Pharmacy Services and Medication Management policy of Preview Hospital. I will follow the processes described.
...
Medical Superintendent; Medication Safety Officer; Pharmacy In-Charge; Nursing Superintendent; Quality Coordinator; department clinical staff covered by MOM.1
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition MOM.1

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| MOM.1.a | Pharmacy services and medication management are implemented following written guidance. | Section 3; 5.1 | Medication Safety Officer |
| MOM.1.b | A multi-disciplinary committee guides the formulation and implementation of pharmacy services and medication management. | Section 3; 5.2 | Medication Safety Officer |
| MOM.1.c | The multi-disciplinary committee updates medication management processes. | Section 3; 5.3 | Medication Safety Officer |
| MOM.1.d | There is a procedure to obtain medications when the pharmacy is closed or in case of stock outs. | Section 3; 5.4 | Medication Safety Officer |
| MOM.1.e | The organisation has a mechanism to inform relevant staff of key changes in pharmacy services and medication management to ensure uninterrupted and safe care. | Section 3; 5.5 | Medication Safety Officer |
