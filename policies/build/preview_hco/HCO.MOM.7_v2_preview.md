...
*HCO Full Accreditation, 6th Edition — MOM.7.*

## Document control

Document number: «HCO/MOM/POL/07»
Issue number: «01»
...
This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard MOM.7: Medications are administered safely.
...
This policy covers safe administration of medications specifically. Related duties — like patient assessment, clinical care, patient rights, infection control, or staffing — are covered in the hospital's other policies, not repeated here. Other MOM standards stay with their own policies.

Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to staff who prescribe, dispense, administer, store, monitor or oversee medications (or, for MOM.10–11, implants / medical devices / medical supplies) at Preview Hospital, including the «Nursing Superintendent», pharmacy, nursing, treating doctors and the Quality Coordinator.

This policy covers all 11 requirements under this standard, listed in detail below.

This policy covers safe administration of medications specifically. Related duties — like patient assessment, clinical care, patient rights, infection control, or staffing — are covered in the hospital's other policies, not repeated here. Spell out abbreviations on first use in training materials. OE counts/levels/asterisks stay with the official portal Standards PDF. Method notes come from the Guidebook Interpretation paragraphs (scanned PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).

## 3. Policy standards

Preview Hospital implements MOM.7 so that medications are administered safely.
...
1. Do not skip: Medications are administered by those who are permitted by law to do so.
2. Do not skip: Prepared medication is labelled before preparation of a second drug.
3. Do not skip: The patient is identified before administration.
4. Do not skip: Medication is verified from the medication order and physically inspected before administration.
5. Do not skip: Strength is verified from the order before administration.
6. Do not skip: The route is verified from the order before administration.
7. Do not skip: Timing is verified from the order before administration.
8. Do not skip: Measures to avoid catheter and tubing mis-connections during medication administration are implemented.
9. Do not skip: Medication administration is documented.
10. Do not skip: Measures to govern patient's self-administration of medications are implemented.
11. Do not skip: Measures to govern patient's medications brought from outside the organisation shall be implemented.
12. Do not bypass the stop-work authority in section 6 when the trigger conditions are met.
13. Staff who see a MOM.7 rule broken report it the same shift to the «department in-charge» or the «Medication Safety Officer».

## 5. What we do

### 5.1 Medications are administered by those who are permitted by law to do so

Only persons permitted by law and by Preview Hospital's authorised list administer medications. The «Nursing Superintendent» and the «Medical Superintendent» hold the list (registered nurses, doctors, and other cadres the organisation names for defined routes).
...
The person administering identifies the patient immediately before administration using the organisation's identifiers (at least two: «name and unique identification number»), matching the order and the labelled product.
...
### 5.5 Strength is verified from the order before administration

Strength / dose is verified from the order before administration, including any calculation for weight-based or infusion doses. A second check is used for high-risk medications per the high-risk list.
...
### 5.9 Medication administration is documented

Every administration is documented on the medication chart at the time of giving (or immediately after a crash dose): drug, dose, route, time, and the administrator's identifier. Omitted or held doses are documented with the reason.
...
Do not administer a medication when the patient has not been identified with the organisation's identifiers, when the medication / strength / route / timing has not been verified against the order, when the product fails physical inspection, or when you are not on the list of persons permitted by law and by Preview Hospital to administer that medication.
...
The person who stops tells the «Nurse In-Charge» and the «treating doctor» the same shift. Refusing an unsafe administration is not a disciplinary matter.

## 7. Governance and responsibility

Medical Superintendent
- Accountable that MOM.7 is resourced and followed.
...
I have read this Safe Administration of Medications policy of Preview Hospital. I will follow the processes described.
...
Medical Superintendent; Nursing Superintendent; Medication Safety Officer; Pharmacy In-Charge; Quality Coordinator; department clinical staff covered by MOM.7
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition MOM.7

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| MOM.7.a | Medications are administered by those who are permitted by law to do so. | Section 3; 5.1; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.b | Prepared medication is labelled before preparation of a second drug. | Section 3; 5.2; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.c | The patient is identified before administration. | Section 3; 5.3; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.d | Medication is verified from the medication order and physically inspected before administration. | Section 3; 5.4; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.e | Strength is verified from the order before administration. | Section 3; 5.5; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.f | The route is verified from the order before administration. | Section 3; 5.6; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.g | Timing is verified from the order before administration. | Section 3; 5.7; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.h | Measures to avoid catheter and tubing mis-connections during medication administration are implemented. | Section 3; 5.8; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.i | Medication administration is documented. | Section 3; 5.9; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.j | Measures to govern patient's self-administration of medications are implemented. | Section 3; 5.10; Section 6 Stop-work | Nursing Superintendent |
| MOM.7.k | Measures to govern patient's medications brought from outside the organisation shall be implemented. | Section 3; 5.11; Section 6 Stop-work | Nursing Superintendent |
