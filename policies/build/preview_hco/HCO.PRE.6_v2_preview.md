...
*HCO Full Accreditation, 6th Edition — PRE.6.*

## Document control

Document number: «HCO/PRE/POL/06»
Issue number: «01»
...
Prepared by (designation): «Patient Accounts In-Charge»    Name: «________»    Signature: «________»
...
This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard PRE.6: Patients and families have a right to information on expected costs.

It covers objective elements PRE.6.a–d (4 elements).
...
This policy owns PRE.6. Related AAC, COP, MOM, IPC/HIC and IMS duties stay with those policies — cross-reference only. Other PRE standards stay with their own policies.

Words marked «like this» are defaults. A blank marked «________» must be filled before issue.

## 2. Scope

This policy applies to staff who register, admit, treat, counsel, bill, take consent from, or communicate with patients and families at Preview Hospital, including the «Patient Accounts In-Charge», treating doctors, nursing, Guest Relations / Patient Rights, Patient Accounts and the Quality Coordinator.
...
Preview Hospital implements PRE.6 so that patients and families have a right to information on expected costs.
...
1. Do not skip: The patient and / or family members are made aware of the pricing policy in different settings (out-patient...
2. Do not skip: The relevant tariff list is available to patients.
3. Do not skip: The patient and/or family members are explained about the expected costs.
4. Do not skip: Patient and/or family are informed about the financial implications when there is a change in the care plan.
5. Staff who see a PRE.6 rule broken report it the same shift to the «department in-charge» or the «Quality Coordinator».
...
The «Patient Accounts In-Charge» keeps the displayed components current. A policy that exists only in accounts and is not visible at the desk is not CORE compliance.

Method note (from guidebook interpretation): The key components of pricing, namely consultation charges, bed charges, nursing charges, security deposit, are available to patients near registration and/or admission desk. This shall be based on the billing policy, which defines the charges to be levied for various healthcare activities in a given setting. The relevant tariff list is available to patients.

This is a CORE objective element — non-compliance is not acceptable for accreditation.

### 5.2 The relevant tariff list is available to patients

An updated tariff list is available for patients to review. Preview Hospital charges as per that list; any additional charge is enumerated in the tariff and communicated. Rates are uniform in a given setting and transparent.

The «Patient Accounts In-Charge» dates the current list. Informal 'extra' charges that are not on the tariff are not permitted.

Method note (from guidebook interpretation): The organisation shall ensure that there is an updated tariff list and that the relevant tariff is available for review to patients when required. The organisation shall charge as per the tariff list. Any additional charge shall also be enumerated in the tariff and the same communicated to the patients. The tariff rates shall be uniform (in a given setting) and transparent. = ‘ " g The patient and/or family members are explained about the expected costs.

### 5.3 The patient and/or family members are explained about the expected costs

Patients receive an estimate of treatment expenses, preferably written, based on the treatment plan. OPD / registration / admission staff prepare it in consultation with the treating doctor. Limitations (for example emergency admission) are discussed.
...
The «Patient Accounts In-Charge» or the «treating doctor» records the revised estimate. Surprise charges at discharge for a known plan change are a gap.

Method note (from guidebook interpretation): Change in the care plan entails that the patient and/or family are informed of the financial implications. Example of change in care plan include patients are shifted from one setting to another, typically to and from ICUs, the shift from medical to surgical management, need to conduct further expensive investigations etc.

## 6. Governance and responsibility

Medical Superintendent
- Accountable that PRE.6 is resourced and followed.
...
I have read this Information on Expected Costs policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Patient Rights and Education, standard PRE.6. Official portal PDF (OE text, counts, levels, asterisks).
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — PRE.6 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a; OCR policies/source/hco6_pre_guidebook_ocr.txt).
- Internal documents of Preview Hospital: Patient Rights display and pamphlet, informed-consent list and forms, tariff and estimate process, feedback and complaints guidance, and communication models named for PRE.6.

## 10. Distribution

Medical Superintendent; Patient Accounts In-Charge; Nursing Superintendent; Guest Relations / Patient Rights Officer; Quality Coordinator; department clinical staff covered by PRE.6
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition PRE.6

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| PRE.6.a | The patient and / or family members are made aware of the pricing policy in different settings (out-patient, emergency, ICU and in-patient). | Section 3; 5.1 | Patient Accounts In-Charge |
| PRE.6.b | The relevant tariff list is available to patients. | Section 3; 5.2 | Patient Accounts In-Charge |
| PRE.6.c | The patient and/or family members are explained about the expected costs. | Section 3; 5.3 | Patient Accounts In-Charge |
| PRE.6.d | Patient and/or family are informed about the financial implications when there is a change in the care plan. | Section 3; 5.4 | Patient Accounts In-Charge |
