...
*HCO Full Accreditation, 6th Edition — COP.14.*

## Document control

Document number: «HCO/COP/POL/14»
Issue number: «01»
...
Prepared by (designation): «OT In-Charge»    Name: «________»    Signature: «________»
...
Preview Hospital implements COP.14 so that surgical services are provided in a consistent and safe manner..
...
1. Do not skip: Surgical services are provided in a consistent and safe manner.
2. Do not skip: Surgical patients have a pre-operative assessment, a documented pre- operative diagnosis, and pre-operative...
3. Do not skip: Informed consent is obtained by a surgeon before the procedure.
...
12. Staff who see a COP.14 rule broken report it the same shift to the «department in-charge» or the «Medical Superintendent».

## 5. What we do

### 5.1 Surgical services are provided in a consistent and safe manner
...
### 5.3 Informed consent is obtained by a surgeon before the procedure

Informed consent is obtained by a surgeon before the procedure.
...
Method note (from guidebook interpretation): Written guidance shall be available for preventing adverse events
...
### 5.6 Post-operative care is guided by a documented plan

Post-operative care is guided by a documented plan.
...
### 5.9 The organisation shall implement a quality assurance programme

The organisation shall implement a quality assurance programme.
...
Do not make the incision or start the interventional procedure when site/procedure/patient verification is incomplete or when required surgical-safety checks for the case are not done.
...
The person who stops tells the «Surgeon / OT In-Charge» the same shift. Refusing to start without verification is not a disciplinary matter.

## 7. Governance and responsibility

Medical Superintendent
- Accountable that COP.14 is resourced and followed.
...
I have read this Surgical Services policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Care of Patients, standard COP.14.
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — COP.14 interpretations (source PDF md5 2c4489ee98de4ae9b49cba168ea9f42a).
- Internal documents of Preview Hospital: written guidance and registers named for COP.14.
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition COP.14

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| COP.14.a | Surgical services are provided in a consistent and safe manner. | Section 3; 5.1; Section 6 Stop-work | OT In-Charge |
| COP.14.b | Surgical patients have a pre-operative assessment, a documented pre- operative diagnosis, and pre-operative instructions are provided before surgery. | Section 3; 5.2; Section 6 Stop-work | OT In-Charge |
| COP.14.c | Informed consent is obtained by a surgeon before the procedure. | Section 3; 5.3; Section 6 Stop-work | OT In-Charge |
