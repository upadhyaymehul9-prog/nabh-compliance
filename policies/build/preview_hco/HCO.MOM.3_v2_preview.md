...
It covers objective elements MOM.3.a–g (7 elements).
...
This policy owns MOM.3. Related AAC, COP, PRE, IPC/HIC and HRM duties stay with those policies — cross-reference only. Other MOM standards stay with their own policies.
