...
*HCO Full Accreditation, 6th Edition — HRM.11.*

## Document control

Document number: «HCO/HRM/POL/11»
Issue number: «01»
...
This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard HRM.11: There is a process for credentialing and privileging of medical professionals, permitted to provide patient care without supervision.

It covers objective elements HRM.11.a–f (6 elements).
...
This policy owns HRM.11. Related AAC, COP, MOM, PRE, IPC, PSQ, ROM and FMS duties stay with those policies — cross-reference only. Other HRM standards stay with their own policies.
...
Preview Hospital implements HRM.11 so that there is a process for credentialing and privileging of medical professionals, permitted to provide patient care without supervision.
...
8. Staff who see a HRM.11 rule broken report it the same shift to the «HR In-Charge / Personnel Officer» or the «Medical Superintendent».
...
Method note (from guidebook interpretation): The organisation identifies the individuals who have the required qualification(s), training and experience to provide patient care in consonance with the law. For the definition of "credentialing" refer to the glossary.
...
Method note (from guidebook interpretation): Update is done after the acquisition of new skills and/or qualification. All credentials required by organisation are documented and maintained for each medical staff member in his or her personal file.

### 5.3 The information about medical professionals is appropriately verified...

Information about medical professionals at Preview Hospital is appropriately verified when possible, by checking with the organisation that awarded the qualification or training. The National Medical Commission's website is a useful reference for verification.
...
Method note (from guidebook interpretation): The organisation shall identify clinical services which each medical professional is authorised to do. This shall be done based on qualification, experience and any additional training received. For example, radiotherapy can only be given by a radiation oncologist. Privileges shall be reviewed every year and where necessary revised.
...
Method note (from guidebook interpretation): A standardised format can be used for each faculty, and a norm for providing privilege shall be practised uniformly. New faculty members can be under proctorship till independent privileges are provided. The organisation could evolve a mechanism to ensure that medical professionals are providing only those services that they have been privileged to offer.

## 6. Stop-work authority

Do not let a medical professional provide patient care without supervision unless the «HR In-Charge / Personnel Officer» and the credentialing file show that professional identified and privileged for that care under HRM.11.
...
- Accountable that HRM.11 is resourced and followed.
...
I have read this Credentialing and Privileging of Medical Professionals policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Human Resource Management, standard HRM.11. Official portal PDF (OE text, counts, levels, asterisks).
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — HRM.11 interpretations (source PDF has no text layer; transcribed and verified against rendered page images — policies/source/hco6_hrm_guidebook_ocr.txt).
- Internal documents of Preview Hospital: workforce plan, recruitment and induction records, training records, appraisal records, disciplinary and grievance registers, staff health records, personal files, and credentialing/privileging files named for HRM.11.

## 11. Distribution

Medical Superintendent; HR In-Charge / Personnel Officer; Quality Coordinator; departmental leaders; staff covered by HRM.11
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition HRM.11

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| HRM.11.a | Medical professionals permitted by law, regulation and the organisation provide patient care without supervision are identified. | Section 3; 5.1; Section 6 Stop-work | HR In-Charge / Personnel Officer |
| HRM.11.b | The education, registration, training and experience of the identified medical professionals are documented and updated periodically. | Section 3; 5.2; Section 6 Stop-work | HR In-Charge / Personnel Officer |
| HRM.11.c | The information about medical professionals is appropriately verified when possible. | Section 3; 5.3; Section 6 Stop-work | HR In-Charge / Personnel Officer |
| HRM.11.d | Medical professionals are granted privileges to admit and care for patients in consonance with their qualification, training, experience and registration. | Section 3; 5.4; Section 6 Stop-work | HR In-Charge / Personnel Officer |
| HRM.11.e | The requisite services to be provided by the medical professionals are known to them as well as the various departments / units of the organisation. | Section 3; 5.5; Section 6 Stop-work | HR In-Charge / Personnel Officer |
| HRM.11.f | Medical professionals admit and care for patients as per their privileging. | Section 3; 5.6; Section 6 Stop-work | HR In-Charge / Personnel Officer |
