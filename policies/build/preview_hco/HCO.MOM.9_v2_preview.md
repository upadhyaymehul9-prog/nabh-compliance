# Narcotics, Psychotropics, Chemotherapy and Radio-pharmaceuticals
**Preview Hospital**

*HCO Full Accreditation, 6th Edition — MOM.9.*

## Document control

Document number: «HCO/MOM/POL/09»
Issue number: «01»
...
Prepared by (designation): «Pharmacy In-Charge»    Name: «________»    Signature: «________»
...
Narcotic drugs and psychotropic substances, chemotherapeutic agents and radio-pharmaceuticals are used in a safe manner.

## 1. Purpose

This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard MOM.9: Narcotic drugs and psychotropic substances, chemotherapeutic agents and radio-pharmaceuticals are used in a safe manner.

It covers objective elements MOM.9.a–e (5 elements).
...
This policy owns MOM.9. Related AAC, COP, PRE, IPC/HIC and HRM duties stay with those policies — cross-reference only. Other MOM standards stay with their own policies.
...
Preview Hospital implements MOM.9 so that narcotic drugs and psychotropic substances, chemotherapeutic agents and radio-pharmaceuticals are used in a safe manner.
...
Chemotherapy and radio-pharmaceuticals are prepared in the required facility (for example a cytotoxic cabinet / designated hot lab) by personnel qualified and trained for that preparation, and administered by personnel qualified for that administration.
...
Do not prepare or administer chemotherapeutic agents or radio-pharmaceuticals without qualified personnel and the required preparation conditions.
...
The person who stops tells the «Pharmacy In-Charge» and the «Medical Superintendent» the same shift. Refusing unsafe handling of these agents is not a disciplinary matter.

## 7. Governance and responsibility

Medical Superintendent
- Accountable that MOM.9 is resourced and followed.
...
I have read this Narcotics, Psychotropics, Chemotherapy and Radio-pharmaceuticals policy of Preview Hospital. I will follow the processes described.
...
Medical Superintendent; Pharmacy In-Charge; Medication Safety Officer; Nursing Superintendent; Quality Coordinator; department clinical staff covered by MOM.9
...
## 13. Traceability to NABH HCO Full Accreditation 6th Edition MOM.9

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| MOM.9.a | Narcotic drugs and psychotropic substances, chemotherapeutic agents and radio-pharmaceuticals are used safely. | Section 3; 5.1; Section 6 Stop-work | Pharmacy In-Charge |
| MOM.9.b | Narcotic drugs and psychotropic substances, chemotherapeutic agents and radio-pharmaceuticals are prescribed by appropriate caregivers. | Section 3; 5.2; Section 6 Stop-work | Pharmacy In-Charge |
| MOM.9.c | Narcotic drugs and psychotropic substances, chemotherapeutic agents and radio-pharmaceuticals drugs shall be stored securely. | Section 3; 5.3; Section 6 Stop-work | Pharmacy In-Charge |
| MOM.9.d | Chemotherapy and radio-pharmaceuticals shall be prepared properly and safely and administered by qualified personnel. | Section 3; 5.4; Section 6 Stop-work | Pharmacy In-Charge |
| MOM.9.e | A proper record shall be kept of the usage, administration and disposal of narcotic drugs and psychotropic substances, chemotherapeutic agents and radio-pharmaceuticals. | Section 3; 5.5; Section 6 Stop-work | Pharmacy In-Charge |
