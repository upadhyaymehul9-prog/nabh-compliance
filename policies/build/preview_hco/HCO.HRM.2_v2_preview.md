...
*HCO Full Accreditation, 6th Edition — HRM.2.*

## Document control

Document number: «HCO/HRM/POL/02»
Issue number: «01»
...
The organisation implements a defined process for staff recruitment.

## 1. Purpose

This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard HRM.2: The organisation implements a defined process for staff recruitment.

It covers objective elements HRM.2.a–d (4 elements).
...
This policy owns HRM.2. Related AAC, COP, MOM, PRE, IPC, PSQ, ROM and FMS duties stay with those policies — cross-reference only. Other HRM standards stay with their own policies.
...
Preview Hospital implements HRM.2 so that the organisation implements a defined process for staff recruitment.
...
1. Do not skip: Written guidance governs the process of recruitment.
2. Do not skip: A pre-employment medical examination is conducted on the staff.
3. Do not skip: The organisation defines and implements a code of conduct for its staff.
4. Do not skip: Administrative procedures for human resource management are documented.
5. Staff who see a HRM.2 rule broken report it the same shift to the «HR In-Charge / Personnel Officer» or the «Medical Superintendent».

## 5. What we do

### 5.1 Written guidance governs the process of recruitment

Written guidance governs the process of recruitment at Preview Hospital, based on defined criteria for each staff category, ensuring an adequate number and skill mix to provide the organisation's services. The procedure confirms that a candidate has the necessary registration, qualifications, skills and experience before appointment, and follows statutory requirements where they apply.

The process is documented and carried out transparently; the «HR In-Charge / Personnel Officer» maintains a recruitment register logging vacancy, candidates considered, selection rationale and fill date. This is a CORE, asterisked element.

Method note (from guidebook interpretation): Recruitment of staff shall be based on defined criteria for each category. The recruitment process ensures an adequate number and skill mix of staff to provide the organisation's services. The procedure shall ensure that the staff has the necessary registration, qualifications, skills and experience to perform its work. Recruitment is undertaken following statutory requirements, where applicable. The process shall be documented and carried out transparently.
...
### 5.2 A pre-employment medical examination is conducted on the staff

A pre-employment medical examination is conducted on staff at Preview Hospital to confirm fitness to provide safe care. The scope of diagnostic testing is guided by the nature of the role, but any test performed follows the law of the land — for example, pre-employment HIV testing without the candidate's consent is illegal and is not this hospital's practice.

The «HR In-Charge / Personnel Officer» holds the examination record with the personnel file.

Method note (from guidebook interpretation): The purpose of this examination is to ensure that the staff is fit to provide safe care to patients. Performance of diagnostic tests could be guided by the nature of the job of the staff in the organisation. However, any such test done shall be in accordance with the law of the land. For example, performing pre-employment HIV testing without consent is illegal.

### 5.3 The organisation defines and implements a code of conduct for its staff

Preview Hospital defines and implements a code of conduct for its staff, outlining the do's and don'ts of workplace behaviour, aligned with the organisation's values and ethics framework and including protection of patient confidentiality. Staff sign the code at the time of joining; it may form part of the hospital's service rules.

This is a CORE element. The «HR In-Charge / Personnel Officer» holds signed acknowledgements with the personnel file.

Method note (from guidebook interpretation): The code of conducts shall outline the do's and don'ts for staff behaviour at the workplace. It shall be aligned with the organisation's values and ethics framework. Code of conduct shall include protection of patient confidentiality. It is preferable that the staff sign the code of conduct at the time of joining. The code of conduct could be part of service rules of the organisation.

This is a CORE objective element — non-compliance is not acceptable for accreditation.

### 5.4 Administrative procedures for human resource management are documented

Administrative procedures for human resource management are documented at Preview Hospital — at minimum attendance, leave, conduct and replacement. The «HR In-Charge / Personnel Officer» maintains the current procedure set and covers it during induction (HRM.3.h). This is an asterisked element.

Method note (from guidebook interpretation): This shall include administrative procedures like attendance, leave, conduct, replacement, etc.
...
- Accountable that HRM.2 is resourced and followed.
...
I have read this Staff Recruitment policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Human Resource Management, standard HRM.2. Official portal PDF (OE text, counts, levels, asterisks).
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — HRM.2 interpretations (source PDF has no text layer; transcribed and verified against rendered page images — policies/source/hco6_hrm_guidebook_ocr.txt).
- Internal documents of Preview Hospital: workforce plan, recruitment and induction records, training records, appraisal records, disciplinary and grievance registers, staff health records, personal files, and credentialing/privileging files named for HRM.2.

## 10. Distribution

Medical Superintendent; HR In-Charge / Personnel Officer; Quality Coordinator; departmental leaders; staff covered by HRM.2
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition HRM.2

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| HRM.2.a | Written guidance governs the process of recruitment. | Section 3; 5.1 | HR In-Charge / Personnel Officer |
| HRM.2.b | A pre-employment medical examination is conducted on the staff. | Section 3; 5.2 | HR In-Charge / Personnel Officer |
| HRM.2.c | The organisation defines and implements a code of conduct for its staff. | Section 3; 5.3 | HR In-Charge / Personnel Officer |
| HRM.2.d | Administrative procedures for human resource management are documented. | Section 3; 5.4 | HR In-Charge / Personnel Officer |
