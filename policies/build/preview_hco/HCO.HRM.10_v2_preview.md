# Staff Personal Information and Records
**Preview Hospital**

*HCO Full Accreditation, 6th Edition — HRM.10.*

## Document control

Document number: «HCO/HRM/POL/10»
Issue number: «01»
...
This policy says how Preview Hospital meets NABH Hospitals 6th Edition standard HRM.10: There is documented personal information for each staff member.

It covers objective elements HRM.10.a–d (4 elements).
...
This policy owns HRM.10. Related AAC, COP, MOM, PRE, IPC, PSQ, ROM and FMS duties stay with those policies — cross-reference only. Other HRM standards stay with their own policies.
...
Preview Hospital implements HRM.10 so that there is documented personal information for each staff member.
...
Method note (from guidebook interpretation): Each file must be current, updated and could be in the electronic format. The organisation maintains confidentiality and access to personal files is restricted.

### 5.2 The personal files contain personal information regarding the staff’s...

Each staff member's personal file at Preview Hospital contains their qualification, job description, verification of credentials and health status.

Method note (from guidebook interpretation): The personal file shall contain these records.

### 5.3 Records of in-service training and education are maintained

Records of in-service training and education are maintained for staff at Preview Hospital. For internal training, an annual summary may be filed, with a supporting document verifying attendance. Where training records are held elsewhere, the personal file carries traceability to them; electronic training records are acceptable.

Method note (from guidebook interpretation): In the case of internal training, the organisation could file a summary of all trainings attended by the staff on an annual basis. However, there shall be a supporting document (hard/soft copy) to verify that the staff has attended the training. In case the organisation maintains training records elsewhere, traceability shall be provided in the personal file to ensure that the intent of the objective element is addressed. Electronic training records are acceptable.

### 5.4 Personal files contain results of all evaluations and remarks

Personal files at Preview Hospital contain the results of all evaluations and remarks — performance appraisals, training assessments, health-check outcomes, and records of achievement, appreciation, complaint, warning or memo.

Method note (from guidebook interpretation): Evaluations would include performance appraisals, training assessment and outcome of health checks. The personal file would include records of achievement/ appreciation/complaint/warning/memo etc.

## 6. Governance and responsibility

Medical Superintendent
- Accountable that HRM.10 is resourced and followed.
...
I have read this Staff Personal Information and Records policy of Preview Hospital. I will follow the processes described.
...
- National Accreditation Board for Hospitals and Healthcare Providers (NABH), Accreditation Standards for Hospitals, 6th Edition (January 2025) — Human Resource Management, standard HRM.10. Official portal PDF (OE text, counts, levels, asterisks).
- NABH Guidebook to Accreditation Standards for Hospitals, 6th Edition — HRM.10 interpretations (source PDF has no text layer; transcribed and verified against rendered page images — policies/source/hco6_hrm_guidebook_ocr.txt).
- Internal documents of Preview Hospital: workforce plan, recruitment and induction records, training records, appraisal records, disciplinary and grievance registers, staff health records, personal files, and credentialing/privileging files named for HRM.10.

## 10. Distribution

Medical Superintendent; HR In-Charge / Personnel Officer; Quality Coordinator; departmental leaders; staff covered by HRM.10
...
## 12. Traceability to NABH HCO Full Accreditation 6th Edition HRM.10

This table is an index. It is not how the policy is organised.

| OE | Requirement | Where this policy addresses it | Responsible |
| --- | --- | --- | --- |
| HRM.10.a | Personal files are maintained with respect to all staff, and their confidentiality is ensured. | Section 3; 5.1 | HR In-Charge / Personnel Officer |
| HRM.10.b | The personal files contain personal information regarding the staff’s qualification, job description, verification of credentials and health status. | Section 3; 5.2 | HR In-Charge / Personnel Officer |
| HRM.10.c | Records of in-service training and education are maintained. | Section 3; 5.3 | HR In-Charge / Personnel Officer |
| HRM.10.d | Personal files contain results of all evaluations and remarks. | Section 3; 5.4 | HR In-Charge / Personnel Officer |
